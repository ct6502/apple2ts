...
const FOUR_CADE_DSK = "c:/git/4cade/res/dsk"
const PRELAUNCH_DIR = "c:/git/4cade/src/prelaunch"
const GAMES_CONF = "c:/git/4cade/res/GAMES.CONF"
const OUTPUT = "src/common/four_cade_prelaunch_db.ts"
...
const lines = entries.map(e =>
  `  ${JSON.stringify(e.name)}: { disk: ${JSON.stringify(e.disk)}, prelaunch: ${JSON.stringify(e.prelaunch)} },`
)
const output = `// Auto-generated from 4cade v6.0.1
// ${entries.length} games keyed by display name for title-based matching.
