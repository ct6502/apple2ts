...
export const RETRO_IIGS_COLORS = [
  { name: "Black", css: "rgb(0, 0, 0)" },
  { name: "Red", css: "rgb(221, 0, 51)" },
  { name: "Dark Blue", css: "rgb(0, 0, 153)" },
  { name: "Purple", css: "rgb(221, 34, 221)" },
  { name: "Dark Green", css: "rgb(0, 119, 34)" },
  { name: "Dark Gray", css: "rgb(85, 85, 85)" },
  { name: "Medium Blue", css: "rgb(34, 34, 255)" },
  { name: "Light Blue", css: "rgb(102, 170, 255)" },
  { name: "Brown", css: "rgb(136, 85, 0)" },
  { name: "Orange", css: "rgb(255, 102, 0)" },
  { name: "Light Gray", css: "rgb(170, 170, 170)" },
  { name: "Pink", css: "rgb(255, 153, 136)" },
  { name: "Light Green", css: "rgb(17, 221, 0)" },
  { name: "Yellow", css: "rgb(255, 255, 0)" },
  { name: "Aquamarine", css: "rgb(68, 255, 153)" },
  { name: "White", css: "rgb(255, 255, 255)" },
] as const
...
const colorControl = (
  ...
  labels: () => RETRO_IIGS_COLORS.map(color => color.name),
