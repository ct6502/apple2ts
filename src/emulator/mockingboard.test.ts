...
// const ldaE_V = (chip: Channel | number, value: number) => {
//   const X = chip ? '8' : '0'
//   return `
...
// const ldaD_V = (chip: Channel | number, value: number) => {
//   const X = chip ? '8' : '0'
//   return `
//   LDA #$${value.toString(16)}
//   STA $C4${X}D
...
// const latchRegister = (chip: Channel, register: number) => {
//   const X = chip ? '8' : '0'
//   return `
...
// const writeRegister = (chip: Channel, data: number) => {
//   const X = chip ? '8' : '0'
//   return `
...
//   const c: Channel = chip as Channel
...
SKIP  LDA #$7F      ; turn off all timer enable bits
      ...
      LDA #$99
      STA $C4${X}${LC}
      STZ $C4${X}${HC}   ; transfer both latches into counters and "start" the timer
      CLC
