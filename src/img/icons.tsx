...
export const svgLowercase = <svg className="svg-inline--fa" width="30" height="30"><svg viewBox="0 0 22.5 22.5"><path d="m9.27,9.12l-2.49-.45c.6-3.57,6.71-3.92,8.49-1.41.96,2.31-.37,6.75.96,9.07h-2.71c-.08-.18-.27-.85-.36-1.13-6.67,4.81-10.81-4.88-.21-5.63.44-2.19-3.23-2.39-3.67-.44Zm3.67,2.23c-.95.44-3.74.36-3.7,1.87.71,3.02,4.5.8,3.7-1.87Z"/><rect x="1.25" y="1.25" width="20" height="20" rx="1" ry="1" style={{fill: 'none', stroke: 'black', strokeWidth: '2.5px', strokeLinecap: 'round', strokeMiterlimit: 10}}/></svg></svg>
