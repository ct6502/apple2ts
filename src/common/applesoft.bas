...
HCOLOR=3
HPLOT 0,0 to 279,0
HPLOT 279,0 to 279,191
HPLOT 279,191 to 0,191
HPLOT 0,0 to 0,191
...
REM test "no-delay" HGR mode which only displays 4 colors
REM https://forum.princed.org/viewtopic.php?f=63&t=4450
10 HGR
20 FOR A = 10 TO 79
30 HCOLOR= A / 10
...
70 GET A
80 IF A=1 THEN POKE 49164,0: POKE 49246,0: PRINT "WEIRD 80COL OFF, AN3 OFF"
90 IF A=2 THEN POKE 49164,0: POKE 49247,0: PRINT "NORMAL 80COL OFF, AN3 ON"
100 GOTO 70
...
REM Test drawing a square, Sather p. 8-28
10 HGR : HCOLOR=3 : HPLOT 0,0 to 0,159 to (159*1.19+0.5),159 to (159*1.19+0.5),0 to 0,0
