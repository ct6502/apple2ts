...
export const generateMenuSourceProgram = (
  ...
  lines.push("46 IF K0<>27 THEN 50")
  lines.push("47 G=1-G:IF G=0 THEN POKE 49236,0:GOTO 40")
  lines.push("48 POKE 49237,0:GOTO 40")
  ...
  lines.push("87 P=0:FOR J=1 TO MAX")
  lines.push("88 IF ASC(MID$(C$,J,1))=K0 THEN P=J:J=MAX")
  lines.push("89 NEXT:IF P>0 THEN I=P:GOSUB 1000")
