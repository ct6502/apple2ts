var ke=Object.defineProperty;var ye=(e,t,r)=>t in e?ke(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var y=(e,t,r)=>(ye(e,typeof t!="symbol"?t+"":t,r),r);(function(){"use strict";var buffer={},base64Js={};base64Js.byteLength=byteLength,base64Js.toByteArray=toByteArray,base64Js.fromByteArray=fromByteArray;for(var lookup=[],revLookup=[],Arr=typeof Uint8Array<"u"?Uint8Array:Array,code$2="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=0,len=code$2.length;i<len;++i)lookup[i]=code$2[i],revLookup[code$2.charCodeAt(i)]=i;revLookup["-".charCodeAt(0)]=62,revLookup["_".charCodeAt(0)]=63;function getLens(e){var t=e.length;if(t%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var r=e.indexOf("=");r===-1&&(r=t);var a=r===t?0:4-r%4;return[r,a]}function byteLength(e){var t=getLens(e),r=t[0],a=t[1];return(r+a)*3/4-a}function _byteLength(e,t,r){return(t+r)*3/4-r}function toByteArray(e){var t,r=getLens(e),a=r[0],c=r[1],D=new Arr(_byteLength(e,a,c)),m=0,l=c>0?a-4:a,I;for(I=0;I<l;I+=4)t=revLookup[e.charCodeAt(I)]<<18|revLookup[e.charCodeAt(I+1)]<<12|revLookup[e.charCodeAt(I+2)]<<6|revLookup[e.charCodeAt(I+3)],D[m++]=t>>16&255,D[m++]=t>>8&255,D[m++]=t&255;return c===2&&(t=revLookup[e.charCodeAt(I)]<<2|revLookup[e.charCodeAt(I+1)]>>4,D[m++]=t&255),c===1&&(t=revLookup[e.charCodeAt(I)]<<10|revLookup[e.charCodeAt(I+1)]<<4|revLookup[e.charCodeAt(I+2)]>>2,D[m++]=t>>8&255,D[m++]=t&255),D}function tripletToBase64(e){return lookup[e>>18&63]+lookup[e>>12&63]+lookup[e>>6&63]+lookup[e&63]}function encodeChunk(e,t,r){for(var a,c=[],D=t;D<r;D+=3)a=(e[D]<<16&16711680)+(e[D+1]<<8&65280)+(e[D+2]&255),c.push(tripletToBase64(a));return c.join("")}function fromByteArray(e){for(var t,r=e.length,a=r%3,c=[],D=16383,m=0,l=r-a;m<l;m+=D)c.push(encodeChunk(e,m,m+D>l?l:m+D));return a===1?(t=e[r-1],c.push(lookup[t>>2]+lookup[t<<4&63]+"==")):a===2&&(t=(e[r-2]<<8)+e[r-1],c.push(lookup[t>>10]+lookup[t>>4&63]+lookup[t<<2&63]+"=")),c.join("")}var ieee754={};/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ieee754.read=function(e,t,r,a,c){var D,m,l=c*8-a-1,I=(1<<l)-1,B=I>>1,g=-7,E=r?c-1:0,T=r?-1:1,k=e[t+E];for(E+=T,D=k&(1<<-g)-1,k>>=-g,g+=l;g>0;D=D*256+e[t+E],E+=T,g-=8);for(m=D&(1<<-g)-1,D>>=-g,g+=a;g>0;m=m*256+e[t+E],E+=T,g-=8);if(D===0)D=1-B;else{if(D===I)return m?NaN:(k?-1:1)*(1/0);m=m+Math.pow(2,a),D=D-B}return(k?-1:1)*m*Math.pow(2,D-a)},ieee754.write=function(e,t,r,a,c,D){var m,l,I,B=D*8-c-1,g=(1<<B)-1,E=g>>1,T=c===23?Math.pow(2,-24)-Math.pow(2,-77):0,k=a?0:D-1,Q=a?1:-1,L=t<0||t===0&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(l=isNaN(t)?1:0,m=g):(m=Math.floor(Math.log(t)/Math.LN2),t*(I=Math.pow(2,-m))<1&&(m--,I*=2),m+E>=1?t+=T/I:t+=T*Math.pow(2,1-E),t*I>=2&&(m++,I/=2),m+E>=g?(l=0,m=g):m+E>=1?(l=(t*I-1)*Math.pow(2,c),m=m+E):(l=t*Math.pow(2,E-1)*Math.pow(2,c),m=0));c>=8;e[r+k]=l&255,k+=Q,l/=256,c-=8);for(m=m<<c|l,B+=c;B>0;e[r+k]=m&255,k+=Q,m/=256,B-=8);e[r+k-Q]|=L*128};/*!
 * The buffer module from node.js, for the browser.
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */(function(e){const t=base64Js,r=ieee754,a=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=l,e.SlowBuffer=x,e.INSPECT_MAX_BYTES=50;const c=2147483647;e.kMaxLength=c,l.TYPED_ARRAY_SUPPORT=D(),!l.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function D(){try{const n=new Uint8Array(1),s={foo:function(){return 42}};return Object.setPrototypeOf(s,Uint8Array.prototype),Object.setPrototypeOf(n,s),n.foo()===42}catch{return!1}}Object.defineProperty(l.prototype,"parent",{enumerable:!0,get:function(){if(l.isBuffer(this))return this.buffer}}),Object.defineProperty(l.prototype,"offset",{enumerable:!0,get:function(){if(l.isBuffer(this))return this.byteOffset}});function m(n){if(n>c)throw new RangeError('The value "'+n+'" is invalid for option "size"');const s=new Uint8Array(n);return Object.setPrototypeOf(s,l.prototype),s}function l(n,s,o){if(typeof n=="number"){if(typeof s=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return E(n)}return I(n,s,o)}l.poolSize=8192;function I(n,s,o){if(typeof n=="string")return T(n,s);if(ArrayBuffer.isView(n))return Q(n);if(n==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof n);if(U(n,ArrayBuffer)||n&&U(n.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(U(n,SharedArrayBuffer)||n&&U(n.buffer,SharedArrayBuffer)))return L(n,s,o);if(typeof n=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const u=n.valueOf&&n.valueOf();if(u!=null&&u!==n)return l.from(u,s,o);const d=H(n);if(d)return d;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof n[Symbol.toPrimitive]=="function")return l.from(n[Symbol.toPrimitive]("string"),s,o);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof n)}l.from=function(n,s,o){return I(n,s,o)},Object.setPrototypeOf(l.prototype,Uint8Array.prototype),Object.setPrototypeOf(l,Uint8Array);function B(n){if(typeof n!="number")throw new TypeError('"size" argument must be of type number');if(n<0)throw new RangeError('The value "'+n+'" is invalid for option "size"')}function g(n,s,o){return B(n),n<=0?m(n):s!==void 0?typeof o=="string"?m(n).fill(s,o):m(n).fill(s):m(n)}l.alloc=function(n,s,o){return g(n,s,o)};function E(n){return B(n),m(n<0?0:W(n)|0)}l.allocUnsafe=function(n){return E(n)},l.allocUnsafeSlow=function(n){return E(n)};function T(n,s){if((typeof s!="string"||s==="")&&(s="utf8"),!l.isEncoding(s))throw new TypeError("Unknown encoding: "+s);const o=v(n,s)|0;let u=m(o);const d=u.write(n,s);return d!==o&&(u=u.slice(0,d)),u}function k(n){const s=n.length<0?0:W(n.length)|0,o=m(s);for(let u=0;u<s;u+=1)o[u]=n[u]&255;return o}function Q(n){if(U(n,Uint8Array)){const s=new Uint8Array(n);return L(s.buffer,s.byteOffset,s.byteLength)}return k(n)}function L(n,s,o){if(s<0||n.byteLength<s)throw new RangeError('"offset" is outside of buffer bounds');if(n.byteLength<s+(o||0))throw new RangeError('"length" is outside of buffer bounds');let u;return s===void 0&&o===void 0?u=new Uint8Array(n):o===void 0?u=new Uint8Array(n,s):u=new Uint8Array(n,s,o),Object.setPrototypeOf(u,l.prototype),u}function H(n){if(l.isBuffer(n)){const s=W(n.length)|0,o=m(s);return o.length===0||n.copy(o,0,0,s),o}if(n.length!==void 0)return typeof n.length!="number"||V(n.length)?m(0):k(n);if(n.type==="Buffer"&&Array.isArray(n.data))return k(n.data)}function W(n){if(n>=c)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+c.toString(16)+" bytes");return n|0}function x(n){return+n!=n&&(n=0),l.alloc(+n)}l.isBuffer=function(s){return s!=null&&s._isBuffer===!0&&s!==l.prototype},l.compare=function(s,o){if(U(s,Uint8Array)&&(s=l.from(s,s.offset,s.byteLength)),U(o,Uint8Array)&&(o=l.from(o,o.offset,o.byteLength)),!l.isBuffer(s)||!l.isBuffer(o))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(s===o)return 0;let u=s.length,d=o.length;for(let C=0,p=Math.min(u,d);C<p;++C)if(s[C]!==o[C]){u=s[C],d=o[C];break}return u<d?-1:d<u?1:0},l.isEncoding=function(s){switch(String(s).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},l.concat=function(s,o){if(!Array.isArray(s))throw new TypeError('"list" argument must be an Array of Buffers');if(s.length===0)return l.alloc(0);let u;if(o===void 0)for(o=0,u=0;u<s.length;++u)o+=s[u].length;const d=l.allocUnsafe(o);let C=0;for(u=0;u<s.length;++u){let p=s[u];if(U(p,Uint8Array))C+p.length>d.length?(l.isBuffer(p)||(p=l.from(p)),p.copy(d,C)):Uint8Array.prototype.set.call(d,p,C);else if(l.isBuffer(p))p.copy(d,C);else throw new TypeError('"list" argument must be an Array of Buffers');C+=p.length}return d};function v(n,s){if(l.isBuffer(n))return n.length;if(ArrayBuffer.isView(n)||U(n,ArrayBuffer))return n.byteLength;if(typeof n!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof n);const o=n.length,u=arguments.length>2&&arguments[2]===!0;if(!u&&o===0)return 0;let d=!1;for(;;)switch(s){case"ascii":case"latin1":case"binary":return o;case"utf8":case"utf-8":return J(n).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return o*2;case"hex":return o>>>1;case"base64":return ie(n).length;default:if(d)return u?-1:J(n).length;s=(""+s).toLowerCase(),d=!0}}l.byteLength=v;function ce(n,s,o){let u=!1;if((s===void 0||s<0)&&(s=0),s>this.length||((o===void 0||o>this.length)&&(o=this.length),o<=0)||(o>>>=0,s>>>=0,o<=s))return"";for(n||(n="utf8");;)switch(n){case"hex":return Ee(this,s,o);case"utf8":case"utf-8":return $(this,s,o);case"ascii":return pe(this,s,o);case"latin1":case"binary":return Ie(this,s,o);case"base64":return me(this,s,o);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return he(this,s,o);default:if(u)throw new TypeError("Unknown encoding: "+n);n=(n+"").toLowerCase(),u=!0}}l.prototype._isBuffer=!0;function K(n,s,o){const u=n[s];n[s]=n[o],n[o]=u}l.prototype.swap16=function(){const s=this.length;if(s%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let o=0;o<s;o+=2)K(this,o,o+1);return this},l.prototype.swap32=function(){const s=this.length;if(s%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let o=0;o<s;o+=4)K(this,o,o+3),K(this,o+1,o+2);return this},l.prototype.swap64=function(){const s=this.length;if(s%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let o=0;o<s;o+=8)K(this,o,o+7),K(this,o+1,o+6),K(this,o+2,o+5),K(this,o+3,o+4);return this},l.prototype.toString=function(){const s=this.length;return s===0?"":arguments.length===0?$(this,0,s):ce.apply(this,arguments)},l.prototype.toLocaleString=l.prototype.toString,l.prototype.equals=function(s){if(!l.isBuffer(s))throw new TypeError("Argument must be a Buffer");return this===s?!0:l.compare(this,s)===0},l.prototype.inspect=function(){let s="";const o=e.INSPECT_MAX_BYTES;return s=this.toString("hex",0,o).replace(/(.{2})/g,"$1 ").trim(),this.length>o&&(s+=" ... "),"<Buffer "+s+">"},a&&(l.prototype[a]=l.prototype.inspect),l.prototype.compare=function(s,o,u,d,C){if(U(s,Uint8Array)&&(s=l.from(s,s.offset,s.byteLength)),!l.isBuffer(s))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof s);if(o===void 0&&(o=0),u===void 0&&(u=s?s.length:0),d===void 0&&(d=0),C===void 0&&(C=this.length),o<0||u>s.length||d<0||C>this.length)throw new RangeError("out of range index");if(d>=C&&o>=u)return 0;if(d>=C)return-1;if(o>=u)return 1;if(o>>>=0,u>>>=0,d>>>=0,C>>>=0,this===s)return 0;let p=C-d,h=u-o;const M=Math.min(p,h),R=this.slice(d,C),w=s.slice(o,u);for(let f=0;f<M;++f)if(R[f]!==w[f]){p=R[f],h=w[f];break}return p<h?-1:h<p?1:0};function j(n,s,o,u,d){if(n.length===0)return-1;if(typeof o=="string"?(u=o,o=0):o>2147483647?o=2147483647:o<-2147483648&&(o=-2147483648),o=+o,V(o)&&(o=d?0:n.length-1),o<0&&(o=n.length+o),o>=n.length){if(d)return-1;o=n.length-1}else if(o<0)if(d)o=0;else return-1;if(typeof s=="string"&&(s=l.from(s,u)),l.isBuffer(s))return s.length===0?-1:z(n,s,o,u,d);if(typeof s=="number")return s=s&255,typeof Uint8Array.prototype.indexOf=="function"?d?Uint8Array.prototype.indexOf.call(n,s,o):Uint8Array.prototype.lastIndexOf.call(n,s,o):z(n,[s],o,u,d);throw new TypeError("val must be string, number or Buffer")}function z(n,s,o,u,d){let C=1,p=n.length,h=s.length;if(u!==void 0&&(u=String(u).toLowerCase(),u==="ucs2"||u==="ucs-2"||u==="utf16le"||u==="utf-16le")){if(n.length<2||s.length<2)return-1;C=2,p/=2,h/=2,o/=2}function M(w,f){return C===1?w[f]:w.readUInt16BE(f*C)}let R;if(d){let w=-1;for(R=o;R<p;R++)if(M(n,R)===M(s,w===-1?0:R-w)){if(w===-1&&(w=R),R-w+1===h)return w*C}else w!==-1&&(R-=R-w),w=-1}else for(o+h>p&&(o=p-h),R=o;R>=0;R--){let w=!0;for(let f=0;f<h;f++)if(M(n,R+f)!==M(s,f)){w=!1;break}if(w)return R}return-1}l.prototype.includes=function(s,o,u){return this.indexOf(s,o,u)!==-1},l.prototype.indexOf=function(s,o,u){return j(this,s,o,u,!0)},l.prototype.lastIndexOf=function(s,o,u){return j(this,s,o,u,!1)};function ue(n,s,o,u){o=Number(o)||0;const d=n.length-o;u?(u=Number(u),u>d&&(u=d)):u=d;const C=s.length;u>C/2&&(u=C/2);let p;for(p=0;p<u;++p){const h=parseInt(s.substr(p*2,2),16);if(V(h))return p;n[o+p]=h}return p}function le(n,s,o,u){return _(J(s,n.length-o),n,o,u)}function De(n,s,o,u){return _(Re(s),n,o,u)}function Se(n,s,o,u){return _(ie(s),n,o,u)}function de(n,s,o,u){return _(Te(s,n.length-o),n,o,u)}l.prototype.write=function(s,o,u,d){if(o===void 0)d="utf8",u=this.length,o=0;else if(u===void 0&&typeof o=="string")d=o,u=this.length,o=0;else if(isFinite(o))o=o>>>0,isFinite(u)?(u=u>>>0,d===void 0&&(d="utf8")):(d=u,u=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const C=this.length-o;if((u===void 0||u>C)&&(u=C),s.length>0&&(u<0||o<0)||o>this.length)throw new RangeError("Attempt to write outside buffer bounds");d||(d="utf8");let p=!1;for(;;)switch(d){case"hex":return ue(this,s,o,u);case"utf8":case"utf-8":return le(this,s,o,u);case"ascii":case"latin1":case"binary":return De(this,s,o,u);case"base64":return Se(this,s,o,u);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return de(this,s,o,u);default:if(p)throw new TypeError("Unknown encoding: "+d);d=(""+d).toLowerCase(),p=!0}},l.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function me(n,s,o){return s===0&&o===n.length?t.fromByteArray(n):t.fromByteArray(n.slice(s,o))}function $(n,s,o){o=Math.min(n.length,o);const u=[];let d=s;for(;d<o;){const C=n[d];let p=null,h=C>239?4:C>223?3:C>191?2:1;if(d+h<=o){let M,R,w,f;switch(h){case 1:C<128&&(p=C);break;case 2:M=n[d+1],(M&192)===128&&(f=(C&31)<<6|M&63,f>127&&(p=f));break;case 3:M=n[d+1],R=n[d+2],(M&192)===128&&(R&192)===128&&(f=(C&15)<<12|(M&63)<<6|R&63,f>2047&&(f<55296||f>57343)&&(p=f));break;case 4:M=n[d+1],R=n[d+2],w=n[d+3],(M&192)===128&&(R&192)===128&&(w&192)===128&&(f=(C&15)<<18|(M&63)<<12|(R&63)<<6|w&63,f>65535&&f<1114112&&(p=f))}}p===null?(p=65533,h=1):p>65535&&(p-=65536,u.push(p>>>10&1023|55296),p=56320|p&1023),u.push(p),d+=h}return Ce(u)}const ee=4096;function Ce(n){const s=n.length;if(s<=ee)return String.fromCharCode.apply(String,n);let o="",u=0;for(;u<s;)o+=String.fromCharCode.apply(String,n.slice(u,u+=ee));return o}function pe(n,s,o){let u="";o=Math.min(n.length,o);for(let d=s;d<o;++d)u+=String.fromCharCode(n[d]&127);return u}function Ie(n,s,o){let u="";o=Math.min(n.length,o);for(let d=s;d<o;++d)u+=String.fromCharCode(n[d]);return u}function Ee(n,s,o){const u=n.length;(!s||s<0)&&(s=0),(!o||o<0||o>u)&&(o=u);let d="";for(let C=s;C<o;++C)d+=Me[n[C]];return d}function he(n,s,o){const u=n.slice(s,o);let d="";for(let C=0;C<u.length-1;C+=2)d+=String.fromCharCode(u[C]+u[C+1]*256);return d}l.prototype.slice=function(s,o){const u=this.length;s=~~s,o=o===void 0?u:~~o,s<0?(s+=u,s<0&&(s=0)):s>u&&(s=u),o<0?(o+=u,o<0&&(o=0)):o>u&&(o=u),o<s&&(o=s);const d=this.subarray(s,o);return Object.setPrototypeOf(d,l.prototype),d};function O(n,s,o){if(n%1!==0||n<0)throw new RangeError("offset is not uint");if(n+s>o)throw new RangeError("Trying to access beyond buffer length")}l.prototype.readUintLE=l.prototype.readUIntLE=function(s,o,u){s=s>>>0,o=o>>>0,u||O(s,o,this.length);let d=this[s],C=1,p=0;for(;++p<o&&(C*=256);)d+=this[s+p]*C;return d},l.prototype.readUintBE=l.prototype.readUIntBE=function(s,o,u){s=s>>>0,o=o>>>0,u||O(s,o,this.length);let d=this[s+--o],C=1;for(;o>0&&(C*=256);)d+=this[s+--o]*C;return d},l.prototype.readUint8=l.prototype.readUInt8=function(s,o){return s=s>>>0,o||O(s,1,this.length),this[s]},l.prototype.readUint16LE=l.prototype.readUInt16LE=function(s,o){return s=s>>>0,o||O(s,2,this.length),this[s]|this[s+1]<<8},l.prototype.readUint16BE=l.prototype.readUInt16BE=function(s,o){return s=s>>>0,o||O(s,2,this.length),this[s]<<8|this[s+1]},l.prototype.readUint32LE=l.prototype.readUInt32LE=function(s,o){return s=s>>>0,o||O(s,4,this.length),(this[s]|this[s+1]<<8|this[s+2]<<16)+this[s+3]*16777216},l.prototype.readUint32BE=l.prototype.readUInt32BE=function(s,o){return s=s>>>0,o||O(s,4,this.length),this[s]*16777216+(this[s+1]<<16|this[s+2]<<8|this[s+3])},l.prototype.readBigUInt64LE=F(function(s){s=s>>>0,q(s,"offset");const o=this[s],u=this[s+7];(o===void 0||u===void 0)&&N(s,this.length-8);const d=o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24,C=this[++s]+this[++s]*2**8+this[++s]*2**16+u*2**24;return BigInt(d)+(BigInt(C)<<BigInt(32))}),l.prototype.readBigUInt64BE=F(function(s){s=s>>>0,q(s,"offset");const o=this[s],u=this[s+7];(o===void 0||u===void 0)&&N(s,this.length-8);const d=o*2**24+this[++s]*2**16+this[++s]*2**8+this[++s],C=this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+u;return(BigInt(d)<<BigInt(32))+BigInt(C)}),l.prototype.readIntLE=function(s,o,u){s=s>>>0,o=o>>>0,u||O(s,o,this.length);let d=this[s],C=1,p=0;for(;++p<o&&(C*=256);)d+=this[s+p]*C;return C*=128,d>=C&&(d-=Math.pow(2,8*o)),d},l.prototype.readIntBE=function(s,o,u){s=s>>>0,o=o>>>0,u||O(s,o,this.length);let d=o,C=1,p=this[s+--d];for(;d>0&&(C*=256);)p+=this[s+--d]*C;return C*=128,p>=C&&(p-=Math.pow(2,8*o)),p},l.prototype.readInt8=function(s,o){return s=s>>>0,o||O(s,1,this.length),this[s]&128?(255-this[s]+1)*-1:this[s]},l.prototype.readInt16LE=function(s,o){s=s>>>0,o||O(s,2,this.length);const u=this[s]|this[s+1]<<8;return u&32768?u|4294901760:u},l.prototype.readInt16BE=function(s,o){s=s>>>0,o||O(s,2,this.length);const u=this[s+1]|this[s]<<8;return u&32768?u|4294901760:u},l.prototype.readInt32LE=function(s,o){return s=s>>>0,o||O(s,4,this.length),this[s]|this[s+1]<<8|this[s+2]<<16|this[s+3]<<24},l.prototype.readInt32BE=function(s,o){return s=s>>>0,o||O(s,4,this.length),this[s]<<24|this[s+1]<<16|this[s+2]<<8|this[s+3]},l.prototype.readBigInt64LE=F(function(s){s=s>>>0,q(s,"offset");const o=this[s],u=this[s+7];(o===void 0||u===void 0)&&N(s,this.length-8);const d=this[s+4]+this[s+5]*2**8+this[s+6]*2**16+(u<<24);return(BigInt(d)<<BigInt(32))+BigInt(o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24)}),l.prototype.readBigInt64BE=F(function(s){s=s>>>0,q(s,"offset");const o=this[s],u=this[s+7];(o===void 0||u===void 0)&&N(s,this.length-8);const d=(o<<24)+this[++s]*2**16+this[++s]*2**8+this[++s];return(BigInt(d)<<BigInt(32))+BigInt(this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+u)}),l.prototype.readFloatLE=function(s,o){return s=s>>>0,o||O(s,4,this.length),r.read(this,s,!0,23,4)},l.prototype.readFloatBE=function(s,o){return s=s>>>0,o||O(s,4,this.length),r.read(this,s,!1,23,4)},l.prototype.readDoubleLE=function(s,o){return s=s>>>0,o||O(s,8,this.length),r.read(this,s,!0,52,8)},l.prototype.readDoubleBE=function(s,o){return s=s>>>0,o||O(s,8,this.length),r.read(this,s,!1,52,8)};function b(n,s,o,u,d,C){if(!l.isBuffer(n))throw new TypeError('"buffer" argument must be a Buffer instance');if(s>d||s<C)throw new RangeError('"value" argument is out of bounds');if(o+u>n.length)throw new RangeError("Index out of range")}l.prototype.writeUintLE=l.prototype.writeUIntLE=function(s,o,u,d){if(s=+s,o=o>>>0,u=u>>>0,!d){const h=Math.pow(2,8*u)-1;b(this,s,o,u,h,0)}let C=1,p=0;for(this[o]=s&255;++p<u&&(C*=256);)this[o+p]=s/C&255;return o+u},l.prototype.writeUintBE=l.prototype.writeUIntBE=function(s,o,u,d){if(s=+s,o=o>>>0,u=u>>>0,!d){const h=Math.pow(2,8*u)-1;b(this,s,o,u,h,0)}let C=u-1,p=1;for(this[o+C]=s&255;--C>=0&&(p*=256);)this[o+C]=s/p&255;return o+u},l.prototype.writeUint8=l.prototype.writeUInt8=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,1,255,0),this[o]=s&255,o+1},l.prototype.writeUint16LE=l.prototype.writeUInt16LE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,2,65535,0),this[o]=s&255,this[o+1]=s>>>8,o+2},l.prototype.writeUint16BE=l.prototype.writeUInt16BE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,2,65535,0),this[o]=s>>>8,this[o+1]=s&255,o+2},l.prototype.writeUint32LE=l.prototype.writeUInt32LE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,4,4294967295,0),this[o+3]=s>>>24,this[o+2]=s>>>16,this[o+1]=s>>>8,this[o]=s&255,o+4},l.prototype.writeUint32BE=l.prototype.writeUInt32BE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,4,4294967295,0),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4};function te(n,s,o,u,d){ae(s,u,d,n,o,7);let C=Number(s&BigInt(4294967295));n[o++]=C,C=C>>8,n[o++]=C,C=C>>8,n[o++]=C,C=C>>8,n[o++]=C;let p=Number(s>>BigInt(32)&BigInt(4294967295));return n[o++]=p,p=p>>8,n[o++]=p,p=p>>8,n[o++]=p,p=p>>8,n[o++]=p,o}function re(n,s,o,u,d){ae(s,u,d,n,o,7);let C=Number(s&BigInt(4294967295));n[o+7]=C,C=C>>8,n[o+6]=C,C=C>>8,n[o+5]=C,C=C>>8,n[o+4]=C;let p=Number(s>>BigInt(32)&BigInt(4294967295));return n[o+3]=p,p=p>>8,n[o+2]=p,p=p>>8,n[o+1]=p,p=p>>8,n[o]=p,o+8}l.prototype.writeBigUInt64LE=F(function(s,o=0){return te(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),l.prototype.writeBigUInt64BE=F(function(s,o=0){return re(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),l.prototype.writeIntLE=function(s,o,u,d){if(s=+s,o=o>>>0,!d){const M=Math.pow(2,8*u-1);b(this,s,o,u,M-1,-M)}let C=0,p=1,h=0;for(this[o]=s&255;++C<u&&(p*=256);)s<0&&h===0&&this[o+C-1]!==0&&(h=1),this[o+C]=(s/p>>0)-h&255;return o+u},l.prototype.writeIntBE=function(s,o,u,d){if(s=+s,o=o>>>0,!d){const M=Math.pow(2,8*u-1);b(this,s,o,u,M-1,-M)}let C=u-1,p=1,h=0;for(this[o+C]=s&255;--C>=0&&(p*=256);)s<0&&h===0&&this[o+C+1]!==0&&(h=1),this[o+C]=(s/p>>0)-h&255;return o+u},l.prototype.writeInt8=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,1,127,-128),s<0&&(s=255+s+1),this[o]=s&255,o+1},l.prototype.writeInt16LE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,2,32767,-32768),this[o]=s&255,this[o+1]=s>>>8,o+2},l.prototype.writeInt16BE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,2,32767,-32768),this[o]=s>>>8,this[o+1]=s&255,o+2},l.prototype.writeInt32LE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,4,2147483647,-2147483648),this[o]=s&255,this[o+1]=s>>>8,this[o+2]=s>>>16,this[o+3]=s>>>24,o+4},l.prototype.writeInt32BE=function(s,o,u){return s=+s,o=o>>>0,u||b(this,s,o,4,2147483647,-2147483648),s<0&&(s=4294967295+s+1),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4},l.prototype.writeBigInt64LE=F(function(s,o=0){return te(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),l.prototype.writeBigInt64BE=F(function(s,o=0){return re(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function se(n,s,o,u,d,C){if(o+u>n.length)throw new RangeError("Index out of range");if(o<0)throw new RangeError("Index out of range")}function oe(n,s,o,u,d){return s=+s,o=o>>>0,d||se(n,s,o,4),r.write(n,s,o,u,23,4),o+4}l.prototype.writeFloatLE=function(s,o,u){return oe(this,s,o,!0,u)},l.prototype.writeFloatBE=function(s,o,u){return oe(this,s,o,!1,u)};function Ae(n,s,o,u,d){return s=+s,o=o>>>0,d||se(n,s,o,8),r.write(n,s,o,u,52,8),o+8}l.prototype.writeDoubleLE=function(s,o,u){return Ae(this,s,o,!0,u)},l.prototype.writeDoubleBE=function(s,o,u){return Ae(this,s,o,!1,u)},l.prototype.copy=function(s,o,u,d){if(!l.isBuffer(s))throw new TypeError("argument should be a Buffer");if(u||(u=0),!d&&d!==0&&(d=this.length),o>=s.length&&(o=s.length),o||(o=0),d>0&&d<u&&(d=u),d===u||s.length===0||this.length===0)return 0;if(o<0)throw new RangeError("targetStart out of bounds");if(u<0||u>=this.length)throw new RangeError("Index out of range");if(d<0)throw new RangeError("sourceEnd out of bounds");d>this.length&&(d=this.length),s.length-o<d-u&&(d=s.length-o+u);const C=d-u;return this===s&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(o,u,d):Uint8Array.prototype.set.call(s,this.subarray(u,d),o),C},l.prototype.fill=function(s,o,u,d){if(typeof s=="string"){if(typeof o=="string"?(d=o,o=0,u=this.length):typeof u=="string"&&(d=u,u=this.length),d!==void 0&&typeof d!="string")throw new TypeError("encoding must be a string");if(typeof d=="string"&&!l.isEncoding(d))throw new TypeError("Unknown encoding: "+d);if(s.length===1){const p=s.charCodeAt(0);(d==="utf8"&&p<128||d==="latin1")&&(s=p)}}else typeof s=="number"?s=s&255:typeof s=="boolean"&&(s=Number(s));if(o<0||this.length<o||this.length<u)throw new RangeError("Out of range index");if(u<=o)return this;o=o>>>0,u=u===void 0?this.length:u>>>0,s||(s=0);let C;if(typeof s=="number")for(C=o;C<u;++C)this[C]=s;else{const p=l.isBuffer(s)?s:l.from(s,d),h=p.length;if(h===0)throw new TypeError('The value "'+s+'" is invalid for argument "value"');for(C=0;C<u-o;++C)this[C+o]=p[C%h]}return this};const G={};function Z(n,s,o){G[n]=class extends o{constructor(){super(),Object.defineProperty(this,"message",{value:s.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${n}]`,this.stack,delete this.name}get code(){return n}set code(d){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:d,writable:!0})}toString(){return`${this.name} [${n}]: ${this.message}`}}}Z("ERR_BUFFER_OUT_OF_BOUNDS",function(n){return n?`${n} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),Z("ERR_INVALID_ARG_TYPE",function(n,s){return`The "${n}" argument must be of type number. Received type ${typeof s}`},TypeError),Z("ERR_OUT_OF_RANGE",function(n,s,o){let u=`The value of "${n}" is out of range.`,d=o;return Number.isInteger(o)&&Math.abs(o)>2**32?d=ne(String(o)):typeof o=="bigint"&&(d=String(o),(o>BigInt(2)**BigInt(32)||o<-(BigInt(2)**BigInt(32)))&&(d=ne(d)),d+="n"),u+=` It must be ${s}. Received ${d}`,u},RangeError);function ne(n){let s="",o=n.length;const u=n[0]==="-"?1:0;for(;o>=u+4;o-=3)s=`_${n.slice(o-3,o)}${s}`;return`${n.slice(0,o)}${s}`}function ge(n,s,o){q(s,"offset"),(n[s]===void 0||n[s+o]===void 0)&&N(s,n.length-(o+1))}function ae(n,s,o,u,d,C){if(n>o||n<s){const p=typeof s=="bigint"?"n":"";let h;throw C>3?s===0||s===BigInt(0)?h=`>= 0${p} and < 2${p} ** ${(C+1)*8}${p}`:h=`>= -(2${p} ** ${(C+1)*8-1}${p}) and < 2 ** ${(C+1)*8-1}${p}`:h=`>= ${s}${p} and <= ${o}${p}`,new G.ERR_OUT_OF_RANGE("value",h,n)}ge(u,d,C)}function q(n,s){if(typeof n!="number")throw new G.ERR_INVALID_ARG_TYPE(s,"number",n)}function N(n,s,o){throw Math.floor(n)!==n?(q(n,o),new G.ERR_OUT_OF_RANGE(o||"offset","an integer",n)):s<0?new G.ERR_BUFFER_OUT_OF_BOUNDS:new G.ERR_OUT_OF_RANGE(o||"offset",`>= ${o?1:0} and <= ${s}`,n)}const fe=/[^+/0-9A-Za-z-_]/g;function Be(n){if(n=n.split("=")[0],n=n.trim().replace(fe,""),n.length<2)return"";for(;n.length%4!==0;)n=n+"=";return n}function J(n,s){s=s||1/0;let o;const u=n.length;let d=null;const C=[];for(let p=0;p<u;++p){if(o=n.charCodeAt(p),o>55295&&o<57344){if(!d){if(o>56319){(s-=3)>-1&&C.push(239,191,189);continue}else if(p+1===u){(s-=3)>-1&&C.push(239,191,189);continue}d=o;continue}if(o<56320){(s-=3)>-1&&C.push(239,191,189),d=o;continue}o=(d-55296<<10|o-56320)+65536}else d&&(s-=3)>-1&&C.push(239,191,189);if(d=null,o<128){if((s-=1)<0)break;C.push(o)}else if(o<2048){if((s-=2)<0)break;C.push(o>>6|192,o&63|128)}else if(o<65536){if((s-=3)<0)break;C.push(o>>12|224,o>>6&63|128,o&63|128)}else if(o<1114112){if((s-=4)<0)break;C.push(o>>18|240,o>>12&63|128,o>>6&63|128,o&63|128)}else throw new Error("Invalid code point")}return C}function Re(n){const s=[];for(let o=0;o<n.length;++o)s.push(n.charCodeAt(o)&255);return s}function Te(n,s){let o,u,d;const C=[];for(let p=0;p<n.length&&!((s-=2)<0);++p)o=n.charCodeAt(p),u=o>>8,d=o%256,C.push(d),C.push(u);return C}function ie(n){return t.toByteArray(Be(n))}function _(n,s,o,u){let d;for(d=0;d<u&&!(d+o>=s.length||d>=n.length);++d)s[d+o]=n[d];return d}function U(n,s){return n instanceof s||n!=null&&n.constructor!=null&&n.constructor.name!=null&&n.constructor.name===s.name}function V(n){return n!==n}const Me=function(){const n="0123456789abcdef",s=new Array(256);for(let o=0;o<16;++o){const u=o*16;for(let d=0;d<16;++d)s[u+d]=n[o]+n[d]}return s}();function F(n){return typeof BigInt>"u"?we:n}function we(){throw new Error("BigInt not supported")}})(buffer);const TEST_DEBUG=!1;var RUN_MODE=(e=>(e[e.IDLE=0]="IDLE",e[e.RUNNING=-1]="RUNNING",e[e.PAUSED=-2]="PAUSED",e[e.NEED_BOOT=-3]="NEED_BOOT",e[e.NEED_RESET=-4]="NEED_RESET",e))(RUN_MODE||{}),MSG_WORKER=(e=>(e[e.MACHINE_STATE=0]="MACHINE_STATE",e[e.CLICK=1]="CLICK",e[e.DRIVE_PROPS=2]="DRIVE_PROPS",e[e.DRIVE_SOUND=3]="DRIVE_SOUND",e[e.SAVE_STATE=4]="SAVE_STATE",e[e.RUMBLE=5]="RUMBLE",e[e.HELP_TEXT=6]="HELP_TEXT",e[e.SHOW_MOUSE=7]="SHOW_MOUSE",e[e.MBOARD_SOUND=8]="MBOARD_SOUND",e[e.COMM_DATA=9]="COMM_DATA",e))(MSG_WORKER||{}),MSG_MAIN=(e=>(e[e.RUN_MODE=0]="RUN_MODE",e[e.STATE6502=1]="STATE6502",e[e.DEBUG=2]="DEBUG",e[e.DISASSEMBLE_ADDR=3]="DISASSEMBLE_ADDR",e[e.BREAKPOINTS=4]="BREAKPOINTS",e[e.STEP_INTO=5]="STEP_INTO",e[e.STEP_OVER=6]="STEP_OVER",e[e.STEP_OUT=7]="STEP_OUT",e[e.SPEED=8]="SPEED",e[e.TIME_TRAVEL_STEP=9]="TIME_TRAVEL_STEP",e[e.TIME_TRAVEL_INDEX=10]="TIME_TRAVEL_INDEX",e[e.TIME_TRAVEL_SNAPSHOT=11]="TIME_TRAVEL_SNAPSHOT",e[e.RESTORE_STATE=12]="RESTORE_STATE",e[e.KEYPRESS=13]="KEYPRESS",e[e.MOUSEEVENT=14]="MOUSEEVENT",e[e.PASTE_TEXT=15]="PASTE_TEXT",e[e.APPLE_PRESS=16]="APPLE_PRESS",e[e.APPLE_RELEASE=17]="APPLE_RELEASE",e[e.GET_SAVE_STATE=18]="GET_SAVE_STATE",e[e.GET_SAVE_STATE_SNAPSHOTS=19]="GET_SAVE_STATE_SNAPSHOTS",e[e.DRIVE_PROPS=20]="DRIVE_PROPS",e[e.GAMEPAD=21]="GAMEPAD",e[e.SET_BINARY_BLOCK=22]="SET_BINARY_BLOCK",e[e.COMM_DATA=23]="COMM_DATA",e))(MSG_MAIN||{}),DRIVE=(e=>(e[e.MOTOR_OFF=0]="MOTOR_OFF",e[e.MOTOR_ON=1]="MOTOR_ON",e[e.TRACK_END=2]="TRACK_END",e[e.TRACK_SEEK=3]="TRACK_SEEK",e))(DRIVE||{}),ADDR_MODE=(e=>(e[e.IMPLIED=0]="IMPLIED",e[e.IMM=1]="IMM",e[e.ZP_REL=2]="ZP_REL",e[e.ZP_X=3]="ZP_X",e[e.ZP_Y=4]="ZP_Y",e[e.ABS=5]="ABS",e[e.ABS_X=6]="ABS_X",e[e.ABS_Y=7]="ABS_Y",e[e.IND_X=8]="IND_X",e[e.IND_Y=9]="IND_Y",e[e.IND=10]="IND",e))(ADDR_MODE||{});const default6502State=()=>({cycleCount:0,PStatus:0,PC:0,Accum:0,XReg:0,YReg:0,StackPtr:0,flagIRQ:0,flagNMI:!1}),isBranchInstruction=e=>e.startsWith("B")&&e!=="BIT"&&e!=="BRK",toHex=(e,t=2)=>(e>255&&(t=4),("0000"+e.toString(16).toUpperCase()).slice(-t)),toASCII=e=>e.split("").map(t=>t.charCodeAt(0)),uint16toBytes=e=>[e&255,e>>>8&255],uint32toBytes=e=>[e&255,e>>>8&255,e>>>16&255,e>>>24&255],replaceSuffix=(e,t)=>{const r=e.lastIndexOf(".")+1;return e.substring(0,r)+t},crcTable=new Uint32Array(256).fill(0),makeCRCTable=()=>{let e;for(let t=0;t<256;t++){e=t;for(let r=0;r<8;r++)e=e&1?3988292384^e>>>1:e>>>1;crcTable[t]=e}},crc32=(e,t=0)=>{crcTable[255]===0&&makeCRCTable();let r=-1;for(let a=t;a<e.length;a++)r=r>>>8^crcTable[(r^e[a])&255];return(r^-1)>>>0};let gamePads;const maxTimeoutCycles=Math.trunc(.0028*1020484);let paddle0timeout=maxTimeoutCycles/2,paddle1timeout=maxTimeoutCycles/2,paddle2timeout=maxTimeoutCycles/2,paddle3timeout=maxTimeoutCycles/2,countStart=0,leftAppleDown=!1,rightAppleDown=!1,leftButtonDown=!1,rightButtonDown=!1,isPB2down=!1,isLeftDown=!1,isRightDown=!1;const setLeftButtonDown=()=>{leftButtonDown=!0},setRightButtonDown=()=>{rightButtonDown=!0},setPushButton2=()=>{isPB2down=!0},valueToTimeout=e=>(e=Math.min(Math.max(e,-1),1),(e+1)*maxTimeoutCycles/2),setGamepad0=e=>{paddle0timeout=valueToTimeout(e)},setGamepad1=e=>{paddle1timeout=valueToTimeout(e)},setGamepad2=e=>{paddle2timeout=valueToTimeout(e)},setGamepad3=e=>{paddle3timeout=valueToTimeout(e)},setButtonState=()=>{isLeftDown=leftAppleDown||leftButtonDown,isRightDown=rightAppleDown||rightButtonDown,SWITCHES.PB0.isSet=isLeftDown,SWITCHES.PB1.isSet=isRightDown||isPB2down,SWITCHES.PB2.isSet=isPB2down},pressAppleCommandKey=(e,t)=>{t?leftAppleDown=e:rightAppleDown=e,setButtonState()},resetJoystick=e=>{memSetC000(49252,128),memSetC000(49253,128),memSetC000(49254,128),memSetC000(49255,128),countStart=e},checkJoystickValues=e=>{const t=e-countStart;memSetC000(49252,t<paddle0timeout?128:0),memSetC000(49253,t<paddle1timeout?128:0),memSetC000(49254,t<paddle2timeout?128:0),memSetC000(49255,t<paddle3timeout?128:0)};let gameMapping,gamePadMapping,isKeyboardJoystick=!1;const setGamepads=e=>{gamePads=e,isKeyboardJoystick=!gamePads.length||!gamePads[0].buttons.length,gameMapping=getGameMapping(),gamePadMapping=gameMapping.gamepad?gameMapping.gamepad:defaultButtons},nearZero=e=>e>-.01&&e<.01,convertGamepadAxes=e=>{let t=e[0],r=e[1];nearZero(t)&&(t=0),nearZero(r)&&(r=0);const a=Math.sqrt(t*t+r*r),c=.95*(a===0?1:Math.max(Math.abs(t),Math.abs(r))/a);return t=Math.min(Math.max(-c,t),c),r=Math.min(Math.max(-c,r),c),t=Math.trunc(maxTimeoutCycles*(t+c)/(2*c)),r=Math.trunc(maxTimeoutCycles*(r+c)/(2*c)),[t,r]},handleGamepad=e=>{const t=gameMapping.joystick?gameMapping.joystick(gamePads[e].axes,isKeyboardJoystick):gamePads[e].axes,r=convertGamepadAxes(t);e===0?(paddle0timeout=r[0],paddle1timeout=r[1],leftButtonDown=!1,rightButtonDown=!1):(paddle2timeout=r[0],paddle3timeout=r[1],isPB2down=!1);let a=!1;gamePads[e].buttons.forEach((c,D)=>{c&&(gamePadMapping(D,gamePads.length>1,e===1),a=!0)}),a||gamePadMapping(-1,gamePads.length>1,e===1),gameMapping.rumble&&gameMapping.rumble(),setButtonState()},handleGamepads=()=>{gamePads&&gamePads.length>0&&(handleGamepad(0),gamePads.length>1&&handleGamepad(1))},gamepad$3=e=>{switch(e){case 0:addToBufferDebounce("JL");break;case 1:addToBufferDebounce("G",200);break;case 2:addToBuffer("M"),addToBufferDebounce("O");break;case 3:addToBufferDebounce("L");break;case 4:addToBufferDebounce("F");break;case 5:addToBuffer("P"),addToBufferDebounce("T");break;case 6:break;case 7:break;case 8:addToBufferDebounce("Z");break;case 9:{const t=getTextPageAsString();t.includes("'N'")?addToBuffer("N"):t.includes("'S'")?addToBuffer("S"):t.includes("NUMERIC KEY")?addToBuffer("1"):addToBuffer("N");break}case 10:break;case 11:break;case 12:addToBufferDebounce("L");break;case 13:addToBufferDebounce("M");break;case 14:addToBufferDebounce("A");break;case 15:addToBufferDebounce("D");break;case-1:return}};let leftdown=0,rightdown=0,buttonreleased=!1;const threshold$2=.5,joystick$2=e=>e[0]<-threshold$2?(rightdown=0,leftdown===0||leftdown>2?(leftdown=0,addToBuffer("A")):leftdown===1&&buttonreleased?addToBufferDebounce("W"):leftdown===2&&buttonreleased&&addToBufferDebounce("R"),leftdown++,buttonreleased=!1,e):e[0]>threshold$2?(leftdown=0,rightdown===0||rightdown>2?(rightdown=0,addToBuffer("D")):rightdown===1&&buttonreleased?addToBufferDebounce("W"):rightdown===2&&buttonreleased&&addToBufferDebounce("R"),rightdown++,buttonreleased=!1,e):e[1]<-threshold$2?(addToBufferDebounce("C"),e):e[1]>threshold$2?(addToBufferDebounce("S"),e):(buttonreleased=!0,e),helptext$6=`AZTEC
