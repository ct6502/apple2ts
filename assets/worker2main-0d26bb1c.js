var we=Object.defineProperty;var ke=(e,t,r)=>t in e?we(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var f=(e,t,r)=>(ke(e,typeof t!="symbol"?t+"":t,r),r);(function(){"use strict";var buffer={},base64Js={};base64Js.byteLength=byteLength,base64Js.toByteArray=toByteArray,base64Js.fromByteArray=fromByteArray;for(var lookup=[],revLookup=[],Arr=typeof Uint8Array<"u"?Uint8Array:Array,code$2="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=0,len=code$2.length;i<len;++i)lookup[i]=code$2[i],revLookup[code$2.charCodeAt(i)]=i;revLookup["-".charCodeAt(0)]=62,revLookup["_".charCodeAt(0)]=63;function getLens(e){var t=e.length;if(t%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var r=e.indexOf("=");r===-1&&(r=t);var n=r===t?0:4-r%4;return[r,n]}function byteLength(e){var t=getLens(e),r=t[0],n=t[1];return(r+n)*3/4-n}function _byteLength(e,t,r){return(t+r)*3/4-r}function toByteArray(e){var t,r=getLens(e),n=r[0],c=r[1],D=new Arr(_byteLength(e,n,c)),C=0,u=c>0?n-4:n,h;for(h=0;h<u;h+=4)t=revLookup[e.charCodeAt(h)]<<18|revLookup[e.charCodeAt(h+1)]<<12|revLookup[e.charCodeAt(h+2)]<<6|revLookup[e.charCodeAt(h+3)],D[C++]=t>>16&255,D[C++]=t>>8&255,D[C++]=t&255;return c===2&&(t=revLookup[e.charCodeAt(h)]<<2|revLookup[e.charCodeAt(h+1)]>>4,D[C++]=t&255),c===1&&(t=revLookup[e.charCodeAt(h)]<<10|revLookup[e.charCodeAt(h+1)]<<4|revLookup[e.charCodeAt(h+2)]>>2,D[C++]=t>>8&255,D[C++]=t&255),D}function tripletToBase64(e){return lookup[e>>18&63]+lookup[e>>12&63]+lookup[e>>6&63]+lookup[e&63]}function encodeChunk(e,t,r){for(var n,c=[],D=t;D<r;D+=3)n=(e[D]<<16&16711680)+(e[D+1]<<8&65280)+(e[D+2]&255),c.push(tripletToBase64(n));return c.join("")}function fromByteArray(e){for(var t,r=e.length,n=r%3,c=[],D=16383,C=0,u=r-n;C<u;C+=D)c.push(encodeChunk(e,C,C+D>u?u:C+D));return n===1?(t=e[r-1],c.push(lookup[t>>2]+lookup[t<<4&63]+"==")):n===2&&(t=(e[r-2]<<8)+e[r-1],c.push(lookup[t>>10]+lookup[t>>4&63]+lookup[t<<2&63]+"=")),c.join("")}var ieee754={};/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ieee754.read=function(e,t,r,n,c){var D,C,u=c*8-n-1,h=(1<<u)-1,R=h>>1,g=-7,p=r?c-1:0,M=r?-1:1,k=e[t+p];for(p+=M,D=k&(1<<-g)-1,k>>=-g,g+=u;g>0;D=D*256+e[t+p],p+=M,g-=8);for(C=D&(1<<-g)-1,D>>=-g,g+=n;g>0;C=C*256+e[t+p],p+=M,g-=8);if(D===0)D=1-R;else{if(D===h)return C?NaN:(k?-1:1)*(1/0);C=C+Math.pow(2,n),D=D-R}return(k?-1:1)*C*Math.pow(2,D-n)},ieee754.write=function(e,t,r,n,c,D){var C,u,h,R=D*8-c-1,g=(1<<R)-1,p=g>>1,M=c===23?Math.pow(2,-24)-Math.pow(2,-77):0,k=n?0:D-1,U=n?1:-1,L=t<0||t===0&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(u=isNaN(t)?1:0,C=g):(C=Math.floor(Math.log(t)/Math.LN2),t*(h=Math.pow(2,-C))<1&&(C--,h*=2),C+p>=1?t+=M/h:t+=M*Math.pow(2,1-p),t*h>=2&&(C++,h/=2),C+p>=g?(u=0,C=g):C+p>=1?(u=(t*h-1)*Math.pow(2,c),C=C+p):(u=t*Math.pow(2,p-1)*Math.pow(2,c),C=0));c>=8;e[r+k]=u&255,k+=U,u/=256,c-=8);for(C=C<<c|u,R+=c;R>0;e[r+k]=C&255,k+=U,C/=256,R-=8);e[r+k-U]|=L*128};/*!
 * The buffer module from node.js, for the browser.
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */(function(e){const t=base64Js,r=ieee754,n=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=u,e.SlowBuffer=W,e.INSPECT_MAX_BYTES=50;const c=2147483647;e.kMaxLength=c,u.TYPED_ARRAY_SUPPORT=D(),!u.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function D(){try{const a=new Uint8Array(1),s={foo:function(){return 42}};return Object.setPrototypeOf(s,Uint8Array.prototype),Object.setPrototypeOf(a,s),a.foo()===42}catch{return!1}}Object.defineProperty(u.prototype,"parent",{enumerable:!0,get:function(){if(u.isBuffer(this))return this.buffer}}),Object.defineProperty(u.prototype,"offset",{enumerable:!0,get:function(){if(u.isBuffer(this))return this.byteOffset}});function C(a){if(a>c)throw new RangeError('The value "'+a+'" is invalid for option "size"');const s=new Uint8Array(a);return Object.setPrototypeOf(s,u.prototype),s}function u(a,s,o){if(typeof a=="number"){if(typeof s=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return p(a)}return h(a,s,o)}u.poolSize=8192;function h(a,s,o){if(typeof a=="string")return M(a,s);if(ArrayBuffer.isView(a))return U(a);if(a==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof a);if(Q(a,ArrayBuffer)||a&&Q(a.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(Q(a,SharedArrayBuffer)||a&&Q(a.buffer,SharedArrayBuffer)))return L(a,s,o);if(typeof a=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const l=a.valueOf&&a.valueOf();if(l!=null&&l!==a)return u.from(l,s,o);const m=H(a);if(m)return m;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof a[Symbol.toPrimitive]=="function")return u.from(a[Symbol.toPrimitive]("string"),s,o);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof a)}u.from=function(a,s,o){return h(a,s,o)},Object.setPrototypeOf(u.prototype,Uint8Array.prototype),Object.setPrototypeOf(u,Uint8Array);function R(a){if(typeof a!="number")throw new TypeError('"size" argument must be of type number');if(a<0)throw new RangeError('The value "'+a+'" is invalid for option "size"')}function g(a,s,o){return R(a),a<=0?C(a):s!==void 0?typeof o=="string"?C(a).fill(s,o):C(a).fill(s):C(a)}u.alloc=function(a,s,o){return g(a,s,o)};function p(a){return R(a),C(a<0?0:_(a)|0)}u.allocUnsafe=function(a){return p(a)},u.allocUnsafeSlow=function(a){return p(a)};function M(a,s){if((typeof s!="string"||s==="")&&(s="utf8"),!u.isEncoding(s))throw new TypeError("Unknown encoding: "+s);const o=v(a,s)|0;let l=C(o);const m=l.write(a,s);return m!==o&&(l=l.slice(0,m)),l}function k(a){const s=a.length<0?0:_(a.length)|0,o=C(s);for(let l=0;l<s;l+=1)o[l]=a[l]&255;return o}function U(a){if(Q(a,Uint8Array)){const s=new Uint8Array(a);return L(s.buffer,s.byteOffset,s.byteLength)}return k(a)}function L(a,s,o){if(s<0||a.byteLength<s)throw new RangeError('"offset" is outside of buffer bounds');if(a.byteLength<s+(o||0))throw new RangeError('"length" is outside of buffer bounds');let l;return s===void 0&&o===void 0?l=new Uint8Array(a):o===void 0?l=new Uint8Array(a,s):l=new Uint8Array(a,s,o),Object.setPrototypeOf(l,u.prototype),l}function H(a){if(u.isBuffer(a)){const s=_(a.length)|0,o=C(s);return o.length===0||a.copy(o,0,0,s),o}if(a.length!==void 0)return typeof a.length!="number"||V(a.length)?C(0):k(a);if(a.type==="Buffer"&&Array.isArray(a.data))return k(a.data)}function _(a){if(a>=c)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+c.toString(16)+" bytes");return a|0}function W(a){return+a!=a&&(a=0),u.alloc(+a)}u.isBuffer=function(s){return s!=null&&s._isBuffer===!0&&s!==u.prototype},u.compare=function(s,o){if(Q(s,Uint8Array)&&(s=u.from(s,s.offset,s.byteLength)),Q(o,Uint8Array)&&(o=u.from(o,o.offset,o.byteLength)),!u.isBuffer(s)||!u.isBuffer(o))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(s===o)return 0;let l=s.length,m=o.length;for(let I=0,d=Math.min(l,m);I<d;++I)if(s[I]!==o[I]){l=s[I],m=o[I];break}return l<m?-1:m<l?1:0},u.isEncoding=function(s){switch(String(s).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},u.concat=function(s,o){if(!Array.isArray(s))throw new TypeError('"list" argument must be an Array of Buffers');if(s.length===0)return u.alloc(0);let l;if(o===void 0)for(o=0,l=0;l<s.length;++l)o+=s[l].length;const m=u.allocUnsafe(o);let I=0;for(l=0;l<s.length;++l){let d=s[l];if(Q(d,Uint8Array))I+d.length>m.length?(u.isBuffer(d)||(d=u.from(d)),d.copy(m,I)):Uint8Array.prototype.set.call(m,d,I);else if(u.isBuffer(d))d.copy(m,I);else throw new TypeError('"list" argument must be an Array of Buffers');I+=d.length}return m};function v(a,s){if(u.isBuffer(a))return a.length;if(ArrayBuffer.isView(a)||Q(a,ArrayBuffer))return a.byteLength;if(typeof a!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof a);const o=a.length,l=arguments.length>2&&arguments[2]===!0;if(!l&&o===0)return 0;let m=!1;for(;;)switch(s){case"ascii":case"latin1":case"binary":return o;case"utf8":case"utf-8":return J(a).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return o*2;case"hex":return o>>>1;case"base64":return ie(a).length;default:if(m)return l?-1:J(a).length;s=(""+s).toLowerCase(),m=!0}}u.byteLength=v;function ce(a,s,o){let l=!1;if((s===void 0||s<0)&&(s=0),s>this.length||((o===void 0||o>this.length)&&(o=this.length),o<=0)||(o>>>=0,s>>>=0,o<=s))return"";for(a||(a="utf8");;)switch(a){case"hex":return pe(this,s,o);case"utf8":case"utf-8":return z(this,s,o);case"ascii":return de(this,s,o);case"latin1":case"binary":return he(this,s,o);case"base64":return Ce(this,s,o);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Ee(this,s,o);default:if(l)throw new TypeError("Unknown encoding: "+a);a=(a+"").toLowerCase(),l=!0}}u.prototype._isBuffer=!0;function N(a,s,o){const l=a[s];a[s]=a[o],a[o]=l}u.prototype.swap16=function(){const s=this.length;if(s%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let o=0;o<s;o+=2)N(this,o,o+1);return this},u.prototype.swap32=function(){const s=this.length;if(s%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let o=0;o<s;o+=4)N(this,o,o+3),N(this,o+1,o+2);return this},u.prototype.swap64=function(){const s=this.length;if(s%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let o=0;o<s;o+=8)N(this,o,o+7),N(this,o+1,o+6),N(this,o+2,o+5),N(this,o+3,o+4);return this},u.prototype.toString=function(){const s=this.length;return s===0?"":arguments.length===0?z(this,0,s):ce.apply(this,arguments)},u.prototype.toLocaleString=u.prototype.toString,u.prototype.equals=function(s){if(!u.isBuffer(s))throw new TypeError("Argument must be a Buffer");return this===s?!0:u.compare(this,s)===0},u.prototype.inspect=function(){let s="";const o=e.INSPECT_MAX_BYTES;return s=this.toString("hex",0,o).replace(/(.{2})/g,"$1 ").trim(),this.length>o&&(s+=" ... "),"<Buffer "+s+">"},n&&(u.prototype[n]=u.prototype.inspect),u.prototype.compare=function(s,o,l,m,I){if(Q(s,Uint8Array)&&(s=u.from(s,s.offset,s.byteLength)),!u.isBuffer(s))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof s);if(o===void 0&&(o=0),l===void 0&&(l=s?s.length:0),m===void 0&&(m=0),I===void 0&&(I=this.length),o<0||l>s.length||m<0||I>this.length)throw new RangeError("out of range index");if(m>=I&&o>=l)return 0;if(m>=I)return-1;if(o>=l)return 1;if(o>>>=0,l>>>=0,m>>>=0,I>>>=0,this===s)return 0;let d=I-m,E=l-o;const O=Math.min(d,E),T=this.slice(m,I),w=s.slice(o,l);for(let B=0;B<O;++B)if(T[B]!==w[B]){d=T[B],E=w[B];break}return d<E?-1:E<d?1:0};function j(a,s,o,l,m){if(a.length===0)return-1;if(typeof o=="string"?(l=o,o=0):o>2147483647?o=2147483647:o<-2147483648&&(o=-2147483648),o=+o,V(o)&&(o=m?0:a.length-1),o<0&&(o=a.length+o),o>=a.length){if(m)return-1;o=a.length-1}else if(o<0)if(m)o=0;else return-1;if(typeof s=="string"&&(s=u.from(s,l)),u.isBuffer(s))return s.length===0?-1:$(a,s,o,l,m);if(typeof s=="number")return s=s&255,typeof Uint8Array.prototype.indexOf=="function"?m?Uint8Array.prototype.indexOf.call(a,s,o):Uint8Array.prototype.lastIndexOf.call(a,s,o):$(a,[s],o,l,m);throw new TypeError("val must be string, number or Buffer")}function $(a,s,o,l,m){let I=1,d=a.length,E=s.length;if(l!==void 0&&(l=String(l).toLowerCase(),l==="ucs2"||l==="ucs-2"||l==="utf16le"||l==="utf-16le")){if(a.length<2||s.length<2)return-1;I=2,d/=2,E/=2,o/=2}function O(w,B){return I===1?w[B]:w.readUInt16BE(B*I)}let T;if(m){let w=-1;for(T=o;T<d;T++)if(O(a,T)===O(s,w===-1?0:T-w)){if(w===-1&&(w=T),T-w+1===E)return w*I}else w!==-1&&(T-=T-w),w=-1}else for(o+E>d&&(o=d-E),T=o;T>=0;T--){let w=!0;for(let B=0;B<E;B++)if(O(a,T+B)!==O(s,B)){w=!1;break}if(w)return T}return-1}u.prototype.includes=function(s,o,l){return this.indexOf(s,o,l)!==-1},u.prototype.indexOf=function(s,o,l){return j(this,s,o,l,!0)},u.prototype.lastIndexOf=function(s,o,l){return j(this,s,o,l,!1)};function le(a,s,o,l){o=Number(o)||0;const m=a.length-o;l?(l=Number(l),l>m&&(l=m)):l=m;const I=s.length;l>I/2&&(l=I/2);let d;for(d=0;d<l;++d){const E=parseInt(s.substr(d*2,2),16);if(V(E))return d;a[o+d]=E}return d}function ue(a,s,o,l){return x(J(s,a.length-o),a,o,l)}function De(a,s,o,l){return x(Re(s),a,o,l)}function Se(a,s,o,l){return x(ie(s),a,o,l)}function me(a,s,o,l){return x(Te(s,a.length-o),a,o,l)}u.prototype.write=function(s,o,l,m){if(o===void 0)m="utf8",l=this.length,o=0;else if(l===void 0&&typeof o=="string")m=o,l=this.length,o=0;else if(isFinite(o))o=o>>>0,isFinite(l)?(l=l>>>0,m===void 0&&(m="utf8")):(m=l,l=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const I=this.length-o;if((l===void 0||l>I)&&(l=I),s.length>0&&(l<0||o<0)||o>this.length)throw new RangeError("Attempt to write outside buffer bounds");m||(m="utf8");let d=!1;for(;;)switch(m){case"hex":return le(this,s,o,l);case"utf8":case"utf-8":return ue(this,s,o,l);case"ascii":case"latin1":case"binary":return De(this,s,o,l);case"base64":return Se(this,s,o,l);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return me(this,s,o,l);default:if(d)throw new TypeError("Unknown encoding: "+m);m=(""+m).toLowerCase(),d=!0}},u.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function Ce(a,s,o){return s===0&&o===a.length?t.fromByteArray(a):t.fromByteArray(a.slice(s,o))}function z(a,s,o){o=Math.min(a.length,o);const l=[];let m=s;for(;m<o;){const I=a[m];let d=null,E=I>239?4:I>223?3:I>191?2:1;if(m+E<=o){let O,T,w,B;switch(E){case 1:I<128&&(d=I);break;case 2:O=a[m+1],(O&192)===128&&(B=(I&31)<<6|O&63,B>127&&(d=B));break;case 3:O=a[m+1],T=a[m+2],(O&192)===128&&(T&192)===128&&(B=(I&15)<<12|(O&63)<<6|T&63,B>2047&&(B<55296||B>57343)&&(d=B));break;case 4:O=a[m+1],T=a[m+2],w=a[m+3],(O&192)===128&&(T&192)===128&&(w&192)===128&&(B=(I&15)<<18|(O&63)<<12|(T&63)<<6|w&63,B>65535&&B<1114112&&(d=B))}}d===null?(d=65533,E=1):d>65535&&(d-=65536,l.push(d>>>10&1023|55296),d=56320|d&1023),l.push(d),m+=E}return Ie(l)}const ee=4096;function Ie(a){const s=a.length;if(s<=ee)return String.fromCharCode.apply(String,a);let o="",l=0;for(;l<s;)o+=String.fromCharCode.apply(String,a.slice(l,l+=ee));return o}function de(a,s,o){let l="";o=Math.min(a.length,o);for(let m=s;m<o;++m)l+=String.fromCharCode(a[m]&127);return l}function he(a,s,o){let l="";o=Math.min(a.length,o);for(let m=s;m<o;++m)l+=String.fromCharCode(a[m]);return l}function pe(a,s,o){const l=a.length;(!s||s<0)&&(s=0),(!o||o<0||o>l)&&(o=l);let m="";for(let I=s;I<o;++I)m+=Me[a[I]];return m}function Ee(a,s,o){const l=a.slice(s,o);let m="";for(let I=0;I<l.length-1;I+=2)m+=String.fromCharCode(l[I]+l[I+1]*256);return m}u.prototype.slice=function(s,o){const l=this.length;s=~~s,o=o===void 0?l:~~o,s<0?(s+=l,s<0&&(s=0)):s>l&&(s=l),o<0?(o+=l,o<0&&(o=0)):o>l&&(o=l),o<s&&(o=s);const m=this.subarray(s,o);return Object.setPrototypeOf(m,u.prototype),m};function y(a,s,o){if(a%1!==0||a<0)throw new RangeError("offset is not uint");if(a+s>o)throw new RangeError("Trying to access beyond buffer length")}u.prototype.readUintLE=u.prototype.readUIntLE=function(s,o,l){s=s>>>0,o=o>>>0,l||y(s,o,this.length);let m=this[s],I=1,d=0;for(;++d<o&&(I*=256);)m+=this[s+d]*I;return m},u.prototype.readUintBE=u.prototype.readUIntBE=function(s,o,l){s=s>>>0,o=o>>>0,l||y(s,o,this.length);let m=this[s+--o],I=1;for(;o>0&&(I*=256);)m+=this[s+--o]*I;return m},u.prototype.readUint8=u.prototype.readUInt8=function(s,o){return s=s>>>0,o||y(s,1,this.length),this[s]},u.prototype.readUint16LE=u.prototype.readUInt16LE=function(s,o){return s=s>>>0,o||y(s,2,this.length),this[s]|this[s+1]<<8},u.prototype.readUint16BE=u.prototype.readUInt16BE=function(s,o){return s=s>>>0,o||y(s,2,this.length),this[s]<<8|this[s+1]},u.prototype.readUint32LE=u.prototype.readUInt32LE=function(s,o){return s=s>>>0,o||y(s,4,this.length),(this[s]|this[s+1]<<8|this[s+2]<<16)+this[s+3]*16777216},u.prototype.readUint32BE=u.prototype.readUInt32BE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]*16777216+(this[s+1]<<16|this[s+2]<<8|this[s+3])},u.prototype.readBigUInt64LE=F(function(s){s=s>>>0,G(s,"offset");const o=this[s],l=this[s+7];(o===void 0||l===void 0)&&q(s,this.length-8);const m=o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24,I=this[++s]+this[++s]*2**8+this[++s]*2**16+l*2**24;return BigInt(m)+(BigInt(I)<<BigInt(32))}),u.prototype.readBigUInt64BE=F(function(s){s=s>>>0,G(s,"offset");const o=this[s],l=this[s+7];(o===void 0||l===void 0)&&q(s,this.length-8);const m=o*2**24+this[++s]*2**16+this[++s]*2**8+this[++s],I=this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+l;return(BigInt(m)<<BigInt(32))+BigInt(I)}),u.prototype.readIntLE=function(s,o,l){s=s>>>0,o=o>>>0,l||y(s,o,this.length);let m=this[s],I=1,d=0;for(;++d<o&&(I*=256);)m+=this[s+d]*I;return I*=128,m>=I&&(m-=Math.pow(2,8*o)),m},u.prototype.readIntBE=function(s,o,l){s=s>>>0,o=o>>>0,l||y(s,o,this.length);let m=o,I=1,d=this[s+--m];for(;m>0&&(I*=256);)d+=this[s+--m]*I;return I*=128,d>=I&&(d-=Math.pow(2,8*o)),d},u.prototype.readInt8=function(s,o){return s=s>>>0,o||y(s,1,this.length),this[s]&128?(255-this[s]+1)*-1:this[s]},u.prototype.readInt16LE=function(s,o){s=s>>>0,o||y(s,2,this.length);const l=this[s]|this[s+1]<<8;return l&32768?l|4294901760:l},u.prototype.readInt16BE=function(s,o){s=s>>>0,o||y(s,2,this.length);const l=this[s+1]|this[s]<<8;return l&32768?l|4294901760:l},u.prototype.readInt32LE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]|this[s+1]<<8|this[s+2]<<16|this[s+3]<<24},u.prototype.readInt32BE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]<<24|this[s+1]<<16|this[s+2]<<8|this[s+3]},u.prototype.readBigInt64LE=F(function(s){s=s>>>0,G(s,"offset");const o=this[s],l=this[s+7];(o===void 0||l===void 0)&&q(s,this.length-8);const m=this[s+4]+this[s+5]*2**8+this[s+6]*2**16+(l<<24);return(BigInt(m)<<BigInt(32))+BigInt(o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24)}),u.prototype.readBigInt64BE=F(function(s){s=s>>>0,G(s,"offset");const o=this[s],l=this[s+7];(o===void 0||l===void 0)&&q(s,this.length-8);const m=(o<<24)+this[++s]*2**16+this[++s]*2**8+this[++s];return(BigInt(m)<<BigInt(32))+BigInt(this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+l)}),u.prototype.readFloatLE=function(s,o){return s=s>>>0,o||y(s,4,this.length),r.read(this,s,!0,23,4)},u.prototype.readFloatBE=function(s,o){return s=s>>>0,o||y(s,4,this.length),r.read(this,s,!1,23,4)},u.prototype.readDoubleLE=function(s,o){return s=s>>>0,o||y(s,8,this.length),r.read(this,s,!0,52,8)},u.prototype.readDoubleBE=function(s,o){return s=s>>>0,o||y(s,8,this.length),r.read(this,s,!1,52,8)};function b(a,s,o,l,m,I){if(!u.isBuffer(a))throw new TypeError('"buffer" argument must be a Buffer instance');if(s>m||s<I)throw new RangeError('"value" argument is out of bounds');if(o+l>a.length)throw new RangeError("Index out of range")}u.prototype.writeUintLE=u.prototype.writeUIntLE=function(s,o,l,m){if(s=+s,o=o>>>0,l=l>>>0,!m){const E=Math.pow(2,8*l)-1;b(this,s,o,l,E,0)}let I=1,d=0;for(this[o]=s&255;++d<l&&(I*=256);)this[o+d]=s/I&255;return o+l},u.prototype.writeUintBE=u.prototype.writeUIntBE=function(s,o,l,m){if(s=+s,o=o>>>0,l=l>>>0,!m){const E=Math.pow(2,8*l)-1;b(this,s,o,l,E,0)}let I=l-1,d=1;for(this[o+I]=s&255;--I>=0&&(d*=256);)this[o+I]=s/d&255;return o+l},u.prototype.writeUint8=u.prototype.writeUInt8=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,1,255,0),this[o]=s&255,o+1},u.prototype.writeUint16LE=u.prototype.writeUInt16LE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,2,65535,0),this[o]=s&255,this[o+1]=s>>>8,o+2},u.prototype.writeUint16BE=u.prototype.writeUInt16BE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,2,65535,0),this[o]=s>>>8,this[o+1]=s&255,o+2},u.prototype.writeUint32LE=u.prototype.writeUInt32LE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,4,4294967295,0),this[o+3]=s>>>24,this[o+2]=s>>>16,this[o+1]=s>>>8,this[o]=s&255,o+4},u.prototype.writeUint32BE=u.prototype.writeUInt32BE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,4,4294967295,0),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4};function te(a,s,o,l,m){ae(s,l,m,a,o,7);let I=Number(s&BigInt(4294967295));a[o++]=I,I=I>>8,a[o++]=I,I=I>>8,a[o++]=I,I=I>>8,a[o++]=I;let d=Number(s>>BigInt(32)&BigInt(4294967295));return a[o++]=d,d=d>>8,a[o++]=d,d=d>>8,a[o++]=d,d=d>>8,a[o++]=d,o}function re(a,s,o,l,m){ae(s,l,m,a,o,7);let I=Number(s&BigInt(4294967295));a[o+7]=I,I=I>>8,a[o+6]=I,I=I>>8,a[o+5]=I,I=I>>8,a[o+4]=I;let d=Number(s>>BigInt(32)&BigInt(4294967295));return a[o+3]=d,d=d>>8,a[o+2]=d,d=d>>8,a[o+1]=d,d=d>>8,a[o]=d,o+8}u.prototype.writeBigUInt64LE=F(function(s,o=0){return te(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),u.prototype.writeBigUInt64BE=F(function(s,o=0){return re(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),u.prototype.writeIntLE=function(s,o,l,m){if(s=+s,o=o>>>0,!m){const O=Math.pow(2,8*l-1);b(this,s,o,l,O-1,-O)}let I=0,d=1,E=0;for(this[o]=s&255;++I<l&&(d*=256);)s<0&&E===0&&this[o+I-1]!==0&&(E=1),this[o+I]=(s/d>>0)-E&255;return o+l},u.prototype.writeIntBE=function(s,o,l,m){if(s=+s,o=o>>>0,!m){const O=Math.pow(2,8*l-1);b(this,s,o,l,O-1,-O)}let I=l-1,d=1,E=0;for(this[o+I]=s&255;--I>=0&&(d*=256);)s<0&&E===0&&this[o+I+1]!==0&&(E=1),this[o+I]=(s/d>>0)-E&255;return o+l},u.prototype.writeInt8=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,1,127,-128),s<0&&(s=255+s+1),this[o]=s&255,o+1},u.prototype.writeInt16LE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,2,32767,-32768),this[o]=s&255,this[o+1]=s>>>8,o+2},u.prototype.writeInt16BE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,2,32767,-32768),this[o]=s>>>8,this[o+1]=s&255,o+2},u.prototype.writeInt32LE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,4,2147483647,-2147483648),this[o]=s&255,this[o+1]=s>>>8,this[o+2]=s>>>16,this[o+3]=s>>>24,o+4},u.prototype.writeInt32BE=function(s,o,l){return s=+s,o=o>>>0,l||b(this,s,o,4,2147483647,-2147483648),s<0&&(s=4294967295+s+1),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4},u.prototype.writeBigInt64LE=F(function(s,o=0){return te(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),u.prototype.writeBigInt64BE=F(function(s,o=0){return re(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function se(a,s,o,l,m,I){if(o+l>a.length)throw new RangeError("Index out of range");if(o<0)throw new RangeError("Index out of range")}function oe(a,s,o,l,m){return s=+s,o=o>>>0,m||se(a,s,o,4),r.write(a,s,o,l,23,4),o+4}u.prototype.writeFloatLE=function(s,o,l){return oe(this,s,o,!0,l)},u.prototype.writeFloatBE=function(s,o,l){return oe(this,s,o,!1,l)};function Ae(a,s,o,l,m){return s=+s,o=o>>>0,m||se(a,s,o,8),r.write(a,s,o,l,52,8),o+8}u.prototype.writeDoubleLE=function(s,o,l){return Ae(this,s,o,!0,l)},u.prototype.writeDoubleBE=function(s,o,l){return Ae(this,s,o,!1,l)},u.prototype.copy=function(s,o,l,m){if(!u.isBuffer(s))throw new TypeError("argument should be a Buffer");if(l||(l=0),!m&&m!==0&&(m=this.length),o>=s.length&&(o=s.length),o||(o=0),m>0&&m<l&&(m=l),m===l||s.length===0||this.length===0)return 0;if(o<0)throw new RangeError("targetStart out of bounds");if(l<0||l>=this.length)throw new RangeError("Index out of range");if(m<0)throw new RangeError("sourceEnd out of bounds");m>this.length&&(m=this.length),s.length-o<m-l&&(m=s.length-o+l);const I=m-l;return this===s&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(o,l,m):Uint8Array.prototype.set.call(s,this.subarray(l,m),o),I},u.prototype.fill=function(s,o,l,m){if(typeof s=="string"){if(typeof o=="string"?(m=o,o=0,l=this.length):typeof l=="string"&&(m=l,l=this.length),m!==void 0&&typeof m!="string")throw new TypeError("encoding must be a string");if(typeof m=="string"&&!u.isEncoding(m))throw new TypeError("Unknown encoding: "+m);if(s.length===1){const d=s.charCodeAt(0);(m==="utf8"&&d<128||m==="latin1")&&(s=d)}}else typeof s=="number"?s=s&255:typeof s=="boolean"&&(s=Number(s));if(o<0||this.length<o||this.length<l)throw new RangeError("Out of range index");if(l<=o)return this;o=o>>>0,l=l===void 0?this.length:l>>>0,s||(s=0);let I;if(typeof s=="number")for(I=o;I<l;++I)this[I]=s;else{const d=u.isBuffer(s)?s:u.from(s,m),E=d.length;if(E===0)throw new TypeError('The value "'+s+'" is invalid for argument "value"');for(I=0;I<l-o;++I)this[I+o]=d[I%E]}return this};const K={};function Z(a,s,o){K[a]=class extends o{constructor(){super(),Object.defineProperty(this,"message",{value:s.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${a}]`,this.stack,delete this.name}get code(){return a}set code(m){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:m,writable:!0})}toString(){return`${this.name} [${a}]: ${this.message}`}}}Z("ERR_BUFFER_OUT_OF_BOUNDS",function(a){return a?`${a} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),Z("ERR_INVALID_ARG_TYPE",function(a,s){return`The "${a}" argument must be of type number. Received type ${typeof s}`},TypeError),Z("ERR_OUT_OF_RANGE",function(a,s,o){let l=`The value of "${a}" is out of range.`,m=o;return Number.isInteger(o)&&Math.abs(o)>2**32?m=ne(String(o)):typeof o=="bigint"&&(m=String(o),(o>BigInt(2)**BigInt(32)||o<-(BigInt(2)**BigInt(32)))&&(m=ne(m)),m+="n"),l+=` It must be ${s}. Received ${m}`,l},RangeError);function ne(a){let s="",o=a.length;const l=a[0]==="-"?1:0;for(;o>=l+4;o-=3)s=`_${a.slice(o-3,o)}${s}`;return`${a.slice(0,o)}${s}`}function ge(a,s,o){G(s,"offset"),(a[s]===void 0||a[s+o]===void 0)&&q(s,a.length-(o+1))}function ae(a,s,o,l,m,I){if(a>o||a<s){const d=typeof s=="bigint"?"n":"";let E;throw I>3?s===0||s===BigInt(0)?E=`>= 0${d} and < 2${d} ** ${(I+1)*8}${d}`:E=`>= -(2${d} ** ${(I+1)*8-1}${d}) and < 2 ** ${(I+1)*8-1}${d}`:E=`>= ${s}${d} and <= ${o}${d}`,new K.ERR_OUT_OF_RANGE("value",E,a)}ge(l,m,I)}function G(a,s){if(typeof a!="number")throw new K.ERR_INVALID_ARG_TYPE(s,"number",a)}function q(a,s,o){throw Math.floor(a)!==a?(G(a,o),new K.ERR_OUT_OF_RANGE(o||"offset","an integer",a)):s<0?new K.ERR_BUFFER_OUT_OF_BOUNDS:new K.ERR_OUT_OF_RANGE(o||"offset",`>= ${o?1:0} and <= ${s}`,a)}const fe=/[^+/0-9A-Za-z-_]/g;function Be(a){if(a=a.split("=")[0],a=a.trim().replace(fe,""),a.length<2)return"";for(;a.length%4!==0;)a=a+"=";return a}function J(a,s){s=s||1/0;let o;const l=a.length;let m=null;const I=[];for(let d=0;d<l;++d){if(o=a.charCodeAt(d),o>55295&&o<57344){if(!m){if(o>56319){(s-=3)>-1&&I.push(239,191,189);continue}else if(d+1===l){(s-=3)>-1&&I.push(239,191,189);continue}m=o;continue}if(o<56320){(s-=3)>-1&&I.push(239,191,189),m=o;continue}o=(m-55296<<10|o-56320)+65536}else m&&(s-=3)>-1&&I.push(239,191,189);if(m=null,o<128){if((s-=1)<0)break;I.push(o)}else if(o<2048){if((s-=2)<0)break;I.push(o>>6|192,o&63|128)}else if(o<65536){if((s-=3)<0)break;I.push(o>>12|224,o>>6&63|128,o&63|128)}else if(o<1114112){if((s-=4)<0)break;I.push(o>>18|240,o>>12&63|128,o>>6&63|128,o&63|128)}else throw new Error("Invalid code point")}return I}function Re(a){const s=[];for(let o=0;o<a.length;++o)s.push(a.charCodeAt(o)&255);return s}function Te(a,s){let o,l,m;const I=[];for(let d=0;d<a.length&&!((s-=2)<0);++d)o=a.charCodeAt(d),l=o>>8,m=o%256,I.push(m),I.push(l);return I}function ie(a){return t.toByteArray(Be(a))}function x(a,s,o,l){let m;for(m=0;m<l&&!(m+o>=s.length||m>=a.length);++m)s[m+o]=a[m];return m}function Q(a,s){return a instanceof s||a!=null&&a.constructor!=null&&a.constructor.name!=null&&a.constructor.name===s.name}function V(a){return a!==a}const Me=function(){const a="0123456789abcdef",s=new Array(256);for(let o=0;o<16;++o){const l=o*16;for(let m=0;m<16;++m)s[l+m]=a[o]+a[m]}return s}();function F(a){return typeof BigInt>"u"?Oe:a}function Oe(){throw new Error("BigInt not supported")}})(buffer);const TEST_DEBUG=!1;var RUN_MODE=(e=>(e[e.IDLE=0]="IDLE",e[e.RUNNING=-1]="RUNNING",e[e.PAUSED=-2]="PAUSED",e[e.NEED_BOOT=-3]="NEED_BOOT",e[e.NEED_RESET=-4]="NEED_RESET",e))(RUN_MODE||{}),MSG_WORKER=(e=>(e[e.MACHINE_STATE=0]="MACHINE_STATE",e[e.CLICK=1]="CLICK",e[e.DRIVE_PROPS=2]="DRIVE_PROPS",e[e.DRIVE_SOUND=3]="DRIVE_SOUND",e[e.SAVE_STATE=4]="SAVE_STATE",e[e.RUMBLE=5]="RUMBLE",e[e.HELP_TEXT=6]="HELP_TEXT",e[e.SHOW_MOUSE=7]="SHOW_MOUSE",e[e.MBOARD_SOUND=8]="MBOARD_SOUND",e[e.COMM_DATA=9]="COMM_DATA",e[e.MIDI_DATA=10]="MIDI_DATA",e))(MSG_WORKER||{}),MSG_MAIN=(e=>(e[e.RUN_MODE=0]="RUN_MODE",e[e.STATE6502=1]="STATE6502",e[e.DEBUG=2]="DEBUG",e[e.DISASSEMBLE_ADDR=3]="DISASSEMBLE_ADDR",e[e.BREAKPOINTS=4]="BREAKPOINTS",e[e.STEP_INTO=5]="STEP_INTO",e[e.STEP_OVER=6]="STEP_OVER",e[e.STEP_OUT=7]="STEP_OUT",e[e.SPEED=8]="SPEED",e[e.TIME_TRAVEL_STEP=9]="TIME_TRAVEL_STEP",e[e.TIME_TRAVEL_INDEX=10]="TIME_TRAVEL_INDEX",e[e.TIME_TRAVEL_SNAPSHOT=11]="TIME_TRAVEL_SNAPSHOT",e[e.RESTORE_STATE=12]="RESTORE_STATE",e[e.KEYPRESS=13]="KEYPRESS",e[e.MOUSEEVENT=14]="MOUSEEVENT",e[e.PASTE_TEXT=15]="PASTE_TEXT",e[e.APPLE_PRESS=16]="APPLE_PRESS",e[e.APPLE_RELEASE=17]="APPLE_RELEASE",e[e.GET_SAVE_STATE=18]="GET_SAVE_STATE",e[e.GET_SAVE_STATE_SNAPSHOTS=19]="GET_SAVE_STATE_SNAPSHOTS",e[e.DRIVE_PROPS=20]="DRIVE_PROPS",e[e.GAMEPAD=21]="GAMEPAD",e[e.SET_BINARY_BLOCK=22]="SET_BINARY_BLOCK",e[e.COMM_DATA=23]="COMM_DATA",e[e.MIDI_DATA=24]="MIDI_DATA",e))(MSG_MAIN||{}),DRIVE=(e=>(e[e.MOTOR_OFF=0]="MOTOR_OFF",e[e.MOTOR_ON=1]="MOTOR_ON",e[e.TRACK_END=2]="TRACK_END",e[e.TRACK_SEEK=3]="TRACK_SEEK",e))(DRIVE||{}),ADDR_MODE=(e=>(e[e.IMPLIED=0]="IMPLIED",e[e.IMM=1]="IMM",e[e.ZP_REL=2]="ZP_REL",e[e.ZP_X=3]="ZP_X",e[e.ZP_Y=4]="ZP_Y",e[e.ABS=5]="ABS",e[e.ABS_X=6]="ABS_X",e[e.ABS_Y=7]="ABS_Y",e[e.IND_X=8]="IND_X",e[e.IND_Y=9]="IND_Y",e[e.IND=10]="IND",e))(ADDR_MODE||{});const default6502State=()=>({cycleCount:0,PStatus:0,PC:0,Accum:0,XReg:0,YReg:0,StackPtr:0,flagIRQ:0,flagNMI:!1}),isBranchInstruction=e=>e.startsWith("B")&&e!=="BIT"&&e!=="BRK",toHex=(e,t=2)=>(e>255&&(t=4),("0000"+e.toString(16).toUpperCase()).slice(-t)),toASCII=e=>e.split("").map(t=>t.charCodeAt(0)),uint16toBytes=e=>[e&255,e>>>8&255],uint32toBytes=e=>[e&255,e>>>8&255,e>>>16&255,e>>>24&255],replaceSuffix=(e,t)=>{const r=e.lastIndexOf(".")+1;return e.substring(0,r)+t},crcTable=new Uint32Array(256).fill(0),makeCRCTable=()=>{let e;for(let t=0;t<256;t++){e=t;for(let r=0;r<8;r++)e=e&1?3988292384^e>>>1:e>>>1;crcTable[t]=e}},crc32=(e,t=0)=>{crcTable[255]===0&&makeCRCTable();let r=-1;for(let n=t;n<e.length;n++)r=r>>>8^crcTable[(r^e[n])&255];return(r^-1)>>>0};let gamePads;const maxTimeoutCycles=Math.trunc(.0028*1020484);let paddle0timeout=maxTimeoutCycles/2,paddle1timeout=maxTimeoutCycles/2,paddle2timeout=maxTimeoutCycles/2,paddle3timeout=maxTimeoutCycles/2,countStart=0,leftAppleDown=!1,rightAppleDown=!1,leftButtonDown=!1,rightButtonDown=!1,isPB2down=!1,isLeftDown=!1,isRightDown=!1;const setLeftButtonDown=()=>{leftButtonDown=!0},setRightButtonDown=()=>{rightButtonDown=!0},setPushButton2=()=>{isPB2down=!0},valueToTimeout=e=>(e=Math.min(Math.max(e,-1),1),(e+1)*maxTimeoutCycles/2),setGamepad0=e=>{paddle0timeout=valueToTimeout(e)},setGamepad1=e=>{paddle1timeout=valueToTimeout(e)},setGamepad2=e=>{paddle2timeout=valueToTimeout(e)},setGamepad3=e=>{paddle3timeout=valueToTimeout(e)},setButtonState=()=>{isLeftDown=leftAppleDown||leftButtonDown,isRightDown=rightAppleDown||rightButtonDown,SWITCHES.PB0.isSet=isLeftDown,SWITCHES.PB1.isSet=isRightDown||isPB2down,SWITCHES.PB2.isSet=isPB2down},pressAppleCommandKey=(e,t)=>{t?leftAppleDown=e:rightAppleDown=e,setButtonState()},resetJoystick=e=>{memSetC000(49252,128),memSetC000(49253,128),memSetC000(49254,128),memSetC000(49255,128),countStart=e},checkJoystickValues=e=>{const t=e-countStart;memSetC000(49252,t<paddle0timeout?128:0),memSetC000(49253,t<paddle1timeout?128:0),memSetC000(49254,t<paddle2timeout?128:0),memSetC000(49255,t<paddle3timeout?128:0)};let gameMapping,gamePadMapping,isKeyboardJoystick=!1;const setGamepads=e=>{gamePads=e,isKeyboardJoystick=!gamePads.length||!gamePads[0].buttons.length,gameMapping=getGameMapping(),gamePadMapping=gameMapping.gamepad?gameMapping.gamepad:defaultButtons},nearZero=e=>e>-.01&&e<.01,convertGamepadAxes=e=>{let t=e[0],r=e[1];nearZero(t)&&(t=0),nearZero(r)&&(r=0);const n=Math.sqrt(t*t+r*r),c=.95*(n===0?1:Math.max(Math.abs(t),Math.abs(r))/n);return t=Math.min(Math.max(-c,t),c),r=Math.min(Math.max(-c,r),c),t=Math.trunc(maxTimeoutCycles*(t+c)/(2*c)),r=Math.trunc(maxTimeoutCycles*(r+c)/(2*c)),[t,r]},handleGamepad=e=>{const t=gameMapping.joystick?gameMapping.joystick(gamePads[e].axes,isKeyboardJoystick):gamePads[e].axes,r=convertGamepadAxes(t);e===0?(paddle0timeout=r[0],paddle1timeout=r[1],leftButtonDown=!1,rightButtonDown=!1):(paddle2timeout=r[0],paddle3timeout=r[1],isPB2down=!1);let n=!1;gamePads[e].buttons.forEach((c,D)=>{c&&(gamePadMapping(D,gamePads.length>1,e===1),n=!0)}),n||gamePadMapping(-1,gamePads.length>1,e===1),gameMapping.rumble&&gameMapping.rumble(),setButtonState()},handleGamepads=()=>{gamePads&&gamePads.length>0&&(handleGamepad(0),gamePads.length>1&&handleGamepad(1))},gamepad$3=e=>{switch(e){case 0:addToBufferDebounce("JL");break;case 1:addToBufferDebounce("G",200);break;case 2:addToBuffer("M"),addToBufferDebounce("O");break;case 3:addToBufferDebounce("L");break;case 4:addToBufferDebounce("F");break;case 5:addToBuffer("P"),addToBufferDebounce("T");break;case 6:break;case 7:break;case 8:addToBufferDebounce("Z");break;case 9:{const t=getTextPageAsString();t.includes("'N'")?addToBuffer("N"):t.includes("'S'")?addToBuffer("S"):t.includes("NUMERIC KEY")?addToBuffer("1"):addToBuffer("N");break}case 10:break;case 11:break;case 12:addToBufferDebounce("L");break;case 13:addToBufferDebounce("M");break;case 14:addToBufferDebounce("A");break;case 15:addToBufferDebounce("D");break;case-1:return}};let leftdown=0,rightdown=0,buttonreleased=!1;const threshold$2=.5,joystick$2=e=>e[0]<-threshold$2?(rightdown=0,leftdown===0||leftdown>2?(leftdown=0,addToBuffer("A")):leftdown===1&&buttonreleased?addToBufferDebounce("W"):leftdown===2&&buttonreleased&&addToBufferDebounce("R"),leftdown++,buttonreleased=!1,e):e[0]>threshold$2?(leftdown=0,rightdown===0||rightdown>2?(rightdown=0,addToBuffer("D")):rightdown===1&&buttonreleased?addToBufferDebounce("W"):rightdown===2&&buttonreleased&&addToBufferDebounce("R"),rightdown++,buttonreleased=!1,e):e[1]<-threshold$2?(addToBufferDebounce("C"),e):e[1]>threshold$2?(addToBufferDebounce("S"),e):(buttonreleased=!0,e),helptext$6=`AZTEC
...
*/const encode_6_and_2=e=>{const t=[150,151,154,155,157,158,159,166,167,171,172,173,174,175,178,179,180,181,182,183,185,186,187,188,189,190,191,203,205,206,207,211,214,215,217,218,219,220,221,222,223,229,230,231,233,234,235,236,237,238,239,242,243,244,245,246,247,249,250,251,252,253,254,255],r=new Uint8Array(343),n=[0,2,1,3];for(let D=0;D<84;D++)r[D]=n[e[D]&3]|n[e[D+86]&3]<<2|n[e[D+172]&3]<<4;r[84]=n[e[84]&3]<<0|n[e[170]&3]<<2,r[85]=n[e[85]&3]<<0|n[e[171]&3]<<2;for(let D=0;D<256;D++)r[86+D]=e[D]>>>2;r[342]=r[341];let c=342;for(;c>1;)c--,r[c]^=r[c-1];for(let D=0;D<343;D++)r[D]=t[r[D]];return r};/*!
...
*/const serialise_track=(e,t,r)=>{let n=0;const c=new Uint8Array(6646).fill(0);for(let D=0;D<16;D++)n=write_sync(c,n);for(let D=0;D<16;D++){n=write_byte(c,n,213),n=write_byte(c,n,170),n=write_byte(c,n,150),n=write_4_and_4(c,n,254),n=write_4_and_4(c,n,t),n=write_4_and_4(c,n,D),n=write_4_and_4(c,n,254^t^D),n=write_byte(c,n,222),n=write_byte(c,n,170),n=write_byte(c,n,235);for(let h=0;h<7;h++)n=write_sync(c,n);n=write_byte(c,n,213),n=write_byte(c,n,170),n=write_byte(c,n,173);const C=D===15?15:D*(r?8:7)%15,u=encode_6_and_2(e.slice(C*256,C*256+256));for(let h=0;h<u.length;h++)n=write_byte(c,n,u[h]);n=write_byte(c,n,222),n=write_byte(c,n,170),n=write_byte(c,n,235);for(let h=0;h<16;h++)n=write_sync(c,n)}return c},convertdsk2woz=(e,t)=>{if(e.length!==35*16*256)return new Uint8Array;const r=new Uint8Array(512*3+512*35*13).fill(0);r.set(toASCII(`WOZ2ÿ
\r
`),0),r.set(toASCII("INFO"),12),r[16]=60,r[20]=2,r[21]=1,r[22]=0,r[23]=0,r[24]=1,r.fill(32,25,57),r.set(toASCII("Apple2TS (CT6502)"),25),r[57]=1,r[58]=0,r[59]=32,r[60]=0,r[62]=0,r[64]=13,r.set(toASCII("TMAP"),80),r[84]=160,r.fill(255,88,88+160);let n=0;for(let c=0;c<35;c++)n=88+(c<<2),c>0&&(r[n-1]=c),r[n]=r[n+1]=c;r.set(toASCII("TRKS"),248),r.set(uint32toBytes(1280+35*13*512),252);for(let c=0;c<35;c++){n=256+(c<<3),r.set(uint16toBytes(3+c*13),n),r[n+2]=13,r.set(uint32toBytes(50304),n+4);const D=e.slice(c*16*256,(c+1)*16*256),C=serialise_track(D,c,t);n=512*(3+13*c),r.set(C,n)}return r},decodeWoz2=(e,t)=>{if(!([87,79,90,50,255,10,13,10].find((u,h)=>u!==t[h])===void 0))return!1;e.isWriteProtected=t[22]===1;const c=t.slice(8,12),D=c[0]+(c[1]<<8)+(c[2]<<16)+c[3]*2**24,C=crc32(t,12);if(D!==0&&D!==C)return alert("CRC checksum error: "+e.filename),!1;for(let u=0;u<80;u++){const h=t[88+u*2];if(h<255){const R=256+8*h,g=t.slice(R,R+8);e.trackStart[u]=512*(g[0]+(g[1]<<8)),e.trackNbits[u]=g[4]+(g[5]<<8)+(g[6]<<16)+g[7]*2**24}else e.trackStart[u]=0,e.trackNbits[u]=51200}return!0},decodeWoz1=(e,t)=>{if(!([87,79,90,49,255,10,13,10].find((c,D)=>c!==t[D])===void 0))return!1;e.isWriteProtected=t[22]===1;for(let c=0;c<80;c++){const D=t[88+c*2];if(D<255){e.trackStart[c]=256+D*6656;const C=t.slice(e.trackStart[c]+6646,e.trackStart[c]+6656);e.trackNbits[c]=C[2]+(C[3]<<8)}else e.trackStart[c]=0,e.trackNbits[c]=51200}return!0},isDSK=e=>{const t=e.toLowerCase(),r=t.endsWith(".dsk")||t.endsWith(".do"),n=t.endsWith(".po");return r||n},decodeDSK=(e,t)=>{const n=e.filename.toLowerCase().endsWith(".po"),c=convertdsk2woz(t,n);return c.length===0?new Uint8Array:(e.filename=replaceSuffix(e.filename,"woz"),e.diskHasChanges=!0,c)},int32=e=>e[0]+256*(e[1]+256*(e[2]+256*e[3])),decode2MG=(e,t)=>{const r=int32(t.slice(24,28)),n=int32(t.slice(28,32));let c="";for(let D=0;D<4;D++)c+=String.fromCharCode(t[D]);return c!=="2IMG"?(console.error("Corrupt 2MG file."),new Uint8Array):t[12]!==1?(console.error("Only ProDOS 2MG files are supported."),new Uint8Array):(e.filename=replaceSuffix(e.filename,"hdv"),e.diskHasChanges=!0,t.slice(r,r+n))},isHardDriveImage=e=>{const t=e.toLowerCase();return t.endsWith(".hdv")||t.endsWith(".po")||t.endsWith(".2mg")},decodeDiskData=(e,t)=>{e.diskHasChanges=!1;const r=e.filename.toLowerCase();if(isHardDriveImage(r)){if(e.hardDrive=!0,e.status="",r.endsWith(".hdv")||r.endsWith(".po"))return t;if(r.endsWith(".2mg"))return decode2MG(e,t)}return isDSK(e.filename)&&(t=decodeDSK(e,t)),decodeWoz2(e,t)||decodeWoz1(e,t)?t:(r!==""&&console.error("Unknown disk format."),new Uint8Array)},disk2driver=[162,32,160,0,162,3,134,60,138,10,36,60,240,16,5,60,73,255,41,126,176,8,74,208,251,152,157,86,3,200,232,16,229,32,88,255,186,189,0,1,10,10,10,10,133,43,170,189,142,192,189,140,192,189,138,192,189,137,192,160,80,189,128,192,152,41,3,10,5,43,170,189,129,192,169,86,32,168,252,136,16,235,133,38,133,61,133,65,169,8,133,39,24,8,189,140,192,16,251,73,213,208,247,189,140,192,16,251,201,170,208,243,234,189,140,192,16,251,201,150,240,9,40,144,223,73,173,240,37,208,217,160,3,133,64,189,140,192,16,251,42,133,60,189,140,192,16,251,37,60,136,208,236,40,197,61,208,190,165,64,197,65,208,184,176,183,160,86,132,60,188,140,192,16,251,89,214,2,164,60,136,153,0,3,208,238,132,60,188,140,192,16,251,89,214,2,164,60,145,38,200,208,239,188,140,192,16,251,89,214,2,208,135,160,0,162,86,202,48,251,177,38,94,0,3,42,94,0,3,42,145,38,200,208,238,230,39,230,61,165,61,205,0,8,166,43,144,219,76,1,8,0,0,0,0,0];let motorOffTimeout=0;const SWITCH={MOTOR_OFF:8,MOTOR_ON:9,DRIVE1:10,DRIVE2:11,DATA_LATCH_OFF:12,DATA_LATCH_ON:13,WRITE_OFF:14,WRITE_ON:15,MOTOR_RUNNING:!1,DATA_LATCH:!1},doResetDiskDrive=e=>{SWITCH.MOTOR_RUNNING=!1,doMotorTimeout(e),e.halftrack=68,e.prevHalfTrack=68},doPauseDiskDrive=(e=!1)=>{if(e){const t=getCurrentDriveState();t.motorRunning&&startMotor(t)}else passDriveSound(DRIVE.MOTOR_OFF)},moveHead=(e,t)=>{e.trackStart[e.halftrack]>0&&(e.prevHalfTrack=e.halftrack),e.halftrack+=t,e.halftrack<0||e.halftrack>68?(passDriveSound(DRIVE.TRACK_END),e.halftrack=e.halftrack<0?0:e.halftrack>68?68:e.halftrack):passDriveSound(DRIVE.TRACK_SEEK),e.status=` Track ${e.halftrack/2}`,passData(),e.trackStart[e.halftrack]>0&&e.prevHalfTrack!==e.halftrack&&(e.trackLocation=Math.floor(e.trackLocation*(e.trackNbits[e.halftrack]/e.trackNbits[e.prevHalfTrack])),e.trackLocation>3&&(e.trackLocation-=4))},pickbit=[128,64,32,16,8,4,2,1],clearbit=[127,191,223,239,247,251,253,254],getNextBit=(e,t)=>{e.trackLocation=e.trackLocation%e.trackNbits[e.halftrack];let r;if(e.trackStart[e.halftrack]>0){const n=e.trackStart[e.halftrack]+(e.trackLocation>>3),c=t[n],D=e.trackLocation&7;r=(c&pickbit[D])>>7-D}else r=1;return e.trackLocation++,r};let dataRegister=0;const getNextByte=(e,t)=>{if(t.length===0)return 0;let r=0;if(dataRegister===0){for(;getNextBit(e,t)===0;);dataRegister=64;for(let n=5;n>=0;n--)dataRegister|=getNextBit(e,t)<<n}else{const n=getNextBit(e,t);dataRegister=dataRegister<<1|n}return r=dataRegister,dataRegister>127&&(dataRegister=0),r};let prevCycleCount$2=0;const doWriteBit=(e,t,r)=>{if(e.trackLocation=e.trackLocation%e.trackNbits[e.halftrack],e.trackStart[e.halftrack]>0){const n=e.trackStart[e.halftrack]+(e.trackLocation>>3);let c=t[n];const D=e.trackLocation&7;r?c|=pickbit[D]:c&=clearbit[D],t[n]=c}e.trackLocation++},doWriteByte=(e,t,r)=>{if(!(t.length===0||e.trackStart[e.halftrack]===0)&&dataRegister>0){if(r>=16)for(let n=7;n>=0;n--)doWriteBit(e,t,dataRegister&2**n?1:0);r>=36&&doWriteBit(e,t,0),r>=40&&doWriteBit(e,t,0),debugCache.push(r>=40?2:r>=36?1:dataRegister),e.diskHasChanges=!0,dataRegister=0}},doMotorTimeout=e=>{motorOffTimeout=0,SWITCH.MOTOR_RUNNING||(e.motorRunning=!1),passData(),passDriveSound(DRIVE.MOTOR_OFF)},startMotor=e=>{motorOffTimeout&&(clearTimeout(motorOffTimeout),motorOffTimeout=0),e.motorRunning=!0,passData(),passDriveSound(DRIVE.MOTOR_ON)},stopMotor=e=>{motorOffTimeout===0&&(motorOffTimeout=setTimeout(()=>doMotorTimeout(e),1e3))};let debugCache=[];const dumpData=e=>{debugCache.length>0&&e.halftrack===2*0&&(debugCache=[])},STEPPER_MOTORS=[0,0,0,0],handleDriveSoftSwitches=(e,t)=>{if(e>=49408)return-1;let r=getCurrentDriveState();const n=getCurrentDriveData();if(r.hardDrive)return 0;let c=0;const D=s6502.cycleCount-prevCycleCount$2;switch(e=e&15,e){case SWITCH.DATA_LATCH_OFF:SWITCH.DATA_LATCH=!1,r.motorRunning&&!r.writeMode&&(c=getNextByte(r,n));break;case SWITCH.MOTOR_ON:SWITCH.MOTOR_RUNNING=!0,startMotor(r),dumpData(r);break;case SWITCH.MOTOR_OFF:SWITCH.MOTOR_RUNNING=!1,stopMotor(r),dumpData(r);break;case SWITCH.DRIVE1:case SWITCH.DRIVE2:{const C=e===SWITCH.DRIVE1?1:2,u=getCurrentDriveState();setCurrentDrive(C),r=getCurrentDriveState(),r!==u&&u.motorRunning&&(u.motorRunning=!1,r.motorRunning=!0,passData());break}case SWITCH.WRITE_OFF:r.motorRunning&&r.writeMode&&(doWriteByte(r,n,D),prevCycleCount$2=s6502.cycleCount),r.writeMode=!1,SWITCH.DATA_LATCH&&(c=r.isWriteProtected?255:0),dumpData(r);break;case SWITCH.WRITE_ON:r.writeMode=!0,prevCycleCount$2=s6502.cycleCount,t>=0&&(dataRegister=t);break;case SWITCH.DATA_LATCH_ON:SWITCH.DATA_LATCH=!0,r.motorRunning&&(r.writeMode&&(doWriteByte(r,n,D),prevCycleCount$2=s6502.cycleCount),t>=0&&(dataRegister=t));break;default:{if(e<0||e>7)break;STEPPER_MOTORS[Math.floor(e/2)]=e%2;const C=STEPPER_MOTORS[(r.currentPhase+1)%4],u=STEPPER_MOTORS[(r.currentPhase+3)%4];STEPPER_MOTORS[r.currentPhase]||(r.motorRunning&&C?(moveHead(r,1),r.currentPhase=(r.currentPhase+1)%4):r.motorRunning&&u&&(moveHead(r,-1),r.currentPhase=(r.currentPhase+3)%4)),dumpData(r);break}}return c},enableDiskDrive=()=>{setSlotDriver(6,Uint8Array.from(disk2driver)),setSlotIOCallback(6,handleDriveSoftSwitches)};let doOutput=!1;const splitOperand=e=>{const t=e.split(","),r=t[0].split(/([+-])/);return{label:r[0]?r[0]:"",operation:r[1]?r[1]:"",value:r[2]?parseInt(r[2].replace("#","").replace("$","0x")):0,idx:t[1]?t[1]:""}},parseNumberOptionalAddressMode=e=>{let t=ADDR_MODE.IMPLIED,r=-1;if(e.length>0){e.startsWith("#")?(t=ADDR_MODE.IMM,e=e.substring(1)):e.startsWith("(")?(e.endsWith(",Y")?t=ADDR_MODE.IND_Y:e.endsWith(",X)")?t=ADDR_MODE.IND_X:t=ADDR_MODE.IND,e=e.substring(1)):e.endsWith(",X")?t=e.length>5?ADDR_MODE.ABS_X:ADDR_MODE.ZP_X:e.endsWith(",Y")?t=e.length>5?ADDR_MODE.ABS_Y:ADDR_MODE.ZP_Y:t=e.length>3?ADDR_MODE.ABS:ADDR_MODE.ZP_REL,e.startsWith("$")&&(e="0x"+e.substring(1)),r=parseInt(e);const n=splitOperand(e);if(n.operation&&n.value){switch(n.operation){case"+":r+=n.value;break;case"-":r-=n.value;break;default:throw new Error("Unknown operation in operand: "+e)}r=(r%65536+65536)%65536}}return[t,r]};let labels={};const getOperandModeValue=(e,t,r,n)=>{let c=ADDR_MODE.IMPLIED,D=-1;if(r.match(/^[#]?[$0-9()]+/))return parseNumberOptionalAddressMode(r);const C=splitOperand(r);if(C.label){const u=C.label.startsWith("<"),h=C.label.startsWith(">"),R=C.label.startsWith("#")||h||u;if(R&&(C.label=C.label.substring(1)),C.label in labels)D=labels[C.label],h?D=D>>8&255:u&&(D=D&255);else if(n===2)throw new Error("Missing label: "+C.label);if(C.operation&&C.value){switch(C.operation){case"+":D+=C.value;break;case"-":D-=C.value;break;default:throw new Error("Unknown operation in operand: "+r)}D=(D%65536+65536)%65536}isBranchInstruction(t)?(c=ADDR_MODE.ZP_REL,D=D-e+254,D>255&&(D-=256)):R?c=ADDR_MODE.IMM:(c=D>=0&&D<=255?ADDR_MODE.ZP_REL:ADDR_MODE.ABS,c=C.idx==="X"?c===ADDR_MODE.ABS?ADDR_MODE.ABS_X:ADDR_MODE.ZP_X:c,c=C.idx==="Y"?c===ADDR_MODE.ABS?ADDR_MODE.ABS_Y:ADDR_MODE.ZP_Y:c)}return[c,D]},splitLine=(e,t)=>{e=e.replace(/\s+/g," ");const r=e.split(" ");return{label:r[0]?r[0]:t,instr:r[1]?r[1]:"",operand:r[2]?r[2]:""}},handleLabel=(e,t)=>{if(e.label in labels)throw new Error("Redefined label: "+e.label);if(e.instr==="EQU"){const[r,n]=getOperandModeValue(t,e.instr,e.operand,2);if(r!==ADDR_MODE.ABS&&r!==ADDR_MODE.ZP_REL)throw new Error("Illegal EQU value: "+e.operand);labels[e.label]=n}else labels[e.label]=t},getHexCodesForInstruction=(e,t)=>{const r=[],n=pcodes[e];return r.push(e),t>=0&&(r.push(t%256),n.bytes===3&&r.push(Math.trunc(t/256))),r};let orgStart=0;const parseOnce=(e,t)=>{let r=orgStart;const n=[];let c="";if(e.forEach(D=>{if(D=D.split(";")[0].trimEnd().toUpperCase(),!D)return;let C=(D+"                   ").slice(0,30)+toHex(r,4)+"- ";const u=splitLine(D,c);if(c="",!u.instr){c=u.label;return}if(u.instr==="ORG"){if(t===1){const[p,M]=parseNumberOptionalAddressMode(u.operand);p===ADDR_MODE.ABS&&(orgStart=M,r=M)}doOutput&&t===2&&console.log(C);return}if(t===1&&u.label&&handleLabel(u,r),u.instr==="EQU")return;let h=[],R,g;if(u.instr==="ASC"||u.instr==="DA"){let p=u.operand,M=0;if(p.startsWith('"')&&p.endsWith('"'))M=128;else if(p.startsWith("'")&&p.endsWith("'"))M=0;else throw new Error("Invalid string: "+p);p=p.substring(1,p.length-1);for(let k=0;k<p.length;k++)h.push(p.charCodeAt(k)|M);h.push(0),r+=p.length+1}else if([R,g]=getOperandModeValue(r,u.instr,u.operand,t),u.instr==="DB")h.push(g&255),r++;else if(u.instr==="DW")h.push(g&255),h.push(g>>8&255),r+=2;else if(u.instr==="DS")for(let p=0;p<g;p++)h.push(0),r++;else{if(t===2&&isBranchInstruction(u.instr)&&(g<0||g>255))throw new Error(`Branch instruction out of range: ${D} value: ${g} pass: ${t}`);const p=pcodes.findIndex(M=>M&&M.name===u.instr&&M.mode===R);if(p<0)throw new Error(`Unknown instruction: "${D}" mode=${R} pass=${t}`);h=getHexCodesForInstruction(p,g),r+=pcodes[p].bytes}doOutput&&t===2&&(h.forEach(p=>{C+=` ${toHex(p)}`}),console.log(C)),n.push(...h)}),doOutput&&t===2){let D="";n.forEach(C=>{D+=` ${toHex(C)}`}),console.log(D)}return n},parseAssembly=(e,t,r=!1)=>{labels={},doOutput=r;try{return orgStart=e,parseOnce(t,1),parseOnce(t,2)}catch(n){return console.error(n),[]}};let timerID=0;const driverAddr=192,code1=`
