var ye=Object.defineProperty;var Te=(e,t,r)=>t in e?ye(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var L=(e,t,r)=>(Te(e,typeof t!="symbol"?t+"":t,r),r);(function(){"use strict";var buffer={},base64Js={};base64Js.byteLength=byteLength,base64Js.toByteArray=toByteArray,base64Js.fromByteArray=fromByteArray;for(var lookup=[],revLookup=[],Arr=typeof Uint8Array<"u"?Uint8Array:Array,code$2="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=0,len=code$2.length;i<len;++i)lookup[i]=code$2[i],revLookup[code$2.charCodeAt(i)]=i;revLookup["-".charCodeAt(0)]=62,revLookup["_".charCodeAt(0)]=63;function getLens(e){var t=e.length;if(t%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var r=e.indexOf("=");r===-1&&(r=t);var a=r===t?0:4-r%4;return[r,a]}function byteLength(e){var t=getLens(e),r=t[0],a=t[1];return(r+a)*3/4-a}function _byteLength(e,t,r){return(t+r)*3/4-r}function toByteArray(e){var t,r=getLens(e),a=r[0],c=r[1],m=new Arr(_byteLength(e,a,c)),d=0,u=c>0?a-4:a,p;for(p=0;p<u;p+=4)t=revLookup[e.charCodeAt(p)]<<18|revLookup[e.charCodeAt(p+1)]<<12|revLookup[e.charCodeAt(p+2)]<<6|revLookup[e.charCodeAt(p+3)],m[d++]=t>>16&255,m[d++]=t>>8&255,m[d++]=t&255;return c===2&&(t=revLookup[e.charCodeAt(p)]<<2|revLookup[e.charCodeAt(p+1)]>>4,m[d++]=t&255),c===1&&(t=revLookup[e.charCodeAt(p)]<<10|revLookup[e.charCodeAt(p+1)]<<4|revLookup[e.charCodeAt(p+2)]>>2,m[d++]=t>>8&255,m[d++]=t&255),m}function tripletToBase64(e){return lookup[e>>18&63]+lookup[e>>12&63]+lookup[e>>6&63]+lookup[e&63]}function encodeChunk(e,t,r){for(var a,c=[],m=t;m<r;m+=3)a=(e[m]<<16&16711680)+(e[m+1]<<8&65280)+(e[m+2]&255),c.push(tripletToBase64(a));return c.join("")}function fromByteArray(e){for(var t,r=e.length,a=r%3,c=[],m=16383,d=0,u=r-a;d<u;d+=m)c.push(encodeChunk(e,d,d+m>u?u:d+m));return a===1?(t=e[r-1],c.push(lookup[t>>2]+lookup[t<<4&63]+"==")):a===2&&(t=(e[r-2]<<8)+e[r-1],c.push(lookup[t>>10]+lookup[t>>4&63]+lookup[t<<2&63]+"=")),c.join("")}var ieee754={};/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ieee754.read=function(e,t,r,a,c){var m,d,u=c*8-a-1,p=(1<<u)-1,B=p>>1,h=-7,E=r?c-1:0,w=r?-1:1,y=e[t+E];for(E+=w,m=y&(1<<-h)-1,y>>=-h,h+=u;h>0;m=m*256+e[t+E],E+=w,h-=8);for(d=m&(1<<-h)-1,m>>=-h,h+=a;h>0;d=d*256+e[t+E],E+=w,h-=8);if(m===0)m=1-B;else{if(m===p)return d?NaN:(y?-1:1)*(1/0);d=d+Math.pow(2,a),m=m-B}return(y?-1:1)*d*Math.pow(2,m-a)},ieee754.write=function(e,t,r,a,c,m){var d,u,p,B=m*8-c-1,h=(1<<B)-1,E=h>>1,w=c===23?Math.pow(2,-24)-Math.pow(2,-77):0,y=a?0:m-1,Q=a?1:-1,b=t<0||t===0&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(u=isNaN(t)?1:0,d=h):(d=Math.floor(Math.log(t)/Math.LN2),t*(p=Math.pow(2,-d))<1&&(d--,p*=2),d+E>=1?t+=w/p:t+=w*Math.pow(2,1-E),t*p>=2&&(d++,p/=2),d+E>=h?(u=0,d=h):d+E>=1?(u=(t*p-1)*Math.pow(2,c),d=d+E):(u=t*Math.pow(2,E-1)*Math.pow(2,c),d=0));c>=8;e[r+y]=u&255,y+=Q,u/=256,c-=8);for(d=d<<c|u,B+=c;B>0;e[r+y]=d&255,y+=Q,d/=256,B-=8);e[r+y-Q]|=b*128};/*!
 * The buffer module from node.js, for the browser.
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */(function(e){const t=base64Js,r=ieee754,a=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=u,e.SlowBuffer=x,e.INSPECT_MAX_BYTES=50;const c=2147483647;e.kMaxLength=c,u.TYPED_ARRAY_SUPPORT=m(),!u.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function m(){try{const n=new Uint8Array(1),o={foo:function(){return 42}};return Object.setPrototypeOf(o,Uint8Array.prototype),Object.setPrototypeOf(n,o),n.foo()===42}catch{return!1}}Object.defineProperty(u.prototype,"parent",{enumerable:!0,get:function(){if(u.isBuffer(this))return this.buffer}}),Object.defineProperty(u.prototype,"offset",{enumerable:!0,get:function(){if(u.isBuffer(this))return this.byteOffset}});function d(n){if(n>c)throw new RangeError('The value "'+n+'" is invalid for option "size"');const o=new Uint8Array(n);return Object.setPrototypeOf(o,u.prototype),o}function u(n,o,s){if(typeof n=="number"){if(typeof o=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return E(n)}return p(n,o,s)}u.poolSize=8192;function p(n,o,s){if(typeof n=="string")return w(n,o);if(ArrayBuffer.isView(n))return Q(n);if(n==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof n);if(U(n,ArrayBuffer)||n&&U(n.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(U(n,SharedArrayBuffer)||n&&U(n.buffer,SharedArrayBuffer)))return b(n,o,s);if(typeof n=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const l=n.valueOf&&n.valueOf();if(l!=null&&l!==n)return u.from(l,o,s);const D=H(n);if(D)return D;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof n[Symbol.toPrimitive]=="function")return u.from(n[Symbol.toPrimitive]("string"),o,s);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof n)}u.from=function(n,o,s){return p(n,o,s)},Object.setPrototypeOf(u.prototype,Uint8Array.prototype),Object.setPrototypeOf(u,Uint8Array);function B(n){if(typeof n!="number")throw new TypeError('"size" argument must be of type number');if(n<0)throw new RangeError('The value "'+n+'" is invalid for option "size"')}function h(n,o,s){return B(n),n<=0?d(n):o!==void 0?typeof s=="string"?d(n).fill(o,s):d(n).fill(o):d(n)}u.alloc=function(n,o,s){return h(n,o,s)};function E(n){return B(n),d(n<0?0:W(n)|0)}u.allocUnsafe=function(n){return E(n)},u.allocUnsafeSlow=function(n){return E(n)};function w(n,o){if((typeof o!="string"||o==="")&&(o="utf8"),!u.isEncoding(o))throw new TypeError("Unknown encoding: "+o);const s=v(n,o)|0;let l=d(s);const D=l.write(n,o);return D!==s&&(l=l.slice(0,D)),l}function y(n){const o=n.length<0?0:W(n.length)|0,s=d(o);for(let l=0;l<o;l+=1)s[l]=n[l]&255;return s}function Q(n){if(U(n,Uint8Array)){const o=new Uint8Array(n);return b(o.buffer,o.byteOffset,o.byteLength)}return y(n)}function b(n,o,s){if(o<0||n.byteLength<o)throw new RangeError('"offset" is outside of buffer bounds');if(n.byteLength<o+(s||0))throw new RangeError('"length" is outside of buffer bounds');let l;return o===void 0&&s===void 0?l=new Uint8Array(n):s===void 0?l=new Uint8Array(n,o):l=new Uint8Array(n,o,s),Object.setPrototypeOf(l,u.prototype),l}function H(n){if(u.isBuffer(n)){const o=W(n.length)|0,s=d(o);return s.length===0||n.copy(s,0,0,o),s}if(n.length!==void 0)return typeof n.length!="number"||V(n.length)?d(0):y(n);if(n.type==="Buffer"&&Array.isArray(n.data))return y(n.data)}function W(n){if(n>=c)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+c.toString(16)+" bytes");return n|0}function x(n){return+n!=n&&(n=0),u.alloc(+n)}u.isBuffer=function(o){return o!=null&&o._isBuffer===!0&&o!==u.prototype},u.compare=function(o,s){if(U(o,Uint8Array)&&(o=u.from(o,o.offset,o.byteLength)),U(s,Uint8Array)&&(s=u.from(s,s.offset,s.byteLength)),!u.isBuffer(o)||!u.isBuffer(s))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(o===s)return 0;let l=o.length,D=s.length;for(let I=0,C=Math.min(l,D);I<C;++I)if(o[I]!==s[I]){l=o[I],D=s[I];break}return l<D?-1:D<l?1:0},u.isEncoding=function(o){switch(String(o).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},u.concat=function(o,s){if(!Array.isArray(o))throw new TypeError('"list" argument must be an Array of Buffers');if(o.length===0)return u.alloc(0);let l;if(s===void 0)for(s=0,l=0;l<o.length;++l)s+=o[l].length;const D=u.allocUnsafe(s);let I=0;for(l=0;l<o.length;++l){let C=o[l];if(U(C,Uint8Array))I+C.length>D.length?(u.isBuffer(C)||(C=u.from(C)),C.copy(D,I)):Uint8Array.prototype.set.call(D,C,I);else if(u.isBuffer(C))C.copy(D,I);else throw new TypeError('"list" argument must be an Array of Buffers');I+=C.length}return D};function v(n,o){if(u.isBuffer(n))return n.length;if(ArrayBuffer.isView(n)||U(n,ArrayBuffer))return n.byteLength;if(typeof n!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof n);const s=n.length,l=arguments.length>2&&arguments[2]===!0;if(!l&&s===0)return 0;let D=!1;for(;;)switch(o){case"ascii":case"latin1":case"binary":return s;case"utf8":case"utf-8":return _(n).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return s*2;case"hex":return s>>>1;case"base64":return ie(n).length;default:if(D)return l?-1:_(n).length;o=(""+o).toLowerCase(),D=!0}}u.byteLength=v;function ce(n,o,s){let l=!1;if((o===void 0||o<0)&&(o=0),o>this.length||((s===void 0||s>this.length)&&(s=this.length),s<=0)||(s>>>=0,o>>>=0,s<=o))return"";for(n||(n="utf8");;)switch(n){case"hex":return Ee(this,o,s);case"utf8":case"utf-8":return $(this,o,s);case"ascii":return Ce(this,o,s);case"latin1":case"binary":return pe(this,o,s);case"base64":return de(this,o,s);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return ge(this,o,s);default:if(l)throw new TypeError("Unknown encoding: "+n);n=(n+"").toLowerCase(),l=!0}}u.prototype._isBuffer=!0;function K(n,o,s){const l=n[o];n[o]=n[s],n[s]=l}u.prototype.swap16=function(){const o=this.length;if(o%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let s=0;s<o;s+=2)K(this,s,s+1);return this},u.prototype.swap32=function(){const o=this.length;if(o%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let s=0;s<o;s+=4)K(this,s,s+3),K(this,s+1,s+2);return this},u.prototype.swap64=function(){const o=this.length;if(o%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let s=0;s<o;s+=8)K(this,s,s+7),K(this,s+1,s+6),K(this,s+2,s+5),K(this,s+3,s+4);return this},u.prototype.toString=function(){const o=this.length;return o===0?"":arguments.length===0?$(this,0,o):ce.apply(this,arguments)},u.prototype.toLocaleString=u.prototype.toString,u.prototype.equals=function(o){if(!u.isBuffer(o))throw new TypeError("Argument must be a Buffer");return this===o?!0:u.compare(this,o)===0},u.prototype.inspect=function(){let o="";const s=e.INSPECT_MAX_BYTES;return o=this.toString("hex",0,s).replace(/(.{2})/g,"$1 ").trim(),this.length>s&&(o+=" ... "),"<Buffer "+o+">"},a&&(u.prototype[a]=u.prototype.inspect),u.prototype.compare=function(o,s,l,D,I){if(U(o,Uint8Array)&&(o=u.from(o,o.offset,o.byteLength)),!u.isBuffer(o))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof o);if(s===void 0&&(s=0),l===void 0&&(l=o?o.length:0),D===void 0&&(D=0),I===void 0&&(I=this.length),s<0||l>o.length||D<0||I>this.length)throw new RangeError("out of range index");if(D>=I&&s>=l)return 0;if(D>=I)return-1;if(s>=l)return 1;if(s>>>=0,l>>>=0,D>>>=0,I>>>=0,this===o)return 0;let C=I-D,g=l-s;const M=Math.min(C,g),R=this.slice(D,I),k=o.slice(s,l);for(let f=0;f<M;++f)if(R[f]!==k[f]){C=R[f],g=k[f];break}return C<g?-1:g<C?1:0};function j(n,o,s,l,D){if(n.length===0)return-1;if(typeof s=="string"?(l=s,s=0):s>2147483647?s=2147483647:s<-2147483648&&(s=-2147483648),s=+s,V(s)&&(s=D?0:n.length-1),s<0&&(s=n.length+s),s>=n.length){if(D)return-1;s=n.length-1}else if(s<0)if(D)s=0;else return-1;if(typeof o=="string"&&(o=u.from(o,l)),u.isBuffer(o))return o.length===0?-1:z(n,o,s,l,D);if(typeof o=="number")return o=o&255,typeof Uint8Array.prototype.indexOf=="function"?D?Uint8Array.prototype.indexOf.call(n,o,s):Uint8Array.prototype.lastIndexOf.call(n,o,s):z(n,[o],s,l,D);throw new TypeError("val must be string, number or Buffer")}function z(n,o,s,l,D){let I=1,C=n.length,g=o.length;if(l!==void 0&&(l=String(l).toLowerCase(),l==="ucs2"||l==="ucs-2"||l==="utf16le"||l==="utf-16le")){if(n.length<2||o.length<2)return-1;I=2,C/=2,g/=2,s/=2}function M(k,f){return I===1?k[f]:k.readUInt16BE(f*I)}let R;if(D){let k=-1;for(R=s;R<C;R++)if(M(n,R)===M(o,k===-1?0:R-k)){if(k===-1&&(k=R),R-k+1===g)return k*I}else k!==-1&&(R-=R-k),k=-1}else for(s+g>C&&(s=C-g),R=s;R>=0;R--){let k=!0;for(let f=0;f<g;f++)if(M(n,R+f)!==M(o,f)){k=!1;break}if(k)return R}return-1}u.prototype.includes=function(o,s,l){return this.indexOf(o,s,l)!==-1},u.prototype.indexOf=function(o,s,l){return j(this,o,s,l,!0)},u.prototype.lastIndexOf=function(o,s,l){return j(this,o,s,l,!1)};function le(n,o,s,l){s=Number(s)||0;const D=n.length-s;l?(l=Number(l),l>D&&(l=D)):l=D;const I=o.length;l>I/2&&(l=I/2);let C;for(C=0;C<l;++C){const g=parseInt(o.substr(C*2,2),16);if(V(g))return C;n[s+C]=g}return C}function ue(n,o,s,l){return Z(_(o,n.length-s),n,s,l)}function De(n,o,s,l){return Z(Re(o),n,s,l)}function Se(n,o,s,l){return Z(ie(o),n,s,l)}function me(n,o,s,l){return Z(we(o,n.length-s),n,s,l)}u.prototype.write=function(o,s,l,D){if(s===void 0)D="utf8",l=this.length,s=0;else if(l===void 0&&typeof s=="string")D=s,l=this.length,s=0;else if(isFinite(s))s=s>>>0,isFinite(l)?(l=l>>>0,D===void 0&&(D="utf8")):(D=l,l=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const I=this.length-s;if((l===void 0||l>I)&&(l=I),o.length>0&&(l<0||s<0)||s>this.length)throw new RangeError("Attempt to write outside buffer bounds");D||(D="utf8");let C=!1;for(;;)switch(D){case"hex":return le(this,o,s,l);case"utf8":case"utf-8":return ue(this,o,s,l);case"ascii":case"latin1":case"binary":return De(this,o,s,l);case"base64":return Se(this,o,s,l);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return me(this,o,s,l);default:if(C)throw new TypeError("Unknown encoding: "+D);D=(""+D).toLowerCase(),C=!0}},u.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function de(n,o,s){return o===0&&s===n.length?t.fromByteArray(n):t.fromByteArray(n.slice(o,s))}function $(n,o,s){s=Math.min(n.length,s);const l=[];let D=o;for(;D<s;){const I=n[D];let C=null,g=I>239?4:I>223?3:I>191?2:1;if(D+g<=s){let M,R,k,f;switch(g){case 1:I<128&&(C=I);break;case 2:M=n[D+1],(M&192)===128&&(f=(I&31)<<6|M&63,f>127&&(C=f));break;case 3:M=n[D+1],R=n[D+2],(M&192)===128&&(R&192)===128&&(f=(I&15)<<12|(M&63)<<6|R&63,f>2047&&(f<55296||f>57343)&&(C=f));break;case 4:M=n[D+1],R=n[D+2],k=n[D+3],(M&192)===128&&(R&192)===128&&(k&192)===128&&(f=(I&15)<<18|(M&63)<<12|(R&63)<<6|k&63,f>65535&&f<1114112&&(C=f))}}C===null?(C=65533,g=1):C>65535&&(C-=65536,l.push(C>>>10&1023|55296),C=56320|C&1023),l.push(C),D+=g}return Ie(l)}const ee=4096;function Ie(n){const o=n.length;if(o<=ee)return String.fromCharCode.apply(String,n);let s="",l=0;for(;l<o;)s+=String.fromCharCode.apply(String,n.slice(l,l+=ee));return s}function Ce(n,o,s){let l="";s=Math.min(n.length,s);for(let D=o;D<s;++D)l+=String.fromCharCode(n[D]&127);return l}function pe(n,o,s){let l="";s=Math.min(n.length,s);for(let D=o;D<s;++D)l+=String.fromCharCode(n[D]);return l}function Ee(n,o,s){const l=n.length;(!o||o<0)&&(o=0),(!s||s<0||s>l)&&(s=l);let D="";for(let I=o;I<s;++I)D+=Me[n[I]];return D}function ge(n,o,s){const l=n.slice(o,s);let D="";for(let I=0;I<l.length-1;I+=2)D+=String.fromCharCode(l[I]+l[I+1]*256);return D}u.prototype.slice=function(o,s){const l=this.length;o=~~o,s=s===void 0?l:~~s,o<0?(o+=l,o<0&&(o=0)):o>l&&(o=l),s<0?(s+=l,s<0&&(s=0)):s>l&&(s=l),s<o&&(s=o);const D=this.subarray(o,s);return Object.setPrototypeOf(D,u.prototype),D};function T(n,o,s){if(n%1!==0||n<0)throw new RangeError("offset is not uint");if(n+o>s)throw new RangeError("Trying to access beyond buffer length")}u.prototype.readUintLE=u.prototype.readUIntLE=function(o,s,l){o=o>>>0,s=s>>>0,l||T(o,s,this.length);let D=this[o],I=1,C=0;for(;++C<s&&(I*=256);)D+=this[o+C]*I;return D},u.prototype.readUintBE=u.prototype.readUIntBE=function(o,s,l){o=o>>>0,s=s>>>0,l||T(o,s,this.length);let D=this[o+--s],I=1;for(;s>0&&(I*=256);)D+=this[o+--s]*I;return D},u.prototype.readUint8=u.prototype.readUInt8=function(o,s){return o=o>>>0,s||T(o,1,this.length),this[o]},u.prototype.readUint16LE=u.prototype.readUInt16LE=function(o,s){return o=o>>>0,s||T(o,2,this.length),this[o]|this[o+1]<<8},u.prototype.readUint16BE=u.prototype.readUInt16BE=function(o,s){return o=o>>>0,s||T(o,2,this.length),this[o]<<8|this[o+1]},u.prototype.readUint32LE=u.prototype.readUInt32LE=function(o,s){return o=o>>>0,s||T(o,4,this.length),(this[o]|this[o+1]<<8|this[o+2]<<16)+this[o+3]*16777216},u.prototype.readUint32BE=u.prototype.readUInt32BE=function(o,s){return o=o>>>0,s||T(o,4,this.length),this[o]*16777216+(this[o+1]<<16|this[o+2]<<8|this[o+3])},u.prototype.readBigUInt64LE=F(function(o){o=o>>>0,q(o,"offset");const s=this[o],l=this[o+7];(s===void 0||l===void 0)&&N(o,this.length-8);const D=s+this[++o]*2**8+this[++o]*2**16+this[++o]*2**24,I=this[++o]+this[++o]*2**8+this[++o]*2**16+l*2**24;return BigInt(D)+(BigInt(I)<<BigInt(32))}),u.prototype.readBigUInt64BE=F(function(o){o=o>>>0,q(o,"offset");const s=this[o],l=this[o+7];(s===void 0||l===void 0)&&N(o,this.length-8);const D=s*2**24+this[++o]*2**16+this[++o]*2**8+this[++o],I=this[++o]*2**24+this[++o]*2**16+this[++o]*2**8+l;return(BigInt(D)<<BigInt(32))+BigInt(I)}),u.prototype.readIntLE=function(o,s,l){o=o>>>0,s=s>>>0,l||T(o,s,this.length);let D=this[o],I=1,C=0;for(;++C<s&&(I*=256);)D+=this[o+C]*I;return I*=128,D>=I&&(D-=Math.pow(2,8*s)),D},u.prototype.readIntBE=function(o,s,l){o=o>>>0,s=s>>>0,l||T(o,s,this.length);let D=s,I=1,C=this[o+--D];for(;D>0&&(I*=256);)C+=this[o+--D]*I;return I*=128,C>=I&&(C-=Math.pow(2,8*s)),C},u.prototype.readInt8=function(o,s){return o=o>>>0,s||T(o,1,this.length),this[o]&128?(255-this[o]+1)*-1:this[o]},u.prototype.readInt16LE=function(o,s){o=o>>>0,s||T(o,2,this.length);const l=this[o]|this[o+1]<<8;return l&32768?l|4294901760:l},u.prototype.readInt16BE=function(o,s){o=o>>>0,s||T(o,2,this.length);const l=this[o+1]|this[o]<<8;return l&32768?l|4294901760:l},u.prototype.readInt32LE=function(o,s){return o=o>>>0,s||T(o,4,this.length),this[o]|this[o+1]<<8|this[o+2]<<16|this[o+3]<<24},u.prototype.readInt32BE=function(o,s){return o=o>>>0,s||T(o,4,this.length),this[o]<<24|this[o+1]<<16|this[o+2]<<8|this[o+3]},u.prototype.readBigInt64LE=F(function(o){o=o>>>0,q(o,"offset");const s=this[o],l=this[o+7];(s===void 0||l===void 0)&&N(o,this.length-8);const D=this[o+4]+this[o+5]*2**8+this[o+6]*2**16+(l<<24);return(BigInt(D)<<BigInt(32))+BigInt(s+this[++o]*2**8+this[++o]*2**16+this[++o]*2**24)}),u.prototype.readBigInt64BE=F(function(o){o=o>>>0,q(o,"offset");const s=this[o],l=this[o+7];(s===void 0||l===void 0)&&N(o,this.length-8);const D=(s<<24)+this[++o]*2**16+this[++o]*2**8+this[++o];return(BigInt(D)<<BigInt(32))+BigInt(this[++o]*2**24+this[++o]*2**16+this[++o]*2**8+l)}),u.prototype.readFloatLE=function(o,s){return o=o>>>0,s||T(o,4,this.length),r.read(this,o,!0,23,4)},u.prototype.readFloatBE=function(o,s){return o=o>>>0,s||T(o,4,this.length),r.read(this,o,!1,23,4)},u.prototype.readDoubleLE=function(o,s){return o=o>>>0,s||T(o,8,this.length),r.read(this,o,!0,52,8)},u.prototype.readDoubleBE=function(o,s){return o=o>>>0,s||T(o,8,this.length),r.read(this,o,!1,52,8)};function O(n,o,s,l,D,I){if(!u.isBuffer(n))throw new TypeError('"buffer" argument must be a Buffer instance');if(o>D||o<I)throw new RangeError('"value" argument is out of bounds');if(s+l>n.length)throw new RangeError("Index out of range")}u.prototype.writeUintLE=u.prototype.writeUIntLE=function(o,s,l,D){if(o=+o,s=s>>>0,l=l>>>0,!D){const g=Math.pow(2,8*l)-1;O(this,o,s,l,g,0)}let I=1,C=0;for(this[s]=o&255;++C<l&&(I*=256);)this[s+C]=o/I&255;return s+l},u.prototype.writeUintBE=u.prototype.writeUIntBE=function(o,s,l,D){if(o=+o,s=s>>>0,l=l>>>0,!D){const g=Math.pow(2,8*l)-1;O(this,o,s,l,g,0)}let I=l-1,C=1;for(this[s+I]=o&255;--I>=0&&(C*=256);)this[s+I]=o/C&255;return s+l},u.prototype.writeUint8=u.prototype.writeUInt8=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,1,255,0),this[s]=o&255,s+1},u.prototype.writeUint16LE=u.prototype.writeUInt16LE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,2,65535,0),this[s]=o&255,this[s+1]=o>>>8,s+2},u.prototype.writeUint16BE=u.prototype.writeUInt16BE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,2,65535,0),this[s]=o>>>8,this[s+1]=o&255,s+2},u.prototype.writeUint32LE=u.prototype.writeUInt32LE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,4,4294967295,0),this[s+3]=o>>>24,this[s+2]=o>>>16,this[s+1]=o>>>8,this[s]=o&255,s+4},u.prototype.writeUint32BE=u.prototype.writeUInt32BE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,4,4294967295,0),this[s]=o>>>24,this[s+1]=o>>>16,this[s+2]=o>>>8,this[s+3]=o&255,s+4};function te(n,o,s,l,D){ae(o,l,D,n,s,7);let I=Number(o&BigInt(4294967295));n[s++]=I,I=I>>8,n[s++]=I,I=I>>8,n[s++]=I,I=I>>8,n[s++]=I;let C=Number(o>>BigInt(32)&BigInt(4294967295));return n[s++]=C,C=C>>8,n[s++]=C,C=C>>8,n[s++]=C,C=C>>8,n[s++]=C,s}function re(n,o,s,l,D){ae(o,l,D,n,s,7);let I=Number(o&BigInt(4294967295));n[s+7]=I,I=I>>8,n[s+6]=I,I=I>>8,n[s+5]=I,I=I>>8,n[s+4]=I;let C=Number(o>>BigInt(32)&BigInt(4294967295));return n[s+3]=C,C=C>>8,n[s+2]=C,C=C>>8,n[s+1]=C,C=C>>8,n[s]=C,s+8}u.prototype.writeBigUInt64LE=F(function(o,s=0){return te(this,o,s,BigInt(0),BigInt("0xffffffffffffffff"))}),u.prototype.writeBigUInt64BE=F(function(o,s=0){return re(this,o,s,BigInt(0),BigInt("0xffffffffffffffff"))}),u.prototype.writeIntLE=function(o,s,l,D){if(o=+o,s=s>>>0,!D){const M=Math.pow(2,8*l-1);O(this,o,s,l,M-1,-M)}let I=0,C=1,g=0;for(this[s]=o&255;++I<l&&(C*=256);)o<0&&g===0&&this[s+I-1]!==0&&(g=1),this[s+I]=(o/C>>0)-g&255;return s+l},u.prototype.writeIntBE=function(o,s,l,D){if(o=+o,s=s>>>0,!D){const M=Math.pow(2,8*l-1);O(this,o,s,l,M-1,-M)}let I=l-1,C=1,g=0;for(this[s+I]=o&255;--I>=0&&(C*=256);)o<0&&g===0&&this[s+I+1]!==0&&(g=1),this[s+I]=(o/C>>0)-g&255;return s+l},u.prototype.writeInt8=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,1,127,-128),o<0&&(o=255+o+1),this[s]=o&255,s+1},u.prototype.writeInt16LE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,2,32767,-32768),this[s]=o&255,this[s+1]=o>>>8,s+2},u.prototype.writeInt16BE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,2,32767,-32768),this[s]=o>>>8,this[s+1]=o&255,s+2},u.prototype.writeInt32LE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,4,2147483647,-2147483648),this[s]=o&255,this[s+1]=o>>>8,this[s+2]=o>>>16,this[s+3]=o>>>24,s+4},u.prototype.writeInt32BE=function(o,s,l){return o=+o,s=s>>>0,l||O(this,o,s,4,2147483647,-2147483648),o<0&&(o=4294967295+o+1),this[s]=o>>>24,this[s+1]=o>>>16,this[s+2]=o>>>8,this[s+3]=o&255,s+4},u.prototype.writeBigInt64LE=F(function(o,s=0){return te(this,o,s,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),u.prototype.writeBigInt64BE=F(function(o,s=0){return re(this,o,s,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function oe(n,o,s,l,D,I){if(s+l>n.length)throw new RangeError("Index out of range");if(s<0)throw new RangeError("Index out of range")}function se(n,o,s,l,D){return o=+o,s=s>>>0,D||oe(n,o,s,4),r.write(n,o,s,l,23,4),s+4}u.prototype.writeFloatLE=function(o,s,l){return se(this,o,s,!0,l)},u.prototype.writeFloatBE=function(o,s,l){return se(this,o,s,!1,l)};function Ae(n,o,s,l,D){return o=+o,s=s>>>0,D||oe(n,o,s,8),r.write(n,o,s,l,52,8),s+8}u.prototype.writeDoubleLE=function(o,s,l){return Ae(this,o,s,!0,l)},u.prototype.writeDoubleBE=function(o,s,l){return Ae(this,o,s,!1,l)},u.prototype.copy=function(o,s,l,D){if(!u.isBuffer(o))throw new TypeError("argument should be a Buffer");if(l||(l=0),!D&&D!==0&&(D=this.length),s>=o.length&&(s=o.length),s||(s=0),D>0&&D<l&&(D=l),D===l||o.length===0||this.length===0)return 0;if(s<0)throw new RangeError("targetStart out of bounds");if(l<0||l>=this.length)throw new RangeError("Index out of range");if(D<0)throw new RangeError("sourceEnd out of bounds");D>this.length&&(D=this.length),o.length-s<D-l&&(D=o.length-s+l);const I=D-l;return this===o&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(s,l,D):Uint8Array.prototype.set.call(o,this.subarray(l,D),s),I},u.prototype.fill=function(o,s,l,D){if(typeof o=="string"){if(typeof s=="string"?(D=s,s=0,l=this.length):typeof l=="string"&&(D=l,l=this.length),D!==void 0&&typeof D!="string")throw new TypeError("encoding must be a string");if(typeof D=="string"&&!u.isEncoding(D))throw new TypeError("Unknown encoding: "+D);if(o.length===1){const C=o.charCodeAt(0);(D==="utf8"&&C<128||D==="latin1")&&(o=C)}}else typeof o=="number"?o=o&255:typeof o=="boolean"&&(o=Number(o));if(s<0||this.length<s||this.length<l)throw new RangeError("Out of range index");if(l<=s)return this;s=s>>>0,l=l===void 0?this.length:l>>>0,o||(o=0);let I;if(typeof o=="number")for(I=s;I<l;++I)this[I]=o;else{const C=u.isBuffer(o)?o:u.from(o,D),g=C.length;if(g===0)throw new TypeError('The value "'+o+'" is invalid for argument "value"');for(I=0;I<l-s;++I)this[I+s]=C[I%g]}return this};const G={};function J(n,o,s){G[n]=class extends s{constructor(){super(),Object.defineProperty(this,"message",{value:o.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${n}]`,this.stack,delete this.name}get code(){return n}set code(D){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:D,writable:!0})}toString(){return`${this.name} [${n}]: ${this.message}`}}}J("ERR_BUFFER_OUT_OF_BOUNDS",function(n){return n?`${n} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),J("ERR_INVALID_ARG_TYPE",function(n,o){return`The "${n}" argument must be of type number. Received type ${typeof o}`},TypeError),J("ERR_OUT_OF_RANGE",function(n,o,s){let l=`The value of "${n}" is out of range.`,D=s;return Number.isInteger(s)&&Math.abs(s)>2**32?D=ne(String(s)):typeof s=="bigint"&&(D=String(s),(s>BigInt(2)**BigInt(32)||s<-(BigInt(2)**BigInt(32)))&&(D=ne(D)),D+="n"),l+=` It must be ${o}. Received ${D}`,l},RangeError);function ne(n){let o="",s=n.length;const l=n[0]==="-"?1:0;for(;s>=l+4;s-=3)o=`_${n.slice(s-3,s)}${o}`;return`${n.slice(0,s)}${o}`}function he(n,o,s){q(o,"offset"),(n[o]===void 0||n[o+s]===void 0)&&N(o,n.length-(s+1))}function ae(n,o,s,l,D,I){if(n>s||n<o){const C=typeof o=="bigint"?"n":"";let g;throw I>3?o===0||o===BigInt(0)?g=`>= 0${C} and < 2${C} ** ${(I+1)*8}${C}`:g=`>= -(2${C} ** ${(I+1)*8-1}${C}) and < 2 ** ${(I+1)*8-1}${C}`:g=`>= ${o}${C} and <= ${s}${C}`,new G.ERR_OUT_OF_RANGE("value",g,n)}he(l,D,I)}function q(n,o){if(typeof n!="number")throw new G.ERR_INVALID_ARG_TYPE(o,"number",n)}function N(n,o,s){throw Math.floor(n)!==n?(q(n,s),new G.ERR_OUT_OF_RANGE(s||"offset","an integer",n)):o<0?new G.ERR_BUFFER_OUT_OF_BOUNDS:new G.ERR_OUT_OF_RANGE(s||"offset",`>= ${s?1:0} and <= ${o}`,n)}const fe=/[^+/0-9A-Za-z-_]/g;function Be(n){if(n=n.split("=")[0],n=n.trim().replace(fe,""),n.length<2)return"";for(;n.length%4!==0;)n=n+"=";return n}function _(n,o){o=o||1/0;let s;const l=n.length;let D=null;const I=[];for(let C=0;C<l;++C){if(s=n.charCodeAt(C),s>55295&&s<57344){if(!D){if(s>56319){(o-=3)>-1&&I.push(239,191,189);continue}else if(C+1===l){(o-=3)>-1&&I.push(239,191,189);continue}D=s;continue}if(s<56320){(o-=3)>-1&&I.push(239,191,189),D=s;continue}s=(D-55296<<10|s-56320)+65536}else D&&(o-=3)>-1&&I.push(239,191,189);if(D=null,s<128){if((o-=1)<0)break;I.push(s)}else if(s<2048){if((o-=2)<0)break;I.push(s>>6|192,s&63|128)}else if(s<65536){if((o-=3)<0)break;I.push(s>>12|224,s>>6&63|128,s&63|128)}else if(s<1114112){if((o-=4)<0)break;I.push(s>>18|240,s>>12&63|128,s>>6&63|128,s&63|128)}else throw new Error("Invalid code point")}return I}function Re(n){const o=[];for(let s=0;s<n.length;++s)o.push(n.charCodeAt(s)&255);return o}function we(n,o){let s,l,D;const I=[];for(let C=0;C<n.length&&!((o-=2)<0);++C)s=n.charCodeAt(C),l=s>>8,D=s%256,I.push(D),I.push(l);return I}function ie(n){return t.toByteArray(Be(n))}function Z(n,o,s,l){let D;for(D=0;D<l&&!(D+s>=o.length||D>=n.length);++D)o[D+s]=n[D];return D}function U(n,o){return n instanceof o||n!=null&&n.constructor!=null&&n.constructor.name!=null&&n.constructor.name===o.name}function V(n){return n!==n}const Me=function(){const n="0123456789abcdef",o=new Array(256);for(let s=0;s<16;++s){const l=s*16;for(let D=0;D<16;++D)o[l+D]=n[s]+n[D]}return o}();function F(n){return typeof BigInt>"u"?ke:n}function ke(){throw new Error("BigInt not supported")}})(buffer);var RUN_MODE=(e=>(e[e.IDLE=0]="IDLE",e[e.RUNNING=-1]="RUNNING",e[e.PAUSED=-2]="PAUSED",e[e.NEED_BOOT=-3]="NEED_BOOT",e[e.NEED_RESET=-4]="NEED_RESET",e))(RUN_MODE||{}),MSG_WORKER=(e=>(e[e.MACHINE_STATE=0]="MACHINE_STATE",e[e.CLICK=1]="CLICK",e[e.DRIVE_PROPS=2]="DRIVE_PROPS",e[e.DRIVE_SOUND=3]="DRIVE_SOUND",e[e.SAVE_STATE=4]="SAVE_STATE",e[e.RUMBLE=5]="RUMBLE",e[e.HELP_TEXT=6]="HELP_TEXT",e[e.SHOW_MOUSE=7]="SHOW_MOUSE",e[e.MBOARD_SOUND=8]="MBOARD_SOUND",e[e.COMM_DATA=9]="COMM_DATA",e))(MSG_WORKER||{}),MSG_MAIN=(e=>(e[e.RUN_MODE=0]="RUN_MODE",e[e.STATE6502=1]="STATE6502",e[e.DEBUG=2]="DEBUG",e[e.DISASSEMBLE_ADDR=3]="DISASSEMBLE_ADDR",e[e.BREAKPOINTS=4]="BREAKPOINTS",e[e.STEP_INTO=5]="STEP_INTO",e[e.STEP_OVER=6]="STEP_OVER",e[e.STEP_OUT=7]="STEP_OUT",e[e.SPEED=8]="SPEED",e[e.TIME_TRAVEL=9]="TIME_TRAVEL",e[e.TIME_TRAVEL_INDEX=10]="TIME_TRAVEL_INDEX",e[e.RESTORE_STATE=11]="RESTORE_STATE",e[e.KEYPRESS=12]="KEYPRESS",e[e.MOUSEEVENT=13]="MOUSEEVENT",e[e.PASTE_TEXT=14]="PASTE_TEXT",e[e.APPLE_PRESS=15]="APPLE_PRESS",e[e.APPLE_RELEASE=16]="APPLE_RELEASE",e[e.GET_SAVE_STATE=17]="GET_SAVE_STATE",e[e.DRIVE_PROPS=18]="DRIVE_PROPS",e[e.GAMEPAD=19]="GAMEPAD",e[e.SET_BINARY_BLOCK=20]="SET_BINARY_BLOCK",e[e.COMM_DATA=21]="COMM_DATA",e))(MSG_MAIN||{}),DRIVE=(e=>(e[e.MOTOR_OFF=0]="MOTOR_OFF",e[e.MOTOR_ON=1]="MOTOR_ON",e[e.TRACK_END=2]="TRACK_END",e[e.TRACK_SEEK=3]="TRACK_SEEK",e))(DRIVE||{}),ADDR_MODE=(e=>(e[e.IMPLIED=0]="IMPLIED",e[e.IMM=1]="IMM",e[e.ZP_REL=2]="ZP_REL",e[e.ZP_X=3]="ZP_X",e[e.ZP_Y=4]="ZP_Y",e[e.ABS=5]="ABS",e[e.ABS_X=6]="ABS_X",e[e.ABS_Y=7]="ABS_Y",e[e.IND_X=8]="IND_X",e[e.IND_Y=9]="IND_Y",e[e.IND=10]="IND",e))(ADDR_MODE||{});const default6502State=()=>({cycleCount:0,PStatus:0,PC:0,Accum:0,XReg:0,YReg:0,StackPtr:0,flagIRQ:0,flagNMI:!1}),isBranchInstruction=e=>e.startsWith("B")&&e!=="BIT"&&e!=="BRK",toHex=(e,t=2)=>(e>255&&(t=4),("0000"+e.toString(16).toUpperCase()).slice(-t)),toASCII=e=>e.split("").map(t=>t.charCodeAt(0)),uint16toBytes=e=>[e&255,e>>>8&255],uint32toBytes=e=>[e&255,e>>>8&255,e>>>16&255,e>>>24&255],replaceSuffix=(e,t)=>{const r=e.lastIndexOf(".")+1;return e.substring(0,r)+t},crcTable=new Uint32Array(256).fill(0),makeCRCTable=()=>{let e;for(let t=0;t<256;t++){e=t;for(let r=0;r<8;r++)e=e&1?3988292384^e>>>1:e>>>1;crcTable[t]=e}},crc32=(e,t=0)=>{crcTable[255]===0&&makeCRCTable();let r=-1;for(let a=t;a<e.length;a++)r=r>>>8^crcTable[(r^e[a])&255];return(r^-1)>>>0};let gamePads;const maxTimeoutCycles=Math.trunc(.0028*1020484);let paddle0timeout=maxTimeoutCycles/2,paddle1timeout=maxTimeoutCycles/2,paddle2timeout=maxTimeoutCycles/2,paddle3timeout=maxTimeoutCycles/2,countStart=0,leftAppleDown=!1,rightAppleDown=!1,leftButtonDown=!1,rightButtonDown=!1,isPB2down=!1,isLeftDown=!1,isRightDown=!1;const setLeftButtonDown=()=>{leftButtonDown=!0},setRightButtonDown=()=>{rightButtonDown=!0},setPushButton2=()=>{isPB2down=!0},valueToTimeout=e=>(e=Math.min(Math.max(e,-1),1),(e+1)*maxTimeoutCycles/2),setGamepad0=e=>{paddle0timeout=valueToTimeout(e)},setGamepad1=e=>{paddle1timeout=valueToTimeout(e)},setGamepad2=e=>{paddle2timeout=valueToTimeout(e)},setGamepad3=e=>{paddle3timeout=valueToTimeout(e)},setButtonState=()=>{isLeftDown=leftAppleDown||leftButtonDown,isRightDown=rightAppleDown||rightButtonDown,SWITCHES.PB0.isSet=isLeftDown,SWITCHES.PB1.isSet=isRightDown||isPB2down,SWITCHES.PB2.isSet=isPB2down},pressAppleCommandKey=(e,t)=>{t?leftAppleDown=e:rightAppleDown=e,setButtonState()},resetJoystick=e=>{memSetC000(49252,128),memSetC000(49253,128),memSetC000(49254,128),memSetC000(49255,128),countStart=e},checkJoystickValues=e=>{const t=e-countStart;memSetC000(49252,t<paddle0timeout?128:0),memSetC000(49253,t<paddle1timeout?128:0),memSetC000(49254,t<paddle2timeout?128:0),memSetC000(49255,t<paddle3timeout?128:0)};let gameMapping,gamePadMapping,isKeyboardJoystick=!1;const setGamepads=e=>{gamePads=e,isKeyboardJoystick=!gamePads.length||!gamePads[0].buttons.length,gameMapping=getGameMapping(),gamePadMapping=gameMapping.gamepad?gameMapping.gamepad:defaultButtons},nearZero=e=>e>-.01&&e<.01,convertGamepadAxes=e=>{let t=e[0],r=e[1];nearZero(t)&&(t=0),nearZero(r)&&(r=0);const a=Math.sqrt(t*t+r*r),c=.95*(a===0?1:Math.max(Math.abs(t),Math.abs(r))/a);return t=Math.min(Math.max(-c,t),c),r=Math.min(Math.max(-c,r),c),t=Math.trunc(maxTimeoutCycles*(t+c)/(2*c)),r=Math.trunc(maxTimeoutCycles*(r+c)/(2*c)),[t,r]},handleGamepad=e=>{const t=gameMapping.joystick?gameMapping.joystick(gamePads[e].axes,isKeyboardJoystick):gamePads[e].axes,r=convertGamepadAxes(t);e===0?(paddle0timeout=r[0],paddle1timeout=r[1],leftButtonDown=!1,rightButtonDown=!1):(paddle2timeout=r[0],paddle3timeout=r[1],isPB2down=!1);let a=!1;gamePads[e].buttons.forEach((c,m)=>{c&&(gamePadMapping(m,gamePads.length>1,e===1),a=!0)}),a||gamePadMapping(-1,gamePads.length>1,e===1),gameMapping.rumble&&gameMapping.rumble(),setButtonState()},handleGamepads=()=>{gamePads&&gamePads.length>0&&(handleGamepad(0),gamePads.length>1&&handleGamepad(1))},gamepad$3=e=>{switch(e){case 0:addToBufferDebounce("JL");break;case 1:addToBufferDebounce("G",200);break;case 2:addToBuffer("M"),addToBufferDebounce("O");break;case 3:addToBufferDebounce("L");break;case 4:addToBufferDebounce("F");break;case 5:addToBuffer("P"),addToBufferDebounce("T");break;case 6:break;case 7:break;case 8:addToBufferDebounce("Z");break;case 9:{const t=getTextPageAsString();t.includes("'N'")?addToBuffer("N"):t.includes("'S'")?addToBuffer("S"):t.includes("NUMERIC KEY")?addToBuffer("1"):addToBuffer("N");break}case 10:break;case 11:break;case 12:addToBufferDebounce("L");break;case 13:addToBufferDebounce("M");break;case 14:addToBufferDebounce("A");break;case 15:addToBufferDebounce("D");break;case-1:return}};let leftdown=0,rightdown=0,buttonreleased=!1;const threshold$2=.5,joystick$2=e=>e[0]<-threshold$2?(rightdown=0,leftdown===0||leftdown>2?(leftdown=0,addToBuffer("A")):leftdown===1&&buttonreleased?addToBufferDebounce("W"):leftdown===2&&buttonreleased&&addToBufferDebounce("R"),leftdown++,buttonreleased=!1,e):e[0]>threshold$2?(leftdown=0,rightdown===0||rightdown>2?(rightdown=0,addToBuffer("D")):rightdown===1&&buttonreleased?addToBufferDebounce("W"):rightdown===2&&buttonreleased&&addToBufferDebounce("R"),rightdown++,buttonreleased=!1,e):e[1]<-threshold$2?(addToBufferDebounce("C"),e):e[1]>threshold$2?(addToBufferDebounce("S"),e):(buttonreleased=!0,e),helptext$6=`AZTEC
...
*/const encode_6_and_2=e=>{const t=[150,151,154,155,157,158,159,166,167,171,172,173,174,175,178,179,180,181,182,183,185,186,187,188,189,190,191,203,205,206,207,211,214,215,217,218,219,220,221,222,223,229,230,231,233,234,235,236,237,238,239,242,243,244,245,246,247,249,250,251,252,253,254,255],r=new Uint8Array(343),a=[0,2,1,3];for(let m=0;m<84;m++)r[m]=a[e[m]&3]|a[e[m+86]&3]<<2|a[e[m+172]&3]<<4;r[84]=a[e[84]&3]<<0|a[e[170]&3]<<2,r[85]=a[e[85]&3]<<0|a[e[171]&3]<<2;for(let m=0;m<256;m++)r[86+m]=e[m]>>>2;r[342]=r[341];let c=342;for(;c>1;)c--,r[c]^=r[c-1];for(let m=0;m<343;m++)r[m]=t[r[m]];return r};/*!
