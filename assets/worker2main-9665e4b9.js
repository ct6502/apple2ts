var Pe=Object.defineProperty;var ke=(e,t,r)=>t in e?Pe(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var g=(e,t,r)=>(ke(e,typeof t!="symbol"?t+"":t,r),r);(function(){"use strict";var buffer={},base64Js={};base64Js.byteLength=byteLength,base64Js.toByteArray=toByteArray,base64Js.fromByteArray=fromByteArray;for(var lookup=[],revLookup=[],Arr=typeof Uint8Array<"u"?Uint8Array:Array,code$2="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=0,len=code$2.length;i<len;++i)lookup[i]=code$2[i],revLookup[code$2.charCodeAt(i)]=i;revLookup["-".charCodeAt(0)]=62,revLookup["_".charCodeAt(0)]=63;function getLens(e){var t=e.length;if(t%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var r=e.indexOf("=");r===-1&&(r=t);var a=r===t?0:4-r%4;return[r,a]}function byteLength(e){var t=getLens(e),r=t[0],a=t[1];return(r+a)*3/4-a}function _byteLength(e,t,r){return(t+r)*3/4-r}function toByteArray(e){var t,r=getLens(e),a=r[0],D=r[1],u=new Arr(_byteLength(e,a,D)),C=0,l=D>0?a-4:a,d;for(d=0;d<l;d+=4)t=revLookup[e.charCodeAt(d)]<<18|revLookup[e.charCodeAt(d+1)]<<12|revLookup[e.charCodeAt(d+2)]<<6|revLookup[e.charCodeAt(d+3)],u[C++]=t>>16&255,u[C++]=t>>8&255,u[C++]=t&255;return D===2&&(t=revLookup[e.charCodeAt(d)]<<2|revLookup[e.charCodeAt(d+1)]>>4,u[C++]=t&255),D===1&&(t=revLookup[e.charCodeAt(d)]<<10|revLookup[e.charCodeAt(d+1)]<<4|revLookup[e.charCodeAt(d+2)]>>2,u[C++]=t>>8&255,u[C++]=t&255),u}function tripletToBase64(e){return lookup[e>>18&63]+lookup[e>>12&63]+lookup[e>>6&63]+lookup[e&63]}function encodeChunk(e,t,r){for(var a,D=[],u=t;u<r;u+=3)a=(e[u]<<16&16711680)+(e[u+1]<<8&65280)+(e[u+2]&255),D.push(tripletToBase64(a));return D.join("")}function fromByteArray(e){for(var t,r=e.length,a=r%3,D=[],u=16383,C=0,l=r-a;C<l;C+=u)D.push(encodeChunk(e,C,C+u>l?l:C+u));return a===1?(t=e[r-1],D.push(lookup[t>>2]+lookup[t<<4&63]+"==")):a===2&&(t=(e[r-2]<<8)+e[r-1],D.push(lookup[t>>10]+lookup[t>>4&63]+lookup[t<<2&63]+"=")),D.join("")}var ieee754={};/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ieee754.read=function(e,t,r,a,D){var u,C,l=D*8-a-1,d=(1<<l)-1,B=d>>1,f=-7,p=r?D-1:0,M=r?-1:1,w=e[t+p];for(p+=M,u=w&(1<<-f)-1,w>>=-f,f+=l;f>0;u=u*256+e[t+p],p+=M,f-=8);for(C=u&(1<<-f)-1,u>>=-f,f+=a;f>0;C=C*256+e[t+p],p+=M,f-=8);if(u===0)u=1-B;else{if(u===d)return C?NaN:(w?-1:1)*(1/0);C=C+Math.pow(2,a),u=u-B}return(w?-1:1)*C*Math.pow(2,u-a)},ieee754.write=function(e,t,r,a,D,u){var C,l,d,B=u*8-D-1,f=(1<<B)-1,p=f>>1,M=D===23?Math.pow(2,-24)-Math.pow(2,-77):0,w=a?0:u-1,_=a?1:-1,b=t<0||t===0&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(l=isNaN(t)?1:0,C=f):(C=Math.floor(Math.log(t)/Math.LN2),t*(d=Math.pow(2,-C))<1&&(C--,d*=2),C+p>=1?t+=M/d:t+=M*Math.pow(2,1-p),t*d>=2&&(C++,d/=2),C+p>=f?(l=0,C=f):C+p>=1?(l=(t*d-1)*Math.pow(2,D),C=C+p):(l=t*Math.pow(2,p-1)*Math.pow(2,D),C=0));D>=8;e[r+w]=l&255,w+=_,l/=256,D-=8);for(C=C<<D|l,B+=D;B>0;e[r+w]=C&255,w+=_,C/=256,B-=8);e[r+w-_]|=b*128};/*!
 * The buffer module from node.js, for the browser.
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */(function(e){const t=base64Js,r=ieee754,a=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=l,e.SlowBuffer=W,e.INSPECT_MAX_BYTES=50;const D=2147483647;e.kMaxLength=D,l.TYPED_ARRAY_SUPPORT=u(),!l.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function u(){try{const n=new Uint8Array(1),s={foo:function(){return 42}};return Object.setPrototypeOf(s,Uint8Array.prototype),Object.setPrototypeOf(n,s),n.foo()===42}catch{return!1}}Object.defineProperty(l.prototype,"parent",{enumerable:!0,get:function(){if(l.isBuffer(this))return this.buffer}}),Object.defineProperty(l.prototype,"offset",{enumerable:!0,get:function(){if(l.isBuffer(this))return this.byteOffset}});function C(n){if(n>D)throw new RangeError('The value "'+n+'" is invalid for option "size"');const s=new Uint8Array(n);return Object.setPrototypeOf(s,l.prototype),s}function l(n,s,o){if(typeof n=="number"){if(typeof s=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return p(n)}return d(n,s,o)}l.poolSize=8192;function d(n,s,o){if(typeof n=="string")return M(n,s);if(ArrayBuffer.isView(n))return _(n);if(n==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof n);if(U(n,ArrayBuffer)||n&&U(n.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(U(n,SharedArrayBuffer)||n&&U(n.buffer,SharedArrayBuffer)))return b(n,s,o);if(typeof n=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const c=n.valueOf&&n.valueOf();if(c!=null&&c!==n)return l.from(c,s,o);const E=H(n);if(E)return E;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof n[Symbol.toPrimitive]=="function")return l.from(n[Symbol.toPrimitive]("string"),s,o);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof n)}l.from=function(n,s,o){return d(n,s,o)},Object.setPrototypeOf(l.prototype,Uint8Array.prototype),Object.setPrototypeOf(l,Uint8Array);function B(n){if(typeof n!="number")throw new TypeError('"size" argument must be of type number');if(n<0)throw new RangeError('The value "'+n+'" is invalid for option "size"')}function f(n,s,o){return B(n),n<=0?C(n):s!==void 0?typeof o=="string"?C(n).fill(s,o):C(n).fill(s):C(n)}l.alloc=function(n,s,o){return f(n,s,o)};function p(n){return B(n),C(n<0?0:q(n)|0)}l.allocUnsafe=function(n){return p(n)},l.allocUnsafeSlow=function(n){return p(n)};function M(n,s){if((typeof s!="string"||s==="")&&(s="utf8"),!l.isEncoding(s))throw new TypeError("Unknown encoding: "+s);const o=v(n,s)|0;let c=C(o);const E=c.write(n,s);return E!==o&&(c=c.slice(0,E)),c}function w(n){const s=n.length<0?0:q(n.length)|0,o=C(s);for(let c=0;c<s;c+=1)o[c]=n[c]&255;return o}function _(n){if(U(n,Uint8Array)){const s=new Uint8Array(n);return b(s.buffer,s.byteOffset,s.byteLength)}return w(n)}function b(n,s,o){if(s<0||n.byteLength<s)throw new RangeError('"offset" is outside of buffer bounds');if(n.byteLength<s+(o||0))throw new RangeError('"length" is outside of buffer bounds');let c;return s===void 0&&o===void 0?c=new Uint8Array(n):o===void 0?c=new Uint8Array(n,s):c=new Uint8Array(n,s,o),Object.setPrototypeOf(c,l.prototype),c}function H(n){if(l.isBuffer(n)){const s=q(n.length)|0,o=C(s);return o.length===0||n.copy(o,0,0,s),o}if(n.length!==void 0)return typeof n.length!="number"||V(n.length)?C(0):w(n);if(n.type==="Buffer"&&Array.isArray(n.data))return w(n.data)}function q(n){if(n>=D)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+D.toString(16)+" bytes");return n|0}function W(n){return+n!=n&&(n=0),l.alloc(+n)}l.isBuffer=function(s){return s!=null&&s._isBuffer===!0&&s!==l.prototype},l.compare=function(s,o){if(U(s,Uint8Array)&&(s=l.from(s,s.offset,s.byteLength)),U(o,Uint8Array)&&(o=l.from(o,o.offset,o.byteLength)),!l.isBuffer(s)||!l.isBuffer(o))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(s===o)return 0;let c=s.length,E=o.length;for(let m=0,I=Math.min(c,E);m<I;++m)if(s[m]!==o[m]){c=s[m],E=o[m];break}return c<E?-1:E<c?1:0},l.isEncoding=function(s){switch(String(s).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},l.concat=function(s,o){if(!Array.isArray(s))throw new TypeError('"list" argument must be an Array of Buffers');if(s.length===0)return l.alloc(0);let c;if(o===void 0)for(o=0,c=0;c<s.length;++c)o+=s[c].length;const E=l.allocUnsafe(o);let m=0;for(c=0;c<s.length;++c){let I=s[c];if(U(I,Uint8Array))m+I.length>E.length?(l.isBuffer(I)||(I=l.from(I)),I.copy(E,m)):Uint8Array.prototype.set.call(E,I,m);else if(l.isBuffer(I))I.copy(E,m);else throw new TypeError('"list" argument must be an Array of Buffers');m+=I.length}return E};function v(n,s){if(l.isBuffer(n))return n.length;if(ArrayBuffer.isView(n)||U(n,ArrayBuffer))return n.byteLength;if(typeof n!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof n);const o=n.length,c=arguments.length>2&&arguments[2]===!0;if(!c&&o===0)return 0;let E=!1;for(;;)switch(s){case"ascii":case"latin1":case"binary":return o;case"utf8":case"utf-8":return J(n).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return o*2;case"hex":return o>>>1;case"base64":return ie(n).length;default:if(E)return c?-1:J(n).length;s=(""+s).toLowerCase(),E=!0}}l.byteLength=v;function De(n,s,o){let c=!1;if((s===void 0||s<0)&&(s=0),s>this.length||((o===void 0||o>this.length)&&(o=this.length),o<=0)||(o>>>=0,s>>>=0,o<=s))return"";for(n||(n="utf8");;)switch(n){case"hex":return pe(this,s,o);case"utf8":case"utf-8":return z(this,s,o);case"ascii":return Ie(this,s,o);case"latin1":case"binary":return de(this,s,o);case"base64":return Ce(this,s,o);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return he(this,s,o);default:if(c)throw new TypeError("Unknown encoding: "+n);n=(n+"").toLowerCase(),c=!0}}l.prototype._isBuffer=!0;function F(n,s,o){const c=n[s];n[s]=n[o],n[o]=c}l.prototype.swap16=function(){const s=this.length;if(s%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let o=0;o<s;o+=2)F(this,o,o+1);return this},l.prototype.swap32=function(){const s=this.length;if(s%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let o=0;o<s;o+=4)F(this,o,o+3),F(this,o+1,o+2);return this},l.prototype.swap64=function(){const s=this.length;if(s%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let o=0;o<s;o+=8)F(this,o,o+7),F(this,o+1,o+6),F(this,o+2,o+5),F(this,o+3,o+4);return this},l.prototype.toString=function(){const s=this.length;return s===0?"":arguments.length===0?z(this,0,s):De.apply(this,arguments)},l.prototype.toLocaleString=l.prototype.toString,l.prototype.equals=function(s){if(!l.isBuffer(s))throw new TypeError("Argument must be a Buffer");return this===s?!0:l.compare(this,s)===0},l.prototype.inspect=function(){let s="";const o=e.INSPECT_MAX_BYTES;return s=this.toString("hex",0,o).replace(/(.{2})/g,"$1 ").trim(),this.length>o&&(s+=" ... "),"<Buffer "+s+">"},a&&(l.prototype[a]=l.prototype.inspect),l.prototype.compare=function(s,o,c,E,m){if(U(s,Uint8Array)&&(s=l.from(s,s.offset,s.byteLength)),!l.isBuffer(s))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof s);if(o===void 0&&(o=0),c===void 0&&(c=s?s.length:0),E===void 0&&(E=0),m===void 0&&(m=this.length),o<0||c>s.length||E<0||m>this.length)throw new RangeError("out of range index");if(E>=m&&o>=c)return 0;if(E>=m)return-1;if(o>=c)return 1;if(o>>>=0,c>>>=0,E>>>=0,m>>>=0,this===s)return 0;let I=m-E,h=c-o;const T=Math.min(I,h),O=this.slice(E,m),k=s.slice(o,c);for(let R=0;R<T;++R)if(O[R]!==k[R]){I=O[R],h=k[R];break}return I<h?-1:h<I?1:0};function $(n,s,o,c,E){if(n.length===0)return-1;if(typeof o=="string"?(c=o,o=0):o>2147483647?o=2147483647:o<-2147483648&&(o=-2147483648),o=+o,V(o)&&(o=E?0:n.length-1),o<0&&(o=n.length+o),o>=n.length){if(E)return-1;o=n.length-1}else if(o<0)if(E)o=0;else return-1;if(typeof s=="string"&&(s=l.from(s,c)),l.isBuffer(s))return s.length===0?-1:j(n,s,o,c,E);if(typeof s=="number")return s=s&255,typeof Uint8Array.prototype.indexOf=="function"?E?Uint8Array.prototype.indexOf.call(n,s,o):Uint8Array.prototype.lastIndexOf.call(n,s,o):j(n,[s],o,c,E);throw new TypeError("val must be string, number or Buffer")}function j(n,s,o,c,E){let m=1,I=n.length,h=s.length;if(c!==void 0&&(c=String(c).toLowerCase(),c==="ucs2"||c==="ucs-2"||c==="utf16le"||c==="utf-16le")){if(n.length<2||s.length<2)return-1;m=2,I/=2,h/=2,o/=2}function T(k,R){return m===1?k[R]:k.readUInt16BE(R*m)}let O;if(E){let k=-1;for(O=o;O<I;O++)if(T(n,O)===T(s,k===-1?0:O-k)){if(k===-1&&(k=O),O-k+1===h)return k*m}else k!==-1&&(O-=O-k),k=-1}else for(o+h>I&&(o=I-h),O=o;O>=0;O--){let k=!0;for(let R=0;R<h;R++)if(T(n,O+R)!==T(s,R)){k=!1;break}if(k)return O}return-1}l.prototype.includes=function(s,o,c){return this.indexOf(s,o,c)!==-1},l.prototype.indexOf=function(s,o,c){return $(this,s,o,c,!0)},l.prototype.lastIndexOf=function(s,o,c){return $(this,s,o,c,!1)};function ce(n,s,o,c){o=Number(o)||0;const E=n.length-o;c?(c=Number(c),c>E&&(c=E)):c=E;const m=s.length;c>m/2&&(c=m/2);let I;for(I=0;I<c;++I){const h=parseInt(s.substr(I*2,2),16);if(V(h))return I;n[o+I]=h}return I}function le(n,s,o,c){return x(J(s,n.length-o),n,o,c)}function ue(n,s,o,c){return x(Be(s),n,o,c)}function Ee(n,s,o,c){return x(ie(s),n,o,c)}function Se(n,s,o,c){return x(Oe(s,n.length-o),n,o,c)}l.prototype.write=function(s,o,c,E){if(o===void 0)E="utf8",c=this.length,o=0;else if(c===void 0&&typeof o=="string")E=o,c=this.length,o=0;else if(isFinite(o))o=o>>>0,isFinite(c)?(c=c>>>0,E===void 0&&(E="utf8")):(E=c,c=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const m=this.length-o;if((c===void 0||c>m)&&(c=m),s.length>0&&(c<0||o<0)||o>this.length)throw new RangeError("Attempt to write outside buffer bounds");E||(E="utf8");let I=!1;for(;;)switch(E){case"hex":return ce(this,s,o,c);case"utf8":case"utf-8":return le(this,s,o,c);case"ascii":case"latin1":case"binary":return ue(this,s,o,c);case"base64":return Ee(this,s,o,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Se(this,s,o,c);default:if(I)throw new TypeError("Unknown encoding: "+E);E=(""+E).toLowerCase(),I=!0}},l.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function Ce(n,s,o){return s===0&&o===n.length?t.fromByteArray(n):t.fromByteArray(n.slice(s,o))}function z(n,s,o){o=Math.min(n.length,o);const c=[];let E=s;for(;E<o;){const m=n[E];let I=null,h=m>239?4:m>223?3:m>191?2:1;if(E+h<=o){let T,O,k,R;switch(h){case 1:m<128&&(I=m);break;case 2:T=n[E+1],(T&192)===128&&(R=(m&31)<<6|T&63,R>127&&(I=R));break;case 3:T=n[E+1],O=n[E+2],(T&192)===128&&(O&192)===128&&(R=(m&15)<<12|(T&63)<<6|O&63,R>2047&&(R<55296||R>57343)&&(I=R));break;case 4:T=n[E+1],O=n[E+2],k=n[E+3],(T&192)===128&&(O&192)===128&&(k&192)===128&&(R=(m&15)<<18|(T&63)<<12|(O&63)<<6|k&63,R>65535&&R<1114112&&(I=R))}}I===null?(I=65533,h=1):I>65535&&(I-=65536,c.push(I>>>10&1023|55296),I=56320|I&1023),c.push(I),E+=h}return me(c)}const ee=4096;function me(n){const s=n.length;if(s<=ee)return String.fromCharCode.apply(String,n);let o="",c=0;for(;c<s;)o+=String.fromCharCode.apply(String,n.slice(c,c+=ee));return o}function Ie(n,s,o){let c="";o=Math.min(n.length,o);for(let E=s;E<o;++E)c+=String.fromCharCode(n[E]&127);return c}function de(n,s,o){let c="";o=Math.min(n.length,o);for(let E=s;E<o;++E)c+=String.fromCharCode(n[E]);return c}function pe(n,s,o){const c=n.length;(!s||s<0)&&(s=0),(!o||o<0||o>c)&&(o=c);let E="";for(let m=s;m<o;++m)E+=Me[n[m]];return E}function he(n,s,o){const c=n.slice(s,o);let E="";for(let m=0;m<c.length-1;m+=2)E+=String.fromCharCode(c[m]+c[m+1]*256);return E}l.prototype.slice=function(s,o){const c=this.length;s=~~s,o=o===void 0?c:~~o,s<0?(s+=c,s<0&&(s=0)):s>c&&(s=c),o<0?(o+=c,o<0&&(o=0)):o>c&&(o=c),o<s&&(o=s);const E=this.subarray(s,o);return Object.setPrototypeOf(E,l.prototype),E};function y(n,s,o){if(n%1!==0||n<0)throw new RangeError("offset is not uint");if(n+s>o)throw new RangeError("Trying to access beyond buffer length")}l.prototype.readUintLE=l.prototype.readUIntLE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=this[s],m=1,I=0;for(;++I<o&&(m*=256);)E+=this[s+I]*m;return E},l.prototype.readUintBE=l.prototype.readUIntBE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=this[s+--o],m=1;for(;o>0&&(m*=256);)E+=this[s+--o]*m;return E},l.prototype.readUint8=l.prototype.readUInt8=function(s,o){return s=s>>>0,o||y(s,1,this.length),this[s]},l.prototype.readUint16LE=l.prototype.readUInt16LE=function(s,o){return s=s>>>0,o||y(s,2,this.length),this[s]|this[s+1]<<8},l.prototype.readUint16BE=l.prototype.readUInt16BE=function(s,o){return s=s>>>0,o||y(s,2,this.length),this[s]<<8|this[s+1]},l.prototype.readUint32LE=l.prototype.readUInt32LE=function(s,o){return s=s>>>0,o||y(s,4,this.length),(this[s]|this[s+1]<<8|this[s+2]<<16)+this[s+3]*16777216},l.prototype.readUint32BE=l.prototype.readUInt32BE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]*16777216+(this[s+1]<<16|this[s+2]<<8|this[s+3])},l.prototype.readBigUInt64LE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24,m=this[++s]+this[++s]*2**8+this[++s]*2**16+c*2**24;return BigInt(E)+(BigInt(m)<<BigInt(32))}),l.prototype.readBigUInt64BE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=o*2**24+this[++s]*2**16+this[++s]*2**8+this[++s],m=this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+c;return(BigInt(E)<<BigInt(32))+BigInt(m)}),l.prototype.readIntLE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=this[s],m=1,I=0;for(;++I<o&&(m*=256);)E+=this[s+I]*m;return m*=128,E>=m&&(E-=Math.pow(2,8*o)),E},l.prototype.readIntBE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=o,m=1,I=this[s+--E];for(;E>0&&(m*=256);)I+=this[s+--E]*m;return m*=128,I>=m&&(I-=Math.pow(2,8*o)),I},l.prototype.readInt8=function(s,o){return s=s>>>0,o||y(s,1,this.length),this[s]&128?(255-this[s]+1)*-1:this[s]},l.prototype.readInt16LE=function(s,o){s=s>>>0,o||y(s,2,this.length);const c=this[s]|this[s+1]<<8;return c&32768?c|4294901760:c},l.prototype.readInt16BE=function(s,o){s=s>>>0,o||y(s,2,this.length);const c=this[s+1]|this[s]<<8;return c&32768?c|4294901760:c},l.prototype.readInt32LE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]|this[s+1]<<8|this[s+2]<<16|this[s+3]<<24},l.prototype.readInt32BE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]<<24|this[s+1]<<16|this[s+2]<<8|this[s+3]},l.prototype.readBigInt64LE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=this[s+4]+this[s+5]*2**8+this[s+6]*2**16+(c<<24);return(BigInt(E)<<BigInt(32))+BigInt(o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24)}),l.prototype.readBigInt64BE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=(o<<24)+this[++s]*2**16+this[++s]*2**8+this[++s];return(BigInt(E)<<BigInt(32))+BigInt(this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+c)}),l.prototype.readFloatLE=function(s,o){return s=s>>>0,o||y(s,4,this.length),r.read(this,s,!0,23,4)},l.prototype.readFloatBE=function(s,o){return s=s>>>0,o||y(s,4,this.length),r.read(this,s,!1,23,4)},l.prototype.readDoubleLE=function(s,o){return s=s>>>0,o||y(s,8,this.length),r.read(this,s,!0,52,8)},l.prototype.readDoubleBE=function(s,o){return s=s>>>0,o||y(s,8,this.length),r.read(this,s,!1,52,8)};function L(n,s,o,c,E,m){if(!l.isBuffer(n))throw new TypeError('"buffer" argument must be a Buffer instance');if(s>E||s<m)throw new RangeError('"value" argument is out of bounds');if(o+c>n.length)throw new RangeError("Index out of range")}l.prototype.writeUintLE=l.prototype.writeUIntLE=function(s,o,c,E){if(s=+s,o=o>>>0,c=c>>>0,!E){const h=Math.pow(2,8*c)-1;L(this,s,o,c,h,0)}let m=1,I=0;for(this[o]=s&255;++I<c&&(m*=256);)this[o+I]=s/m&255;return o+c},l.prototype.writeUintBE=l.prototype.writeUIntBE=function(s,o,c,E){if(s=+s,o=o>>>0,c=c>>>0,!E){const h=Math.pow(2,8*c)-1;L(this,s,o,c,h,0)}let m=c-1,I=1;for(this[o+m]=s&255;--m>=0&&(I*=256);)this[o+m]=s/I&255;return o+c},l.prototype.writeUint8=l.prototype.writeUInt8=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,1,255,0),this[o]=s&255,o+1},l.prototype.writeUint16LE=l.prototype.writeUInt16LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,65535,0),this[o]=s&255,this[o+1]=s>>>8,o+2},l.prototype.writeUint16BE=l.prototype.writeUInt16BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,65535,0),this[o]=s>>>8,this[o+1]=s&255,o+2},l.prototype.writeUint32LE=l.prototype.writeUInt32LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,4294967295,0),this[o+3]=s>>>24,this[o+2]=s>>>16,this[o+1]=s>>>8,this[o]=s&255,o+4},l.prototype.writeUint32BE=l.prototype.writeUInt32BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,4294967295,0),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4};function te(n,s,o,c,E){ne(s,c,E,n,o,7);let m=Number(s&BigInt(4294967295));n[o++]=m,m=m>>8,n[o++]=m,m=m>>8,n[o++]=m,m=m>>8,n[o++]=m;let I=Number(s>>BigInt(32)&BigInt(4294967295));return n[o++]=I,I=I>>8,n[o++]=I,I=I>>8,n[o++]=I,I=I>>8,n[o++]=I,o}function re(n,s,o,c,E){ne(s,c,E,n,o,7);let m=Number(s&BigInt(4294967295));n[o+7]=m,m=m>>8,n[o+6]=m,m=m>>8,n[o+5]=m,m=m>>8,n[o+4]=m;let I=Number(s>>BigInt(32)&BigInt(4294967295));return n[o+3]=I,I=I>>8,n[o+2]=I,I=I>>8,n[o+1]=I,I=I>>8,n[o]=I,o+8}l.prototype.writeBigUInt64LE=N(function(s,o=0){return te(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),l.prototype.writeBigUInt64BE=N(function(s,o=0){return re(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),l.prototype.writeIntLE=function(s,o,c,E){if(s=+s,o=o>>>0,!E){const T=Math.pow(2,8*c-1);L(this,s,o,c,T-1,-T)}let m=0,I=1,h=0;for(this[o]=s&255;++m<c&&(I*=256);)s<0&&h===0&&this[o+m-1]!==0&&(h=1),this[o+m]=(s/I>>0)-h&255;return o+c},l.prototype.writeIntBE=function(s,o,c,E){if(s=+s,o=o>>>0,!E){const T=Math.pow(2,8*c-1);L(this,s,o,c,T-1,-T)}let m=c-1,I=1,h=0;for(this[o+m]=s&255;--m>=0&&(I*=256);)s<0&&h===0&&this[o+m+1]!==0&&(h=1),this[o+m]=(s/I>>0)-h&255;return o+c},l.prototype.writeInt8=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,1,127,-128),s<0&&(s=255+s+1),this[o]=s&255,o+1},l.prototype.writeInt16LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,32767,-32768),this[o]=s&255,this[o+1]=s>>>8,o+2},l.prototype.writeInt16BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,32767,-32768),this[o]=s>>>8,this[o+1]=s&255,o+2},l.prototype.writeInt32LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,2147483647,-2147483648),this[o]=s&255,this[o+1]=s>>>8,this[o+2]=s>>>16,this[o+3]=s>>>24,o+4},l.prototype.writeInt32BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,2147483647,-2147483648),s<0&&(s=4294967295+s+1),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4},l.prototype.writeBigInt64LE=N(function(s,o=0){return te(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),l.prototype.writeBigInt64BE=N(function(s,o=0){return re(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function se(n,s,o,c,E,m){if(o+c>n.length)throw new RangeError("Index out of range");if(o<0)throw new RangeError("Index out of range")}function oe(n,s,o,c,E){return s=+s,o=o>>>0,E||se(n,s,o,4),r.write(n,s,o,c,23,4),o+4}l.prototype.writeFloatLE=function(s,o,c){return oe(this,s,o,!0,c)},l.prototype.writeFloatBE=function(s,o,c){return oe(this,s,o,!1,c)};function Ae(n,s,o,c,E){return s=+s,o=o>>>0,E||se(n,s,o,8),r.write(n,s,o,c,52,8),o+8}l.prototype.writeDoubleLE=function(s,o,c){return Ae(this,s,o,!0,c)},l.prototype.writeDoubleBE=function(s,o,c){return Ae(this,s,o,!1,c)},l.prototype.copy=function(s,o,c,E){if(!l.isBuffer(s))throw new TypeError("argument should be a Buffer");if(c||(c=0),!E&&E!==0&&(E=this.length),o>=s.length&&(o=s.length),o||(o=0),E>0&&E<c&&(E=c),E===c||s.length===0||this.length===0)return 0;if(o<0)throw new RangeError("targetStart out of bounds");if(c<0||c>=this.length)throw new RangeError("Index out of range");if(E<0)throw new RangeError("sourceEnd out of bounds");E>this.length&&(E=this.length),s.length-o<E-c&&(E=s.length-o+c);const m=E-c;return this===s&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(o,c,E):Uint8Array.prototype.set.call(s,this.subarray(c,E),o),m},l.prototype.fill=function(s,o,c,E){if(typeof s=="string"){if(typeof o=="string"?(E=o,o=0,c=this.length):typeof c=="string"&&(E=c,c=this.length),E!==void 0&&typeof E!="string")throw new TypeError("encoding must be a string");if(typeof E=="string"&&!l.isEncoding(E))throw new TypeError("Unknown encoding: "+E);if(s.length===1){const I=s.charCodeAt(0);(E==="utf8"&&I<128||E==="latin1")&&(s=I)}}else typeof s=="number"?s=s&255:typeof s=="boolean"&&(s=Number(s));if(o<0||this.length<o||this.length<c)throw new RangeError("Out of range index");if(c<=o)return this;o=o>>>0,c=c===void 0?this.length:c>>>0,s||(s=0);let m;if(typeof s=="number")for(m=o;m<c;++m)this[m]=s;else{const I=l.isBuffer(s)?s:l.from(s,E),h=I.length;if(h===0)throw new TypeError('The value "'+s+'" is invalid for argument "value"');for(m=0;m<c-o;++m)this[m+o]=I[m%h]}return this};const Q={};function Z(n,s,o){Q[n]=class extends o{constructor(){super(),Object.defineProperty(this,"message",{value:s.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${n}]`,this.stack,delete this.name}get code(){return n}set code(E){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:E,writable:!0})}toString(){return`${this.name} [${n}]: ${this.message}`}}}Z("ERR_BUFFER_OUT_OF_BOUNDS",function(n){return n?`${n} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),Z("ERR_INVALID_ARG_TYPE",function(n,s){return`The "${n}" argument must be of type number. Received type ${typeof s}`},TypeError),Z("ERR_OUT_OF_RANGE",function(n,s,o){let c=`The value of "${n}" is out of range.`,E=o;return Number.isInteger(o)&&Math.abs(o)>2**32?E=ae(String(o)):typeof o=="bigint"&&(E=String(o),(o>BigInt(2)**BigInt(32)||o<-(BigInt(2)**BigInt(32)))&&(E=ae(E)),E+="n"),c+=` It must be ${s}. Received ${E}`,c},RangeError);function ae(n){let s="",o=n.length;const c=n[0]==="-"?1:0;for(;o>=c+4;o-=3)s=`_${n.slice(o-3,o)}${s}`;return`${n.slice(0,o)}${s}`}function fe(n,s,o){K(s,"offset"),(n[s]===void 0||n[s+o]===void 0)&&G(s,n.length-(o+1))}function ne(n,s,o,c,E,m){if(n>o||n<s){const I=typeof s=="bigint"?"n":"";let h;throw m>3?s===0||s===BigInt(0)?h=`>= 0${I} and < 2${I} ** ${(m+1)*8}${I}`:h=`>= -(2${I} ** ${(m+1)*8-1}${I}) and < 2 ** ${(m+1)*8-1}${I}`:h=`>= ${s}${I} and <= ${o}${I}`,new Q.ERR_OUT_OF_RANGE("value",h,n)}fe(c,E,m)}function K(n,s){if(typeof n!="number")throw new Q.ERR_INVALID_ARG_TYPE(s,"number",n)}function G(n,s,o){throw Math.floor(n)!==n?(K(n,o),new Q.ERR_OUT_OF_RANGE(o||"offset","an integer",n)):s<0?new Q.ERR_BUFFER_OUT_OF_BOUNDS:new Q.ERR_OUT_OF_RANGE(o||"offset",`>= ${o?1:0} and <= ${s}`,n)}const ge=/[^+/0-9A-Za-z-_]/g;function Re(n){if(n=n.split("=")[0],n=n.trim().replace(ge,""),n.length<2)return"";for(;n.length%4!==0;)n=n+"=";return n}function J(n,s){s=s||1/0;let o;const c=n.length;let E=null;const m=[];for(let I=0;I<c;++I){if(o=n.charCodeAt(I),o>55295&&o<57344){if(!E){if(o>56319){(s-=3)>-1&&m.push(239,191,189);continue}else if(I+1===c){(s-=3)>-1&&m.push(239,191,189);continue}E=o;continue}if(o<56320){(s-=3)>-1&&m.push(239,191,189),E=o;continue}o=(E-55296<<10|o-56320)+65536}else E&&(s-=3)>-1&&m.push(239,191,189);if(E=null,o<128){if((s-=1)<0)break;m.push(o)}else if(o<2048){if((s-=2)<0)break;m.push(o>>6|192,o&63|128)}else if(o<65536){if((s-=3)<0)break;m.push(o>>12|224,o>>6&63|128,o&63|128)}else if(o<1114112){if((s-=4)<0)break;m.push(o>>18|240,o>>12&63|128,o>>6&63|128,o&63|128)}else throw new Error("Invalid code point")}return m}function Be(n){const s=[];for(let o=0;o<n.length;++o)s.push(n.charCodeAt(o)&255);return s}function Oe(n,s){let o,c,E;const m=[];for(let I=0;I<n.length&&!((s-=2)<0);++I)o=n.charCodeAt(I),c=o>>8,E=o%256,m.push(E),m.push(c);return m}function ie(n){return t.toByteArray(Re(n))}function x(n,s,o,c){let E;for(E=0;E<c&&!(E+o>=s.length||E>=n.length);++E)s[E+o]=n[E];return E}function U(n,s){return n instanceof s||n!=null&&n.constructor!=null&&n.constructor.name!=null&&n.constructor.name===s.name}function V(n){return n!==n}const Me=function(){const n="0123456789abcdef",s=new Array(256);for(let o=0;o<16;++o){const c=o*16;for(let E=0;E<16;++E)s[c+E]=n[o]+n[E]}return s}();function N(n){return typeof BigInt>"u"?Te:n}function Te(){throw new Error("BigInt not supported")}})(buffer);const TEST_DEBUG=!0,MAX_SNAPSHOTS=30,ROMpage=256,RamWorksPage=383,ROMmemoryStart=256*ROMpage,RamWorksMemoryStart=256*RamWorksPage;var RUN_MODE=(e=>(e[e.IDLE=0]="IDLE",e[e.RUNNING=-1]="RUNNING",e[e.PAUSED=-2]="PAUSED",e[e.NEED_BOOT=-3]="NEED_BOOT",e[e.NEED_RESET=-4]="NEED_RESET",e))(RUN_MODE||{}),MSG_WORKER=(e=>(e[e.MACHINE_STATE=0]="MACHINE_STATE",e[e.CLICK=1]="CLICK",e[e.DRIVE_PROPS=2]="DRIVE_PROPS",e[e.DRIVE_SOUND=3]="DRIVE_SOUND",e[e.SAVE_STATE=4]="SAVE_STATE",e[e.RUMBLE=5]="RUMBLE",e[e.HELP_TEXT=6]="HELP_TEXT",e[e.SHOW_MOUSE=7]="SHOW_MOUSE",e[e.MBOARD_SOUND=8]="MBOARD_SOUND",e[e.COMM_DATA=9]="COMM_DATA",e[e.MIDI_DATA=10]="MIDI_DATA",e[e.REQUEST_THUMBNAIL=11]="REQUEST_THUMBNAIL",e))(MSG_WORKER||{}),MSG_MAIN=(e=>(e[e.RUN_MODE=0]="RUN_MODE",e[e.STATE6502=1]="STATE6502",e[e.DEBUG=2]="DEBUG",e[e.DISASSEMBLE_ADDR=3]="DISASSEMBLE_ADDR",e[e.BREAKPOINTS=4]="BREAKPOINTS",e[e.STEP_INTO=5]="STEP_INTO",e[e.STEP_OVER=6]="STEP_OVER",e[e.STEP_OUT=7]="STEP_OUT",e[e.SPEED=8]="SPEED",e[e.TIME_TRAVEL_STEP=9]="TIME_TRAVEL_STEP",e[e.TIME_TRAVEL_INDEX=10]="TIME_TRAVEL_INDEX",e[e.TIME_TRAVEL_SNAPSHOT=11]="TIME_TRAVEL_SNAPSHOT",e[e.THUMBNAIL_IMAGE=12]="THUMBNAIL_IMAGE",e[e.RESTORE_STATE=13]="RESTORE_STATE",e[e.KEYPRESS=14]="KEYPRESS",e[e.MOUSEEVENT=15]="MOUSEEVENT",e[e.PASTE_TEXT=16]="PASTE_TEXT",e[e.APPLE_PRESS=17]="APPLE_PRESS",e[e.APPLE_RELEASE=18]="APPLE_RELEASE",e[e.GET_SAVE_STATE=19]="GET_SAVE_STATE",e[e.GET_SAVE_STATE_SNAPSHOTS=20]="GET_SAVE_STATE_SNAPSHOTS",e[e.DRIVE_PROPS=21]="DRIVE_PROPS",e[e.GAMEPAD=22]="GAMEPAD",e[e.SET_BINARY_BLOCK=23]="SET_BINARY_BLOCK",e[e.SET_MEMORY=24]="SET_MEMORY",e[e.COMM_DATA=25]="COMM_DATA",e[e.MIDI_DATA=26]="MIDI_DATA",e[e.RamWorks=27]="RamWorks",e[e.SOFTSWITCHES=28]="SOFTSWITCHES",e))(MSG_MAIN||{}),COLOR_MODE=(e=>(e[e.COLOR=0]="COLOR",e[e.NOFRINGE=1]="NOFRINGE",e[e.GREEN=2]="GREEN",e[e.AMBER=3]="AMBER",e[e.BLACKANDWHITE=4]="BLACKANDWHITE",e))(COLOR_MODE||{}),DRIVE=(e=>(e[e.MOTOR_OFF=0]="MOTOR_OFF",e[e.MOTOR_ON=1]="MOTOR_ON",e[e.TRACK_END=2]="TRACK_END",e[e.TRACK_SEEK=3]="TRACK_SEEK",e))(DRIVE||{}),ADDR_MODE=(e=>(e[e.IMPLIED=0]="IMPLIED",e[e.IMM=1]="IMM",e[e.ZP_REL=2]="ZP_REL",e[e.ZP_X=3]="ZP_X",e[e.ZP_Y=4]="ZP_Y",e[e.ABS=5]="ABS",e[e.ABS_X=6]="ABS_X",e[e.ABS_Y=7]="ABS_Y",e[e.IND_X=8]="IND_X",e[e.IND_Y=9]="IND_Y",e[e.IND=10]="IND",e))(ADDR_MODE||{});const default6502State=()=>({cycleCount:0,PStatus:0,PC:0,Accum:0,XReg:0,YReg:0,StackPtr:0,flagIRQ:0,flagNMI:!1}),isBranchInstruction=e=>e.startsWith("B")&&e!=="BIT"&&e!=="BRK",toHex=(e,t=2)=>(e>255&&(t=4),("0000"+e.toString(16).toUpperCase()).slice(-t)),toASCII=e=>e.split("").map(t=>t.charCodeAt(0)),uint16toBytes=e=>[e&255,e>>>8&255],uint32toBytes=e=>[e&255,e>>>8&255,e>>>16&255,e>>>24&255],replaceSuffix=(e,t)=>{const r=e.lastIndexOf(".")+1;return e.substring(0,r)+t},crcTable=new Uint32Array(256).fill(0),makeCRCTable=()=>{let e;for(let t=0;t<256;t++){e=t;for(let r=0;r<8;r++)e=e&1?3988292384^e>>>1:e>>>1;crcTable[t]=e}},crc32=(e,t=0)=>{crcTable[255]===0&&makeCRCTable();let r=-1;for(let a=t;a<e.length;a++)r=r>>>8^crcTable[(r^e[a])&255];return(r^-1)>>>0},hiresLineToAddress=(e,t)=>e+40*Math.trunc(t/64)+1024*(t%8)+128*(Math.trunc(t/8)&7);let gamePads;const maxTimeoutCycles=Math.trunc(.0028*1020484);let paddle0timeout=maxTimeoutCycles/2,paddle1timeout=maxTimeoutCycles/2,paddle2timeout=maxTimeoutCycles/2,paddle3timeout=maxTimeoutCycles/2,countStart=0,leftAppleDown=!1,rightAppleDown=!1,leftButtonDown=!1,rightButtonDown=!1,isPB2down=!1,isLeftDown=!1,isRightDown=!1;const setLeftButtonDown=()=>{leftButtonDown=!0},setRightButtonDown=()=>{rightButtonDown=!0},setPushButton2=()=>{isPB2down=!0},valueToTimeout=e=>(e=Math.min(Math.max(e,-1),1),(e+1)*maxTimeoutCycles/2),setGamepad0=e=>{paddle0timeout=valueToTimeout(e)},setGamepad1=e=>{paddle1timeout=valueToTimeout(e)},setGamepad2=e=>{paddle2timeout=valueToTimeout(e)},setGamepad3=e=>{paddle3timeout=valueToTimeout(e)},setButtonState=()=>{isLeftDown=leftAppleDown||leftButtonDown,isRightDown=rightAppleDown||rightButtonDown,SWITCHES.PB0.isSet=isLeftDown,SWITCHES.PB1.isSet=isRightDown||isPB2down,SWITCHES.PB2.isSet=isPB2down},pressAppleCommandKey=(e,t)=>{t?leftAppleDown=e:rightAppleDown=e,setButtonState()},resetJoystick=e=>{memSetC000(49252,128),memSetC000(49253,128),memSetC000(49254,128),memSetC000(49255,128),countStart=e},checkJoystickValues=e=>{const t=e-countStart;memSetC000(49252,t<paddle0timeout?128:0),memSetC000(49253,t<paddle1timeout?128:0),memSetC000(49254,t<paddle2timeout?128:0),memSetC000(49255,t<paddle3timeout?128:0)};let gameMapping,gamePadMapping,isKeyboardJoystick=!1;const setGamepads=e=>{gamePads=e,isKeyboardJoystick=!gamePads.length||!gamePads[0].buttons.length,gameMapping=getGameMapping(),gamePadMapping=gameMapping.gamepad?gameMapping.gamepad:defaultButtons},nearZero=e=>e>-.01&&e<.01,scaleAxes=(e,t)=>{nearZero(e)&&(e=0),nearZero(t)&&(t=0);const r=Math.sqrt(e*e+t*t),a=.95*(r===0?1:Math.max(Math.abs(e),Math.abs(t))/r);return e=Math.min(Math.max(-a,e),a),t=Math.min(Math.max(-a,t),a),e=Math.trunc(maxTimeoutCycles*(e+a)/(2*a)),t=Math.trunc(maxTimeoutCycles*(t+a)/(2*a)),[e,t]},convertGamepadAxes=e=>{const[t,r]=scaleAxes(e[0],e[1]),a=e.length>=6?e[5]:e[3],[D,u]=e.length>=4?scaleAxes(e[2],a):[0,0];return[t,r,D,u]},handleGamepad=e=>{const t=gameMapping.joystick?gameMapping.joystick(gamePads[e].axes,isKeyboardJoystick):gamePads[e].axes,r=convertGamepadAxes(t);e===0?(paddle0timeout=r[0],paddle1timeout=r[1],leftButtonDown=!1,rightButtonDown=!1,paddle2timeout=r[2],paddle3timeout=r[3]):(paddle2timeout=r[0],paddle3timeout=r[1],isPB2down=!1);let a=!1;gamePads[e].buttons.forEach((D,u)=>{D&&(gamePadMapping(u,gamePads.length>1,e===1),a=!0)}),a||gamePadMapping(-1,gamePads.length>1,e===1),gameMapping.rumble&&gameMapping.rumble(),setButtonState()},handleGamepads=()=>{gamePads&&gamePads.length>0&&(handleGamepad(0),gamePads.length>1&&handleGamepad(1))},gamepad$4=e=>{switch(e){case 0:addToBufferDebounce("JL");break;case 1:addToBufferDebounce("G",200);break;case 2:addToBuffer("M"),addToBufferDebounce("O");break;case 3:addToBufferDebounce("L");break;case 4:addToBufferDebounce("F");break;case 5:addToBuffer("P"),addToBufferDebounce("T");break;case 6:break;case 7:break;case 8:addToBufferDebounce("Z");break;case 9:{const t=getTextPageAsString();t.includes("'N'")?addToBuffer("N"):t.includes("'S'")?addToBuffer("S"):t.includes("NUMERIC KEY")?addToBuffer("1"):addToBuffer("N");break}case 10:break;case 11:break;case 12:addToBufferDebounce("L");break;case 13:addToBufferDebounce("M");break;case 14:addToBufferDebounce("A");break;case 15:addToBufferDebounce("D");break;case-1:return}};let leftdown=0,rightdown=0,buttonreleased=!1;const threshold$2=.5,joystick$2=e=>e[0]<-threshold$2?(rightdown=0,leftdown===0||leftdown>2?(leftdown=0,addToBuffer("A")):leftdown===1&&buttonreleased?addToBufferDebounce("W"):leftdown===2&&buttonreleased&&addToBufferDebounce("R"),leftdown++,buttonreleased=!1,e):e[0]>threshold$2?(leftdown=0,rightdown===0||rightdown>2?(rightdown=0,addToBuffer("D")):rightdown===1&&buttonreleased?addToBufferDebounce("W"):rightdown===2&&buttonreleased&&addToBufferDebounce("R"),rightdown++,buttonreleased=!1,e):e[1]<-threshold$2?(addToBufferDebounce("C"),e):e[1]>threshold$2?(addToBufferDebounce("S"),e):(buttonreleased=!0,e),helptext$8=`AZTEC
...
`:"";let D=r+a;return D||(D=e[2]<-threshold$1?"L\b":e[2]>threshold$1?"L":"",D||(D=e[3]<-threshold$1?"L\v":e[3]>threshold$1?`L
`:"")),D&&addToBufferDebounce(D,200),[0,0,0,0]},helptext$4=`Nox Archaist, Mark Lemmert, 6502 Workshop, 2021
...
*/const encode_6_and_2=e=>{const t=[150,151,154,155,157,158,159,166,167,171,172,173,174,175,178,179,180,181,182,183,185,186,187,188,189,190,191,203,205,206,207,211,214,215,217,218,219,220,221,222,223,229,230,231,233,234,235,236,237,238,239,242,243,244,245,246,247,249,250,251,252,253,254,255],r=new Uint8Array(343),a=[0,2,1,3];for(let u=0;u<84;u++)r[u]=a[e[u]&3]|a[e[u+86]&3]<<2|a[e[u+172]&3]<<4;r[84]=a[e[84]&3]<<0|a[e[170]&3]<<2,r[85]=a[e[85]&3]<<0|a[e[171]&3]<<2;for(let u=0;u<256;u++)r[86+u]=e[u]>>>2;r[342]=r[341];let D=342;for(;D>1;)D--,r[D]^=r[D-1];for(let u=0;u<343;u++)r[u]=t[r[u]];return r};/*!
