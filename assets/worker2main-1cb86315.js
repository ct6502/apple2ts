var Pe=Object.defineProperty;var ke=(e,t,r)=>t in e?Pe(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var f=(e,t,r)=>(ke(e,typeof t!="symbol"?t+"":t,r),r);(function(){"use strict";var buffer={},base64Js={};base64Js.byteLength=byteLength,base64Js.toByteArray=toByteArray,base64Js.fromByteArray=fromByteArray;for(var lookup=[],revLookup=[],Arr=typeof Uint8Array<"u"?Uint8Array:Array,code$2="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=0,len=code$2.length;i<len;++i)lookup[i]=code$2[i],revLookup[code$2.charCodeAt(i)]=i;revLookup["-".charCodeAt(0)]=62,revLookup["_".charCodeAt(0)]=63;function getLens(e){var t=e.length;if(t%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var r=e.indexOf("=");r===-1&&(r=t);var n=r===t?0:4-r%4;return[r,n]}function byteLength(e){var t=getLens(e),r=t[0],n=t[1];return(r+n)*3/4-n}function _byteLength(e,t,r){return(t+r)*3/4-r}function toByteArray(e){var t,r=getLens(e),n=r[0],D=r[1],l=new Arr(_byteLength(e,n,D)),C=0,u=D>0?n-4:n,d;for(d=0;d<u;d+=4)t=revLookup[e.charCodeAt(d)]<<18|revLookup[e.charCodeAt(d+1)]<<12|revLookup[e.charCodeAt(d+2)]<<6|revLookup[e.charCodeAt(d+3)],l[C++]=t>>16&255,l[C++]=t>>8&255,l[C++]=t&255;return D===2&&(t=revLookup[e.charCodeAt(d)]<<2|revLookup[e.charCodeAt(d+1)]>>4,l[C++]=t&255),D===1&&(t=revLookup[e.charCodeAt(d)]<<10|revLookup[e.charCodeAt(d+1)]<<4|revLookup[e.charCodeAt(d+2)]>>2,l[C++]=t>>8&255,l[C++]=t&255),l}function tripletToBase64(e){return lookup[e>>18&63]+lookup[e>>12&63]+lookup[e>>6&63]+lookup[e&63]}function encodeChunk(e,t,r){for(var n,D=[],l=t;l<r;l+=3)n=(e[l]<<16&16711680)+(e[l+1]<<8&65280)+(e[l+2]&255),D.push(tripletToBase64(n));return D.join("")}function fromByteArray(e){for(var t,r=e.length,n=r%3,D=[],l=16383,C=0,u=r-n;C<u;C+=l)D.push(encodeChunk(e,C,C+l>u?u:C+l));return n===1?(t=e[r-1],D.push(lookup[t>>2]+lookup[t<<4&63]+"==")):n===2&&(t=(e[r-2]<<8)+e[r-1],D.push(lookup[t>>10]+lookup[t>>4&63]+lookup[t<<2&63]+"=")),D.join("")}var ieee754={};/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ieee754.read=function(e,t,r,n,D){var l,C,u=D*8-n-1,d=(1<<u)-1,R=d>>1,g=-7,p=r?D-1:0,M=r?-1:1,w=e[t+p];for(p+=M,l=w&(1<<-g)-1,w>>=-g,g+=u;g>0;l=l*256+e[t+p],p+=M,g-=8);for(C=l&(1<<-g)-1,l>>=-g,g+=n;g>0;C=C*256+e[t+p],p+=M,g-=8);if(l===0)l=1-R;else{if(l===d)return C?NaN:(w?-1:1)*(1/0);C=C+Math.pow(2,n),l=l-R}return(w?-1:1)*C*Math.pow(2,l-n)},ieee754.write=function(e,t,r,n,D,l){var C,u,d,R=l*8-D-1,g=(1<<R)-1,p=g>>1,M=D===23?Math.pow(2,-24)-Math.pow(2,-77):0,w=n?0:l-1,_=n?1:-1,b=t<0||t===0&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(u=isNaN(t)?1:0,C=g):(C=Math.floor(Math.log(t)/Math.LN2),t*(d=Math.pow(2,-C))<1&&(C--,d*=2),C+p>=1?t+=M/d:t+=M*Math.pow(2,1-p),t*d>=2&&(C++,d/=2),C+p>=g?(u=0,C=g):C+p>=1?(u=(t*d-1)*Math.pow(2,D),C=C+p):(u=t*Math.pow(2,p-1)*Math.pow(2,D),C=0));D>=8;e[r+w]=u&255,w+=_,u/=256,D-=8);for(C=C<<D|u,R+=D;R>0;e[r+w]=C&255,w+=_,C/=256,R-=8);e[r+w-_]|=b*128};/*!
 * The buffer module from node.js, for the browser.
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */(function(e){const t=base64Js,r=ieee754,n=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=u,e.SlowBuffer=W,e.INSPECT_MAX_BYTES=50;const D=2147483647;e.kMaxLength=D,u.TYPED_ARRAY_SUPPORT=l(),!u.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function l(){try{const a=new Uint8Array(1),s={foo:function(){return 42}};return Object.setPrototypeOf(s,Uint8Array.prototype),Object.setPrototypeOf(a,s),a.foo()===42}catch{return!1}}Object.defineProperty(u.prototype,"parent",{enumerable:!0,get:function(){if(u.isBuffer(this))return this.buffer}}),Object.defineProperty(u.prototype,"offset",{enumerable:!0,get:function(){if(u.isBuffer(this))return this.byteOffset}});function C(a){if(a>D)throw new RangeError('The value "'+a+'" is invalid for option "size"');const s=new Uint8Array(a);return Object.setPrototypeOf(s,u.prototype),s}function u(a,s,o){if(typeof a=="number"){if(typeof s=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return p(a)}return d(a,s,o)}u.poolSize=8192;function d(a,s,o){if(typeof a=="string")return M(a,s);if(ArrayBuffer.isView(a))return _(a);if(a==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof a);if(U(a,ArrayBuffer)||a&&U(a.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(U(a,SharedArrayBuffer)||a&&U(a.buffer,SharedArrayBuffer)))return b(a,s,o);if(typeof a=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const c=a.valueOf&&a.valueOf();if(c!=null&&c!==a)return u.from(c,s,o);const E=H(a);if(E)return E;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof a[Symbol.toPrimitive]=="function")return u.from(a[Symbol.toPrimitive]("string"),s,o);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof a)}u.from=function(a,s,o){return d(a,s,o)},Object.setPrototypeOf(u.prototype,Uint8Array.prototype),Object.setPrototypeOf(u,Uint8Array);function R(a){if(typeof a!="number")throw new TypeError('"size" argument must be of type number');if(a<0)throw new RangeError('The value "'+a+'" is invalid for option "size"')}function g(a,s,o){return R(a),a<=0?C(a):s!==void 0?typeof o=="string"?C(a).fill(s,o):C(a).fill(s):C(a)}u.alloc=function(a,s,o){return g(a,s,o)};function p(a){return R(a),C(a<0?0:q(a)|0)}u.allocUnsafe=function(a){return p(a)},u.allocUnsafeSlow=function(a){return p(a)};function M(a,s){if((typeof s!="string"||s==="")&&(s="utf8"),!u.isEncoding(s))throw new TypeError("Unknown encoding: "+s);const o=$(a,s)|0;let c=C(o);const E=c.write(a,s);return E!==o&&(c=c.slice(0,E)),c}function w(a){const s=a.length<0?0:q(a.length)|0,o=C(s);for(let c=0;c<s;c+=1)o[c]=a[c]&255;return o}function _(a){if(U(a,Uint8Array)){const s=new Uint8Array(a);return b(s.buffer,s.byteOffset,s.byteLength)}return w(a)}function b(a,s,o){if(s<0||a.byteLength<s)throw new RangeError('"offset" is outside of buffer bounds');if(a.byteLength<s+(o||0))throw new RangeError('"length" is outside of buffer bounds');let c;return s===void 0&&o===void 0?c=new Uint8Array(a):o===void 0?c=new Uint8Array(a,s):c=new Uint8Array(a,s,o),Object.setPrototypeOf(c,u.prototype),c}function H(a){if(u.isBuffer(a)){const s=q(a.length)|0,o=C(s);return o.length===0||a.copy(o,0,0,s),o}if(a.length!==void 0)return typeof a.length!="number"||V(a.length)?C(0):w(a);if(a.type==="Buffer"&&Array.isArray(a.data))return w(a.data)}function q(a){if(a>=D)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+D.toString(16)+" bytes");return a|0}function W(a){return+a!=a&&(a=0),u.alloc(+a)}u.isBuffer=function(s){return s!=null&&s._isBuffer===!0&&s!==u.prototype},u.compare=function(s,o){if(U(s,Uint8Array)&&(s=u.from(s,s.offset,s.byteLength)),U(o,Uint8Array)&&(o=u.from(o,o.offset,o.byteLength)),!u.isBuffer(s)||!u.isBuffer(o))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(s===o)return 0;let c=s.length,E=o.length;for(let I=0,m=Math.min(c,E);I<m;++I)if(s[I]!==o[I]){c=s[I],E=o[I];break}return c<E?-1:E<c?1:0},u.isEncoding=function(s){switch(String(s).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},u.concat=function(s,o){if(!Array.isArray(s))throw new TypeError('"list" argument must be an Array of Buffers');if(s.length===0)return u.alloc(0);let c;if(o===void 0)for(o=0,c=0;c<s.length;++c)o+=s[c].length;const E=u.allocUnsafe(o);let I=0;for(c=0;c<s.length;++c){let m=s[c];if(U(m,Uint8Array))I+m.length>E.length?(u.isBuffer(m)||(m=u.from(m)),m.copy(E,I)):Uint8Array.prototype.set.call(E,m,I);else if(u.isBuffer(m))m.copy(E,I);else throw new TypeError('"list" argument must be an Array of Buffers');I+=m.length}return E};function $(a,s){if(u.isBuffer(a))return a.length;if(ArrayBuffer.isView(a)||U(a,ArrayBuffer))return a.byteLength;if(typeof a!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof a);const o=a.length,c=arguments.length>2&&arguments[2]===!0;if(!c&&o===0)return 0;let E=!1;for(;;)switch(s){case"ascii":case"latin1":case"binary":return o;case"utf8":case"utf-8":return J(a).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return o*2;case"hex":return o>>>1;case"base64":return ie(a).length;default:if(E)return c?-1:J(a).length;s=(""+s).toLowerCase(),E=!0}}u.byteLength=$;function De(a,s,o){let c=!1;if((s===void 0||s<0)&&(s=0),s>this.length||((o===void 0||o>this.length)&&(o=this.length),o<=0)||(o>>>=0,s>>>=0,o<=s))return"";for(a||(a="utf8");;)switch(a){case"hex":return pe(this,s,o);case"utf8":case"utf-8":return z(this,s,o);case"ascii":return me(this,s,o);case"latin1":case"binary":return de(this,s,o);case"base64":return Ce(this,s,o);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return he(this,s,o);default:if(c)throw new TypeError("Unknown encoding: "+a);a=(a+"").toLowerCase(),c=!0}}u.prototype._isBuffer=!0;function Q(a,s,o){const c=a[s];a[s]=a[o],a[o]=c}u.prototype.swap16=function(){const s=this.length;if(s%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let o=0;o<s;o+=2)Q(this,o,o+1);return this},u.prototype.swap32=function(){const s=this.length;if(s%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let o=0;o<s;o+=4)Q(this,o,o+3),Q(this,o+1,o+2);return this},u.prototype.swap64=function(){const s=this.length;if(s%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let o=0;o<s;o+=8)Q(this,o,o+7),Q(this,o+1,o+6),Q(this,o+2,o+5),Q(this,o+3,o+4);return this},u.prototype.toString=function(){const s=this.length;return s===0?"":arguments.length===0?z(this,0,s):De.apply(this,arguments)},u.prototype.toLocaleString=u.prototype.toString,u.prototype.equals=function(s){if(!u.isBuffer(s))throw new TypeError("Argument must be a Buffer");return this===s?!0:u.compare(this,s)===0},u.prototype.inspect=function(){let s="";const o=e.INSPECT_MAX_BYTES;return s=this.toString("hex",0,o).replace(/(.{2})/g,"$1 ").trim(),this.length>o&&(s+=" ... "),"<Buffer "+s+">"},n&&(u.prototype[n]=u.prototype.inspect),u.prototype.compare=function(s,o,c,E,I){if(U(s,Uint8Array)&&(s=u.from(s,s.offset,s.byteLength)),!u.isBuffer(s))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof s);if(o===void 0&&(o=0),c===void 0&&(c=s?s.length:0),E===void 0&&(E=0),I===void 0&&(I=this.length),o<0||c>s.length||E<0||I>this.length)throw new RangeError("out of range index");if(E>=I&&o>=c)return 0;if(E>=I)return-1;if(o>=c)return 1;if(o>>>=0,c>>>=0,E>>>=0,I>>>=0,this===s)return 0;let m=I-E,h=c-o;const T=Math.min(m,h),O=this.slice(E,I),k=s.slice(o,c);for(let B=0;B<T;++B)if(O[B]!==k[B]){m=O[B],h=k[B];break}return m<h?-1:h<m?1:0};function v(a,s,o,c,E){if(a.length===0)return-1;if(typeof o=="string"?(c=o,o=0):o>2147483647?o=2147483647:o<-2147483648&&(o=-2147483648),o=+o,V(o)&&(o=E?0:a.length-1),o<0&&(o=a.length+o),o>=a.length){if(E)return-1;o=a.length-1}else if(o<0)if(E)o=0;else return-1;if(typeof s=="string"&&(s=u.from(s,c)),u.isBuffer(s))return s.length===0?-1:j(a,s,o,c,E);if(typeof s=="number")return s=s&255,typeof Uint8Array.prototype.indexOf=="function"?E?Uint8Array.prototype.indexOf.call(a,s,o):Uint8Array.prototype.lastIndexOf.call(a,s,o):j(a,[s],o,c,E);throw new TypeError("val must be string, number or Buffer")}function j(a,s,o,c,E){let I=1,m=a.length,h=s.length;if(c!==void 0&&(c=String(c).toLowerCase(),c==="ucs2"||c==="ucs-2"||c==="utf16le"||c==="utf-16le")){if(a.length<2||s.length<2)return-1;I=2,m/=2,h/=2,o/=2}function T(k,B){return I===1?k[B]:k.readUInt16BE(B*I)}let O;if(E){let k=-1;for(O=o;O<m;O++)if(T(a,O)===T(s,k===-1?0:O-k)){if(k===-1&&(k=O),O-k+1===h)return k*I}else k!==-1&&(O-=O-k),k=-1}else for(o+h>m&&(o=m-h),O=o;O>=0;O--){let k=!0;for(let B=0;B<h;B++)if(T(a,O+B)!==T(s,B)){k=!1;break}if(k)return O}return-1}u.prototype.includes=function(s,o,c){return this.indexOf(s,o,c)!==-1},u.prototype.indexOf=function(s,o,c){return v(this,s,o,c,!0)},u.prototype.lastIndexOf=function(s,o,c){return v(this,s,o,c,!1)};function ce(a,s,o,c){o=Number(o)||0;const E=a.length-o;c?(c=Number(c),c>E&&(c=E)):c=E;const I=s.length;c>I/2&&(c=I/2);let m;for(m=0;m<c;++m){const h=parseInt(s.substr(m*2,2),16);if(V(h))return m;a[o+m]=h}return m}function ue(a,s,o,c){return x(J(s,a.length-o),a,o,c)}function le(a,s,o,c){return x(Re(s),a,o,c)}function Ee(a,s,o,c){return x(ie(s),a,o,c)}function Se(a,s,o,c){return x(Oe(s,a.length-o),a,o,c)}u.prototype.write=function(s,o,c,E){if(o===void 0)E="utf8",c=this.length,o=0;else if(c===void 0&&typeof o=="string")E=o,c=this.length,o=0;else if(isFinite(o))o=o>>>0,isFinite(c)?(c=c>>>0,E===void 0&&(E="utf8")):(E=c,c=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const I=this.length-o;if((c===void 0||c>I)&&(c=I),s.length>0&&(c<0||o<0)||o>this.length)throw new RangeError("Attempt to write outside buffer bounds");E||(E="utf8");let m=!1;for(;;)switch(E){case"hex":return ce(this,s,o,c);case"utf8":case"utf-8":return ue(this,s,o,c);case"ascii":case"latin1":case"binary":return le(this,s,o,c);case"base64":return Ee(this,s,o,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Se(this,s,o,c);default:if(m)throw new TypeError("Unknown encoding: "+E);E=(""+E).toLowerCase(),m=!0}},u.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function Ce(a,s,o){return s===0&&o===a.length?t.fromByteArray(a):t.fromByteArray(a.slice(s,o))}function z(a,s,o){o=Math.min(a.length,o);const c=[];let E=s;for(;E<o;){const I=a[E];let m=null,h=I>239?4:I>223?3:I>191?2:1;if(E+h<=o){let T,O,k,B;switch(h){case 1:I<128&&(m=I);break;case 2:T=a[E+1],(T&192)===128&&(B=(I&31)<<6|T&63,B>127&&(m=B));break;case 3:T=a[E+1],O=a[E+2],(T&192)===128&&(O&192)===128&&(B=(I&15)<<12|(T&63)<<6|O&63,B>2047&&(B<55296||B>57343)&&(m=B));break;case 4:T=a[E+1],O=a[E+2],k=a[E+3],(T&192)===128&&(O&192)===128&&(k&192)===128&&(B=(I&15)<<18|(T&63)<<12|(O&63)<<6|k&63,B>65535&&B<1114112&&(m=B))}}m===null?(m=65533,h=1):m>65535&&(m-=65536,c.push(m>>>10&1023|55296),m=56320|m&1023),c.push(m),E+=h}return Ie(c)}const ee=4096;function Ie(a){const s=a.length;if(s<=ee)return String.fromCharCode.apply(String,a);let o="",c=0;for(;c<s;)o+=String.fromCharCode.apply(String,a.slice(c,c+=ee));return o}function me(a,s,o){let c="";o=Math.min(a.length,o);for(let E=s;E<o;++E)c+=String.fromCharCode(a[E]&127);return c}function de(a,s,o){let c="";o=Math.min(a.length,o);for(let E=s;E<o;++E)c+=String.fromCharCode(a[E]);return c}function pe(a,s,o){const c=a.length;(!s||s<0)&&(s=0),(!o||o<0||o>c)&&(o=c);let E="";for(let I=s;I<o;++I)E+=Me[a[I]];return E}function he(a,s,o){const c=a.slice(s,o);let E="";for(let I=0;I<c.length-1;I+=2)E+=String.fromCharCode(c[I]+c[I+1]*256);return E}u.prototype.slice=function(s,o){const c=this.length;s=~~s,o=o===void 0?c:~~o,s<0?(s+=c,s<0&&(s=0)):s>c&&(s=c),o<0?(o+=c,o<0&&(o=0)):o>c&&(o=c),o<s&&(o=s);const E=this.subarray(s,o);return Object.setPrototypeOf(E,u.prototype),E};function y(a,s,o){if(a%1!==0||a<0)throw new RangeError("offset is not uint");if(a+s>o)throw new RangeError("Trying to access beyond buffer length")}u.prototype.readUintLE=u.prototype.readUIntLE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=this[s],I=1,m=0;for(;++m<o&&(I*=256);)E+=this[s+m]*I;return E},u.prototype.readUintBE=u.prototype.readUIntBE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=this[s+--o],I=1;for(;o>0&&(I*=256);)E+=this[s+--o]*I;return E},u.prototype.readUint8=u.prototype.readUInt8=function(s,o){return s=s>>>0,o||y(s,1,this.length),this[s]},u.prototype.readUint16LE=u.prototype.readUInt16LE=function(s,o){return s=s>>>0,o||y(s,2,this.length),this[s]|this[s+1]<<8},u.prototype.readUint16BE=u.prototype.readUInt16BE=function(s,o){return s=s>>>0,o||y(s,2,this.length),this[s]<<8|this[s+1]},u.prototype.readUint32LE=u.prototype.readUInt32LE=function(s,o){return s=s>>>0,o||y(s,4,this.length),(this[s]|this[s+1]<<8|this[s+2]<<16)+this[s+3]*16777216},u.prototype.readUint32BE=u.prototype.readUInt32BE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]*16777216+(this[s+1]<<16|this[s+2]<<8|this[s+3])},u.prototype.readBigUInt64LE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24,I=this[++s]+this[++s]*2**8+this[++s]*2**16+c*2**24;return BigInt(E)+(BigInt(I)<<BigInt(32))}),u.prototype.readBigUInt64BE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=o*2**24+this[++s]*2**16+this[++s]*2**8+this[++s],I=this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+c;return(BigInt(E)<<BigInt(32))+BigInt(I)}),u.prototype.readIntLE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=this[s],I=1,m=0;for(;++m<o&&(I*=256);)E+=this[s+m]*I;return I*=128,E>=I&&(E-=Math.pow(2,8*o)),E},u.prototype.readIntBE=function(s,o,c){s=s>>>0,o=o>>>0,c||y(s,o,this.length);let E=o,I=1,m=this[s+--E];for(;E>0&&(I*=256);)m+=this[s+--E]*I;return I*=128,m>=I&&(m-=Math.pow(2,8*o)),m},u.prototype.readInt8=function(s,o){return s=s>>>0,o||y(s,1,this.length),this[s]&128?(255-this[s]+1)*-1:this[s]},u.prototype.readInt16LE=function(s,o){s=s>>>0,o||y(s,2,this.length);const c=this[s]|this[s+1]<<8;return c&32768?c|4294901760:c},u.prototype.readInt16BE=function(s,o){s=s>>>0,o||y(s,2,this.length);const c=this[s+1]|this[s]<<8;return c&32768?c|4294901760:c},u.prototype.readInt32LE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]|this[s+1]<<8|this[s+2]<<16|this[s+3]<<24},u.prototype.readInt32BE=function(s,o){return s=s>>>0,o||y(s,4,this.length),this[s]<<24|this[s+1]<<16|this[s+2]<<8|this[s+3]},u.prototype.readBigInt64LE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=this[s+4]+this[s+5]*2**8+this[s+6]*2**16+(c<<24);return(BigInt(E)<<BigInt(32))+BigInt(o+this[++s]*2**8+this[++s]*2**16+this[++s]*2**24)}),u.prototype.readBigInt64BE=N(function(s){s=s>>>0,K(s,"offset");const o=this[s],c=this[s+7];(o===void 0||c===void 0)&&G(s,this.length-8);const E=(o<<24)+this[++s]*2**16+this[++s]*2**8+this[++s];return(BigInt(E)<<BigInt(32))+BigInt(this[++s]*2**24+this[++s]*2**16+this[++s]*2**8+c)}),u.prototype.readFloatLE=function(s,o){return s=s>>>0,o||y(s,4,this.length),r.read(this,s,!0,23,4)},u.prototype.readFloatBE=function(s,o){return s=s>>>0,o||y(s,4,this.length),r.read(this,s,!1,23,4)},u.prototype.readDoubleLE=function(s,o){return s=s>>>0,o||y(s,8,this.length),r.read(this,s,!0,52,8)},u.prototype.readDoubleBE=function(s,o){return s=s>>>0,o||y(s,8,this.length),r.read(this,s,!1,52,8)};function L(a,s,o,c,E,I){if(!u.isBuffer(a))throw new TypeError('"buffer" argument must be a Buffer instance');if(s>E||s<I)throw new RangeError('"value" argument is out of bounds');if(o+c>a.length)throw new RangeError("Index out of range")}u.prototype.writeUintLE=u.prototype.writeUIntLE=function(s,o,c,E){if(s=+s,o=o>>>0,c=c>>>0,!E){const h=Math.pow(2,8*c)-1;L(this,s,o,c,h,0)}let I=1,m=0;for(this[o]=s&255;++m<c&&(I*=256);)this[o+m]=s/I&255;return o+c},u.prototype.writeUintBE=u.prototype.writeUIntBE=function(s,o,c,E){if(s=+s,o=o>>>0,c=c>>>0,!E){const h=Math.pow(2,8*c)-1;L(this,s,o,c,h,0)}let I=c-1,m=1;for(this[o+I]=s&255;--I>=0&&(m*=256);)this[o+I]=s/m&255;return o+c},u.prototype.writeUint8=u.prototype.writeUInt8=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,1,255,0),this[o]=s&255,o+1},u.prototype.writeUint16LE=u.prototype.writeUInt16LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,65535,0),this[o]=s&255,this[o+1]=s>>>8,o+2},u.prototype.writeUint16BE=u.prototype.writeUInt16BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,65535,0),this[o]=s>>>8,this[o+1]=s&255,o+2},u.prototype.writeUint32LE=u.prototype.writeUInt32LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,4294967295,0),this[o+3]=s>>>24,this[o+2]=s>>>16,this[o+1]=s>>>8,this[o]=s&255,o+4},u.prototype.writeUint32BE=u.prototype.writeUInt32BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,4294967295,0),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4};function te(a,s,o,c,E){ae(s,c,E,a,o,7);let I=Number(s&BigInt(4294967295));a[o++]=I,I=I>>8,a[o++]=I,I=I>>8,a[o++]=I,I=I>>8,a[o++]=I;let m=Number(s>>BigInt(32)&BigInt(4294967295));return a[o++]=m,m=m>>8,a[o++]=m,m=m>>8,a[o++]=m,m=m>>8,a[o++]=m,o}function re(a,s,o,c,E){ae(s,c,E,a,o,7);let I=Number(s&BigInt(4294967295));a[o+7]=I,I=I>>8,a[o+6]=I,I=I>>8,a[o+5]=I,I=I>>8,a[o+4]=I;let m=Number(s>>BigInt(32)&BigInt(4294967295));return a[o+3]=m,m=m>>8,a[o+2]=m,m=m>>8,a[o+1]=m,m=m>>8,a[o]=m,o+8}u.prototype.writeBigUInt64LE=N(function(s,o=0){return te(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),u.prototype.writeBigUInt64BE=N(function(s,o=0){return re(this,s,o,BigInt(0),BigInt("0xffffffffffffffff"))}),u.prototype.writeIntLE=function(s,o,c,E){if(s=+s,o=o>>>0,!E){const T=Math.pow(2,8*c-1);L(this,s,o,c,T-1,-T)}let I=0,m=1,h=0;for(this[o]=s&255;++I<c&&(m*=256);)s<0&&h===0&&this[o+I-1]!==0&&(h=1),this[o+I]=(s/m>>0)-h&255;return o+c},u.prototype.writeIntBE=function(s,o,c,E){if(s=+s,o=o>>>0,!E){const T=Math.pow(2,8*c-1);L(this,s,o,c,T-1,-T)}let I=c-1,m=1,h=0;for(this[o+I]=s&255;--I>=0&&(m*=256);)s<0&&h===0&&this[o+I+1]!==0&&(h=1),this[o+I]=(s/m>>0)-h&255;return o+c},u.prototype.writeInt8=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,1,127,-128),s<0&&(s=255+s+1),this[o]=s&255,o+1},u.prototype.writeInt16LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,32767,-32768),this[o]=s&255,this[o+1]=s>>>8,o+2},u.prototype.writeInt16BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,2,32767,-32768),this[o]=s>>>8,this[o+1]=s&255,o+2},u.prototype.writeInt32LE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,2147483647,-2147483648),this[o]=s&255,this[o+1]=s>>>8,this[o+2]=s>>>16,this[o+3]=s>>>24,o+4},u.prototype.writeInt32BE=function(s,o,c){return s=+s,o=o>>>0,c||L(this,s,o,4,2147483647,-2147483648),s<0&&(s=4294967295+s+1),this[o]=s>>>24,this[o+1]=s>>>16,this[o+2]=s>>>8,this[o+3]=s&255,o+4},u.prototype.writeBigInt64LE=N(function(s,o=0){return te(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),u.prototype.writeBigInt64BE=N(function(s,o=0){return re(this,s,o,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function se(a,s,o,c,E,I){if(o+c>a.length)throw new RangeError("Index out of range");if(o<0)throw new RangeError("Index out of range")}function oe(a,s,o,c,E){return s=+s,o=o>>>0,E||se(a,s,o,4),r.write(a,s,o,c,23,4),o+4}u.prototype.writeFloatLE=function(s,o,c){return oe(this,s,o,!0,c)},u.prototype.writeFloatBE=function(s,o,c){return oe(this,s,o,!1,c)};function Ae(a,s,o,c,E){return s=+s,o=o>>>0,E||se(a,s,o,8),r.write(a,s,o,c,52,8),o+8}u.prototype.writeDoubleLE=function(s,o,c){return Ae(this,s,o,!0,c)},u.prototype.writeDoubleBE=function(s,o,c){return Ae(this,s,o,!1,c)},u.prototype.copy=function(s,o,c,E){if(!u.isBuffer(s))throw new TypeError("argument should be a Buffer");if(c||(c=0),!E&&E!==0&&(E=this.length),o>=s.length&&(o=s.length),o||(o=0),E>0&&E<c&&(E=c),E===c||s.length===0||this.length===0)return 0;if(o<0)throw new RangeError("targetStart out of bounds");if(c<0||c>=this.length)throw new RangeError("Index out of range");if(E<0)throw new RangeError("sourceEnd out of bounds");E>this.length&&(E=this.length),s.length-o<E-c&&(E=s.length-o+c);const I=E-c;return this===s&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(o,c,E):Uint8Array.prototype.set.call(s,this.subarray(c,E),o),I},u.prototype.fill=function(s,o,c,E){if(typeof s=="string"){if(typeof o=="string"?(E=o,o=0,c=this.length):typeof c=="string"&&(E=c,c=this.length),E!==void 0&&typeof E!="string")throw new TypeError("encoding must be a string");if(typeof E=="string"&&!u.isEncoding(E))throw new TypeError("Unknown encoding: "+E);if(s.length===1){const m=s.charCodeAt(0);(E==="utf8"&&m<128||E==="latin1")&&(s=m)}}else typeof s=="number"?s=s&255:typeof s=="boolean"&&(s=Number(s));if(o<0||this.length<o||this.length<c)throw new RangeError("Out of range index");if(c<=o)return this;o=o>>>0,c=c===void 0?this.length:c>>>0,s||(s=0);let I;if(typeof s=="number")for(I=o;I<c;++I)this[I]=s;else{const m=u.isBuffer(s)?s:u.from(s,E),h=m.length;if(h===0)throw new TypeError('The value "'+s+'" is invalid for argument "value"');for(I=0;I<c-o;++I)this[I+o]=m[I%h]}return this};const F={};function Z(a,s,o){F[a]=class extends o{constructor(){super(),Object.defineProperty(this,"message",{value:s.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${a}]`,this.stack,delete this.name}get code(){return a}set code(E){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:E,writable:!0})}toString(){return`${this.name} [${a}]: ${this.message}`}}}Z("ERR_BUFFER_OUT_OF_BOUNDS",function(a){return a?`${a} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),Z("ERR_INVALID_ARG_TYPE",function(a,s){return`The "${a}" argument must be of type number. Received type ${typeof s}`},TypeError),Z("ERR_OUT_OF_RANGE",function(a,s,o){let c=`The value of "${a}" is out of range.`,E=o;return Number.isInteger(o)&&Math.abs(o)>2**32?E=ne(String(o)):typeof o=="bigint"&&(E=String(o),(o>BigInt(2)**BigInt(32)||o<-(BigInt(2)**BigInt(32)))&&(E=ne(E)),E+="n"),c+=` It must be ${s}. Received ${E}`,c},RangeError);function ne(a){let s="",o=a.length;const c=a[0]==="-"?1:0;for(;o>=c+4;o-=3)s=`_${a.slice(o-3,o)}${s}`;return`${a.slice(0,o)}${s}`}function ge(a,s,o){K(s,"offset"),(a[s]===void 0||a[s+o]===void 0)&&G(s,a.length-(o+1))}function ae(a,s,o,c,E,I){if(a>o||a<s){const m=typeof s=="bigint"?"n":"";let h;throw I>3?s===0||s===BigInt(0)?h=`>= 0${m} and < 2${m} ** ${(I+1)*8}${m}`:h=`>= -(2${m} ** ${(I+1)*8-1}${m}) and < 2 ** ${(I+1)*8-1}${m}`:h=`>= ${s}${m} and <= ${o}${m}`,new F.ERR_OUT_OF_RANGE("value",h,a)}ge(c,E,I)}function K(a,s){if(typeof a!="number")throw new F.ERR_INVALID_ARG_TYPE(s,"number",a)}function G(a,s,o){throw Math.floor(a)!==a?(K(a,o),new F.ERR_OUT_OF_RANGE(o||"offset","an integer",a)):s<0?new F.ERR_BUFFER_OUT_OF_BOUNDS:new F.ERR_OUT_OF_RANGE(o||"offset",`>= ${o?1:0} and <= ${s}`,a)}const fe=/[^+/0-9A-Za-z-_]/g;function Be(a){if(a=a.split("=")[0],a=a.trim().replace(fe,""),a.length<2)return"";for(;a.length%4!==0;)a=a+"=";return a}function J(a,s){s=s||1/0;let o;const c=a.length;let E=null;const I=[];for(let m=0;m<c;++m){if(o=a.charCodeAt(m),o>55295&&o<57344){if(!E){if(o>56319){(s-=3)>-1&&I.push(239,191,189);continue}else if(m+1===c){(s-=3)>-1&&I.push(239,191,189);continue}E=o;continue}if(o<56320){(s-=3)>-1&&I.push(239,191,189),E=o;continue}o=(E-55296<<10|o-56320)+65536}else E&&(s-=3)>-1&&I.push(239,191,189);if(E=null,o<128){if((s-=1)<0)break;I.push(o)}else if(o<2048){if((s-=2)<0)break;I.push(o>>6|192,o&63|128)}else if(o<65536){if((s-=3)<0)break;I.push(o>>12|224,o>>6&63|128,o&63|128)}else if(o<1114112){if((s-=4)<0)break;I.push(o>>18|240,o>>12&63|128,o>>6&63|128,o&63|128)}else throw new Error("Invalid code point")}return I}function Re(a){const s=[];for(let o=0;o<a.length;++o)s.push(a.charCodeAt(o)&255);return s}function Oe(a,s){let o,c,E;const I=[];for(let m=0;m<a.length&&!((s-=2)<0);++m)o=a.charCodeAt(m),c=o>>8,E=o%256,I.push(E),I.push(c);return I}function ie(a){return t.toByteArray(Be(a))}function x(a,s,o,c){let E;for(E=0;E<c&&!(E+o>=s.length||E>=a.length);++E)s[E+o]=a[E];return E}function U(a,s){return a instanceof s||a!=null&&a.constructor!=null&&a.constructor.name!=null&&a.constructor.name===s.name}function V(a){return a!==a}const Me=function(){const a="0123456789abcdef",s=new Array(256);for(let o=0;o<16;++o){const c=o*16;for(let E=0;E<16;++E)s[c+E]=a[o]+a[E]}return s}();function N(a){return typeof BigInt>"u"?Te:a}function Te(){throw new Error("BigInt not supported")}})(buffer);const TEST_DEBUG=!1,MAX_SNAPSHOTS=60;var RUN_MODE=(e=>(e[e.IDLE=0]="IDLE",e[e.RUNNING=-1]="RUNNING",e[e.PAUSED=-2]="PAUSED",e[e.NEED_BOOT=-3]="NEED_BOOT",e[e.NEED_RESET=-4]="NEED_RESET",e))(RUN_MODE||{}),MSG_WORKER=(e=>(e[e.MACHINE_STATE=0]="MACHINE_STATE",e[e.CLICK=1]="CLICK",e[e.DRIVE_PROPS=2]="DRIVE_PROPS",e[e.DRIVE_SOUND=3]="DRIVE_SOUND",e[e.SAVE_STATE=4]="SAVE_STATE",e[e.RUMBLE=5]="RUMBLE",e[e.HELP_TEXT=6]="HELP_TEXT",e[e.SHOW_MOUSE=7]="SHOW_MOUSE",e[e.MBOARD_SOUND=8]="MBOARD_SOUND",e[e.COMM_DATA=9]="COMM_DATA",e[e.MIDI_DATA=10]="MIDI_DATA",e[e.REQUEST_THUMBNAIL=11]="REQUEST_THUMBNAIL",e))(MSG_WORKER||{}),MSG_MAIN=(e=>(e[e.RUN_MODE=0]="RUN_MODE",e[e.STATE6502=1]="STATE6502",e[e.DEBUG=2]="DEBUG",e[e.DISASSEMBLE_ADDR=3]="DISASSEMBLE_ADDR",e[e.BREAKPOINTS=4]="BREAKPOINTS",e[e.STEP_INTO=5]="STEP_INTO",e[e.STEP_OVER=6]="STEP_OVER",e[e.STEP_OUT=7]="STEP_OUT",e[e.SPEED=8]="SPEED",e[e.TIME_TRAVEL_STEP=9]="TIME_TRAVEL_STEP",e[e.TIME_TRAVEL_INDEX=10]="TIME_TRAVEL_INDEX",e[e.TIME_TRAVEL_SNAPSHOT=11]="TIME_TRAVEL_SNAPSHOT",e[e.THUMBNAIL_IMAGE=12]="THUMBNAIL_IMAGE",e[e.RESTORE_STATE=13]="RESTORE_STATE",e[e.KEYPRESS=14]="KEYPRESS",e[e.MOUSEEVENT=15]="MOUSEEVENT",e[e.PASTE_TEXT=16]="PASTE_TEXT",e[e.APPLE_PRESS=17]="APPLE_PRESS",e[e.APPLE_RELEASE=18]="APPLE_RELEASE",e[e.GET_SAVE_STATE=19]="GET_SAVE_STATE",e[e.GET_SAVE_STATE_SNAPSHOTS=20]="GET_SAVE_STATE_SNAPSHOTS",e[e.DRIVE_PROPS=21]="DRIVE_PROPS",e[e.GAMEPAD=22]="GAMEPAD",e[e.SET_BINARY_BLOCK=23]="SET_BINARY_BLOCK",e[e.COMM_DATA=24]="COMM_DATA",e[e.MIDI_DATA=25]="MIDI_DATA",e[e.RAMWORKS=26]="RAMWORKS",e))(MSG_MAIN||{}),COLOR_MODE=(e=>(e[e.COLOR=0]="COLOR",e[e.NOFRINGE=1]="NOFRINGE",e[e.GREEN=2]="GREEN",e[e.AMBER=3]="AMBER",e[e.BLACKANDWHITE=4]="BLACKANDWHITE",e))(COLOR_MODE||{}),DRIVE=(e=>(e[e.MOTOR_OFF=0]="MOTOR_OFF",e[e.MOTOR_ON=1]="MOTOR_ON",e[e.TRACK_END=2]="TRACK_END",e[e.TRACK_SEEK=3]="TRACK_SEEK",e))(DRIVE||{}),ADDR_MODE=(e=>(e[e.IMPLIED=0]="IMPLIED",e[e.IMM=1]="IMM",e[e.ZP_REL=2]="ZP_REL",e[e.ZP_X=3]="ZP_X",e[e.ZP_Y=4]="ZP_Y",e[e.ABS=5]="ABS",e[e.ABS_X=6]="ABS_X",e[e.ABS_Y=7]="ABS_Y",e[e.IND_X=8]="IND_X",e[e.IND_Y=9]="IND_Y",e[e.IND=10]="IND",e))(ADDR_MODE||{});const default6502State=()=>({cycleCount:0,PStatus:0,PC:0,Accum:0,XReg:0,YReg:0,StackPtr:0,flagIRQ:0,flagNMI:!1}),isBranchInstruction=e=>e.startsWith("B")&&e!=="BIT"&&e!=="BRK",toHex=(e,t=2)=>(e>255&&(t=4),("0000"+e.toString(16).toUpperCase()).slice(-t)),toASCII=e=>e.split("").map(t=>t.charCodeAt(0)),uint16toBytes=e=>[e&255,e>>>8&255],uint32toBytes=e=>[e&255,e>>>8&255,e>>>16&255,e>>>24&255],replaceSuffix=(e,t)=>{const r=e.lastIndexOf(".")+1;return e.substring(0,r)+t},crcTable=new Uint32Array(256).fill(0),makeCRCTable=()=>{let e;for(let t=0;t<256;t++){e=t;for(let r=0;r<8;r++)e=e&1?3988292384^e>>>1:e>>>1;crcTable[t]=e}},crc32=(e,t=0)=>{crcTable[255]===0&&makeCRCTable();let r=-1;for(let n=t;n<e.length;n++)r=r>>>8^crcTable[(r^e[n])&255];return(r^-1)>>>0};let gamePads;const maxTimeoutCycles=Math.trunc(.0028*1020484);let paddle0timeout=maxTimeoutCycles/2,paddle1timeout=maxTimeoutCycles/2,paddle2timeout=maxTimeoutCycles/2,paddle3timeout=maxTimeoutCycles/2,countStart=0,leftAppleDown=!1,rightAppleDown=!1,leftButtonDown=!1,rightButtonDown=!1,isPB2down=!1,isLeftDown=!1,isRightDown=!1;const setLeftButtonDown=()=>{leftButtonDown=!0},setRightButtonDown=()=>{rightButtonDown=!0},setPushButton2=()=>{isPB2down=!0},valueToTimeout=e=>(e=Math.min(Math.max(e,-1),1),(e+1)*maxTimeoutCycles/2),setGamepad0=e=>{paddle0timeout=valueToTimeout(e)},setGamepad1=e=>{paddle1timeout=valueToTimeout(e)},setGamepad2=e=>{paddle2timeout=valueToTimeout(e)},setGamepad3=e=>{paddle3timeout=valueToTimeout(e)},setButtonState=()=>{isLeftDown=leftAppleDown||leftButtonDown,isRightDown=rightAppleDown||rightButtonDown,SWITCHES.PB0.isSet=isLeftDown,SWITCHES.PB1.isSet=isRightDown||isPB2down,SWITCHES.PB2.isSet=isPB2down},pressAppleCommandKey=(e,t)=>{t?leftAppleDown=e:rightAppleDown=e,setButtonState()},resetJoystick=e=>{memSetC000(49252,128),memSetC000(49253,128),memSetC000(49254,128),memSetC000(49255,128),countStart=e},checkJoystickValues=e=>{const t=e-countStart;memSetC000(49252,t<paddle0timeout?128:0),memSetC000(49253,t<paddle1timeout?128:0),memSetC000(49254,t<paddle2timeout?128:0),memSetC000(49255,t<paddle3timeout?128:0)};let gameMapping,gamePadMapping,isKeyboardJoystick=!1;const setGamepads=e=>{gamePads=e,isKeyboardJoystick=!gamePads.length||!gamePads[0].buttons.length,gameMapping=getGameMapping(),gamePadMapping=gameMapping.gamepad?gameMapping.gamepad:defaultButtons},nearZero=e=>e>-.01&&e<.01,convertGamepadAxes=e=>{let t=e[0],r=e[1];nearZero(t)&&(t=0),nearZero(r)&&(r=0);const n=Math.sqrt(t*t+r*r),D=.95*(n===0?1:Math.max(Math.abs(t),Math.abs(r))/n);return t=Math.min(Math.max(-D,t),D),r=Math.min(Math.max(-D,r),D),t=Math.trunc(maxTimeoutCycles*(t+D)/(2*D)),r=Math.trunc(maxTimeoutCycles*(r+D)/(2*D)),[t,r]},handleGamepad=e=>{const t=gameMapping.joystick?gameMapping.joystick(gamePads[e].axes,isKeyboardJoystick):gamePads[e].axes,r=convertGamepadAxes(t);e===0?(paddle0timeout=r[0],paddle1timeout=r[1],leftButtonDown=!1,rightButtonDown=!1):(paddle2timeout=r[0],paddle3timeout=r[1],isPB2down=!1);let n=!1;gamePads[e].buttons.forEach((D,l)=>{D&&(gamePadMapping(l,gamePads.length>1,e===1),n=!0)}),n||gamePadMapping(-1,gamePads.length>1,e===1),gameMapping.rumble&&gameMapping.rumble(),setButtonState()},handleGamepads=()=>{gamePads&&gamePads.length>0&&(handleGamepad(0),gamePads.length>1&&handleGamepad(1))},gamepad$4=e=>{switch(e){case 0:addToBufferDebounce("JL");break;case 1:addToBufferDebounce("G",200);break;case 2:addToBuffer("M"),addToBufferDebounce("O");break;case 3:addToBufferDebounce("L");break;case 4:addToBufferDebounce("F");break;case 5:addToBuffer("P"),addToBufferDebounce("T");break;case 6:break;case 7:break;case 8:addToBufferDebounce("Z");break;case 9:{const t=getTextPageAsString();t.includes("'N'")?addToBuffer("N"):t.includes("'S'")?addToBuffer("S"):t.includes("NUMERIC KEY")?addToBuffer("1"):addToBuffer("N");break}case 10:break;case 11:break;case 12:addToBufferDebounce("L");break;case 13:addToBufferDebounce("M");break;case 14:addToBufferDebounce("A");break;case 15:addToBufferDebounce("D");break;case-1:return}};let leftdown=0,rightdown=0,buttonreleased=!1;const threshold$2=.5,joystick$2=e=>e[0]<-threshold$2?(rightdown=0,leftdown===0||leftdown>2?(leftdown=0,addToBuffer("A")):leftdown===1&&buttonreleased?addToBufferDebounce("W"):leftdown===2&&buttonreleased&&addToBufferDebounce("R"),leftdown++,buttonreleased=!1,e):e[0]>threshold$2?(leftdown=0,rightdown===0||rightdown>2?(rightdown=0,addToBuffer("D")):rightdown===1&&buttonreleased?addToBufferDebounce("W"):rightdown===2&&buttonreleased&&addToBufferDebounce("R"),rightdown++,buttonreleased=!1,e):e[1]<-threshold$2?(addToBufferDebounce("C"),e):e[1]>threshold$2?(addToBufferDebounce("S"),e):(buttonreleased=!0,e),helptext$7=`AZTEC
...
*/const encode_6_and_2=e=>{const t=[150,151,154,155,157,158,159,166,167,171,172,173,174,175,178,179,180,181,182,183,185,186,187,188,189,190,191,203,205,206,207,211,214,215,217,218,219,220,221,222,223,229,230,231,233,234,235,236,237,238,239,242,243,244,245,246,247,249,250,251,252,253,254,255],r=new Uint8Array(343),n=[0,2,1,3];for(let l=0;l<84;l++)r[l]=n[e[l]&3]|n[e[l+86]&3]<<2|n[e[l+172]&3]<<4;r[84]=n[e[84]&3]<<0|n[e[170]&3]<<2,r[85]=n[e[85]&3]<<0|n[e[171]&3]<<2;for(let l=0;l<256;l++)r[86+l]=e[l]>>>2;r[342]=r[341];let D=342;for(;D>1;)D--,r[D]^=r[D-1];for(let l=0;l<343;l++)r[l]=t[r[l]];return r};/*!
...
*/const serialise_track=(e,t,r)=>{let n=0;const D=new Uint8Array(6646).fill(0);for(let l=0;l<16;l++)n=write_sync(D,n);for(let l=0;l<16;l++){n=write_byte(D,n,213),n=write_byte(D,n,170),n=write_byte(D,n,150),n=write_4_and_4(D,n,254),n=write_4_and_4(D,n,t),n=write_4_and_4(D,n,l),n=write_4_and_4(D,n,254^t^l),n=write_byte(D,n,222),n=write_byte(D,n,170),n=write_byte(D,n,235);for(let d=0;d<7;d++)n=write_sync(D,n);n=write_byte(D,n,213),n=write_byte(D,n,170),n=write_byte(D,n,173);const C=l===15?15:l*(r?8:7)%15,u=encode_6_and_2(e.slice(C*256,C*256+256));for(let d=0;d<u.length;d++)n=write_byte(D,n,u[d]);n=write_byte(D,n,222),n=write_byte(D,n,170),n=write_byte(D,n,235);for(let d=0;d<16;d++)n=write_sync(D,n)}return D},convertdsk2woz=(e,t)=>{if(e.length!==35*16*256)return new Uint8Array;const r=new Uint8Array(512*3+512*35*13).fill(0);r.set(toASCII(`WOZ2ÿ
\r
`),0),r.set(toASCII("INFO"),12),r[16]=60,r[20]=2,r[21]=1,r[22]=0,r[23]=0,r[24]=1,r.fill(32,25,57),r.set(toASCII("Apple2TS (CT6502)"),25),r[57]=1,r[58]=0,r[59]=32,r[60]=0,r[62]=0,r[64]=13,r.set(toASCII("TMAP"),80),r[84]=160,r.fill(255,88,88+160);let n=0;for(let D=0;D<35;D++)n=88+(D<<2),D>0&&(r[n-1]=D),r[n]=r[n+1]=D;r.set(toASCII("TRKS"),248),r.set(uint32toBytes(1280+35*13*512),252);for(let D=0;D<35;D++){n=256+(D<<3),r.set(uint16toBytes(3+D*13),n),r[n+2]=13,r.set(uint32toBytes(50304),n+4);const l=e.slice(D*16*256,(D+1)*16*256),C=serialise_track(l,D,t);n=512*(3+13*D),r.set(C,n)}return r},decodeWoz2=(e,t)=>{if(!([87,79,90,50,255,10,13,10].find((u,d)=>u!==t[d])===void 0))return!1;e.isWriteProtected=t[22]===1;const D=t.slice(8,12),l=D[0]+(D[1]<<8)+(D[2]<<16)+D[3]*2**24,C=crc32(t,12);if(l!==0&&l!==C)return alert("CRC checksum error: "+e.filename),!1;for(let u=0;u<80;u++){const d=t[88+u*2];if(d<255){const R=256+8*d,g=t.slice(R,R+8);e.trackStart[u]=512*(g[0]+(g[1]<<8)),e.trackNbits[u]=g[4]+(g[5]<<8)+(g[6]<<16)+g[7]*2**24}else e.trackStart[u]=0,e.trackNbits[u]=51200}return!0},decodeWoz1=(e,t)=>{if(!([87,79,90,49,255,10,13,10].find((D,l)=>D!==t[l])===void 0))return!1;e.isWriteProtected=t[22]===1;for(let D=0;D<80;D++){const l=t[88+D*2];if(l<255){e.trackStart[D]=256+l*6656;const C=t.slice(e.trackStart[D]+6646,e.trackStart[D]+6656);e.trackNbits[D]=C[2]+(C[3]<<8)}else e.trackStart[D]=0,e.trackNbits[D]=51200}return!0},isDSK=e=>{const t=e.toLowerCase(),r=t.endsWith(".dsk")||t.endsWith(".do"),n=t.endsWith(".po");return r||n},decodeDSK=(e,t)=>{const n=e.filename.toLowerCase().endsWith(".po"),D=convertdsk2woz(t,n);return D.length===0?new Uint8Array:(e.filename=replaceSuffix(e.filename,"woz"),e.diskHasChanges=!0,D)},int32=e=>e[0]+256*(e[1]+256*(e[2]+256*e[3])),decode2MG=(e,t)=>{const r=int32(t.slice(24,28)),n=int32(t.slice(28,32));let D="";for(let l=0;l<4;l++)D+=String.fromCharCode(t[l]);return D!=="2IMG"?(console.error("Corrupt 2MG file."),new Uint8Array):t[12]!==1?(console.error("Only ProDOS 2MG files are supported."),new Uint8Array):(e.filename=replaceSuffix(e.filename,"hdv"),e.diskHasChanges=!0,t.slice(r,r+n))},isHardDriveImage=e=>{const t=e.toLowerCase();return t.endsWith(".hdv")||t.endsWith(".po")||t.endsWith(".2mg")},decodeDiskData=(e,t)=>{e.diskHasChanges=!1;const r=e.filename.toLowerCase();if(isHardDriveImage(r)){if(e.hardDrive=!0,e.status="",r.endsWith(".hdv")||r.endsWith(".po"))return t;if(r.endsWith(".2mg"))return decode2MG(e,t)}return isDSK(e.filename)&&(t=decodeDSK(e,t)),decodeWoz2(e,t)||decodeWoz1(e,t)?t:(r!==""&&console.error("Unknown disk format."),new Uint8Array)},disk2driver=[162,32,160,0,162,3,134,60,138,10,36,60,240,16,5,60,73,255,41,126,176,8,74,208,251,152,157,86,3,200,232,16,229,32,88,255,186,189,0,1,10,10,10,10,133,43,170,189,142,192,189,140,192,189,138,192,189,137,192,160,80,189,128,192,152,41,3,10,5,43,170,189,129,192,169,86,32,168,252,136,16,235,133,38,133,61,133,65,169,8,133,39,24,8,189,140,192,16,251,73,213,208,247,189,140,192,16,251,201,170,208,243,234,189,140,192,16,251,201,150,240,9,40,144,223,73,173,240,37,208,217,160,3,133,64,189,140,192,16,251,42,133,60,189,140,192,16,251,37,60,136,208,236,40,197,61,208,190,165,64,197,65,208,184,176,183,160,86,132,60,188,140,192,16,251,89,214,2,164,60,136,153,0,3,208,238,132,60,188,140,192,16,251,89,214,2,164,60,145,38,200,208,239,188,140,192,16,251,89,214,2,208,135,160,0,162,86,202,48,251,177,38,94,0,3,42,94,0,3,42,145,38,200,208,238,230,39,230,61,165,61,205,0,8,166,43,144,219,76,1,8,0,0,0,0,0];let motorOffTimeout=0;const SWITCH={MOTOR_OFF:8,MOTOR_ON:9,DRIVE1:10,DRIVE2:11,DATA_LATCH_OFF:12,DATA_LATCH_ON:13,WRITE_OFF:14,WRITE_ON:15,MOTOR_RUNNING:!1,DATA_LATCH:!1},doResetDiskDrive=e=>{SWITCH.MOTOR_RUNNING=!1,doMotorTimeout(e),e.halftrack=68,e.prevHalfTrack=68},doPauseDiskDrive=(e=!1)=>{if(e){const t=getCurrentDriveState();t.motorRunning&&startMotor(t)}else passDriveSound(DRIVE.MOTOR_OFF)},moveHead=(e,t)=>{e.trackStart[e.halftrack]>0&&(e.prevHalfTrack=e.halftrack),e.halftrack+=t,e.halftrack<0||e.halftrack>68?(passDriveSound(DRIVE.TRACK_END),e.halftrack=e.halftrack<0?0:e.halftrack>68?68:e.halftrack):passDriveSound(DRIVE.TRACK_SEEK),e.status=` Track ${e.halftrack/2}`,passData(),e.trackStart[e.halftrack]>0&&e.prevHalfTrack!==e.halftrack&&(e.trackLocation=Math.floor(e.trackLocation*(e.trackNbits[e.halftrack]/e.trackNbits[e.prevHalfTrack])),e.trackLocation>3&&(e.trackLocation-=4))},pickbit=[128,64,32,16,8,4,2,1],clearbit=[127,191,223,239,247,251,253,254],getNextBit=(e,t)=>{e.trackLocation=e.trackLocation%e.trackNbits[e.halftrack];let r;if(e.trackStart[e.halftrack]>0){const n=e.trackStart[e.halftrack]+(e.trackLocation>>3),D=t[n],l=e.trackLocation&7;r=(D&pickbit[l])>>7-l}else r=1;return e.trackLocation++,r};let dataRegister=0;const getNextByte=(e,t)=>{if(t.length===0)return 0;let r=0;if(dataRegister===0){for(;getNextBit(e,t)===0;);dataRegister=64;for(let n=5;n>=0;n--)dataRegister|=getNextBit(e,t)<<n}else{const n=getNextBit(e,t);dataRegister=dataRegister<<1|n}return r=dataRegister,dataRegister>127&&(dataRegister=0),r};let prevCycleCount$2=0;const doWriteBit=(e,t,r)=>{if(e.trackLocation=e.trackLocation%e.trackNbits[e.halftrack],e.trackStart[e.halftrack]>0){const n=e.trackStart[e.halftrack]+(e.trackLocation>>3);let D=t[n];const l=e.trackLocation&7;r?D|=pickbit[l]:D&=clearbit[l],t[n]=D}e.trackLocation++},doWriteByte=(e,t,r)=>{if(!(t.length===0||e.trackStart[e.halftrack]===0)&&dataRegister>0){if(r>=16)for(let n=7;n>=0;n--)doWriteBit(e,t,dataRegister&2**n?1:0);r>=36&&doWriteBit(e,t,0),r>=40&&doWriteBit(e,t,0),debugCache.push(r>=40?2:r>=36?1:dataRegister),e.diskHasChanges=!0,dataRegister=0}},doMotorTimeout=e=>{motorOffTimeout=0,SWITCH.MOTOR_RUNNING||(e.motorRunning=!1),passData(),passDriveSound(DRIVE.MOTOR_OFF)},startMotor=e=>{motorOffTimeout&&(clearTimeout(motorOffTimeout),motorOffTimeout=0),e.motorRunning=!0,passData(),passDriveSound(DRIVE.MOTOR_ON)},stopMotor=e=>{motorOffTimeout===0&&(motorOffTimeout=setTimeout(()=>doMotorTimeout(e),1e3))};let debugCache=[];const dumpData=e=>{debugCache.length>0&&e.halftrack===2*0&&(debugCache=[])},STEPPER_MOTORS=[0,0,0,0],handleDriveSoftSwitches=(e,t)=>{if(e>=49408)return-1;let r=getCurrentDriveState();const n=getCurrentDriveData();if(r.hardDrive)return 0;let D=0;const l=s6502.cycleCount-prevCycleCount$2;switch(e=e&15,e){case SWITCH.DATA_LATCH_OFF:SWITCH.DATA_LATCH=!1,r.motorRunning&&!r.writeMode&&(D=getNextByte(r,n));break;case SWITCH.MOTOR_ON:SWITCH.MOTOR_RUNNING=!0,startMotor(r),dumpData(r);break;case SWITCH.MOTOR_OFF:SWITCH.MOTOR_RUNNING=!1,stopMotor(r),dumpData(r);break;case SWITCH.DRIVE1:case SWITCH.DRIVE2:{const C=e===SWITCH.DRIVE1?1:2,u=getCurrentDriveState();setCurrentDrive(C),r=getCurrentDriveState(),r!==u&&u.motorRunning&&(u.motorRunning=!1,r.motorRunning=!0,passData());break}case SWITCH.WRITE_OFF:r.motorRunning&&r.writeMode&&(doWriteByte(r,n,l),prevCycleCount$2=s6502.cycleCount),r.writeMode=!1,SWITCH.DATA_LATCH&&(D=r.isWriteProtected?255:0),dumpData(r);break;case SWITCH.WRITE_ON:r.writeMode=!0,prevCycleCount$2=s6502.cycleCount,t>=0&&(dataRegister=t);break;case SWITCH.DATA_LATCH_ON:SWITCH.DATA_LATCH=!0,r.motorRunning&&(r.writeMode&&(doWriteByte(r,n,l),prevCycleCount$2=s6502.cycleCount),t>=0&&(dataRegister=t));break;default:{if(e<0||e>7)break;STEPPER_MOTORS[Math.floor(e/2)]=e%2;const C=STEPPER_MOTORS[(r.currentPhase+1)%4],u=STEPPER_MOTORS[(r.currentPhase+3)%4];STEPPER_MOTORS[r.currentPhase]||(r.motorRunning&&C?(moveHead(r,1),r.currentPhase=(r.currentPhase+1)%4):r.motorRunning&&u&&(moveHead(r,-1),r.currentPhase=(r.currentPhase+3)%4)),dumpData(r);break}}return D},enableDiskDrive=()=>{setSlotDriver(6,Uint8Array.from(disk2driver)),setSlotIOCallback(6,handleDriveSoftSwitches)};let doOutput=!1;const splitOperand=e=>{const t=e.split(","),r=t[0].split(/([+-])/);return{label:r[0]?r[0]:"",operation:r[1]?r[1]:"",value:r[2]?parseInt(r[2].replace("#","").replace("$","0x")):0,idx:t[1]?t[1]:""}},parseNumberOptionalAddressMode=e=>{let t=ADDR_MODE.IMPLIED,r=-1;if(e.length>0){e.startsWith("#")?(t=ADDR_MODE.IMM,e=e.substring(1)):e.startsWith("(")?(e.endsWith(",Y")?t=ADDR_MODE.IND_Y:e.endsWith(",X)")?t=ADDR_MODE.IND_X:t=ADDR_MODE.IND,e=e.substring(1)):e.endsWith(",X")?t=e.length>5?ADDR_MODE.ABS_X:ADDR_MODE.ZP_X:e.endsWith(",Y")?t=e.length>5?ADDR_MODE.ABS_Y:ADDR_MODE.ZP_Y:t=e.length>3?ADDR_MODE.ABS:ADDR_MODE.ZP_REL,e.startsWith("$")&&(e="0x"+e.substring(1)),r=parseInt(e);const n=splitOperand(e);if(n.operation&&n.value){switch(n.operation){case"+":r+=n.value;break;case"-":r-=n.value;break;default:throw new Error("Unknown operation in operand: "+e)}r=(r%65536+65536)%65536}}return[t,r]};let labels={};const getOperandModeValue=(e,t,r,n)=>{let D=ADDR_MODE.IMPLIED,l=-1;if(r.match(/^[#]?[$0-9()]+/))return parseNumberOptionalAddressMode(r);const C=splitOperand(r);if(C.label){const u=C.label.startsWith("<"),d=C.label.startsWith(">"),R=C.label.startsWith("#")||d||u;if(R&&(C.label=C.label.substring(1)),C.label in labels)l=labels[C.label],d?l=l>>8&255:u&&(l=l&255);else if(n===2)throw new Error("Missing label: "+C.label);if(C.operation&&C.value){switch(C.operation){case"+":l+=C.value;break;case"-":l-=C.value;break;default:throw new Error("Unknown operation in operand: "+r)}l=(l%65536+65536)%65536}isBranchInstruction(t)?(D=ADDR_MODE.ZP_REL,l=l-e+254,l>255&&(l-=256)):R?D=ADDR_MODE.IMM:(D=l>=0&&l<=255?ADDR_MODE.ZP_REL:ADDR_MODE.ABS,D=C.idx==="X"?D===ADDR_MODE.ABS?ADDR_MODE.ABS_X:ADDR_MODE.ZP_X:D,D=C.idx==="Y"?D===ADDR_MODE.ABS?ADDR_MODE.ABS_Y:ADDR_MODE.ZP_Y:D)}return[D,l]},splitLine=(e,t)=>{e=e.replace(/\s+/g," ");const r=e.split(" ");return{label:r[0]?r[0]:t,instr:r[1]?r[1]:"",operand:r[2]?r[2]:""}},handleLabel=(e,t)=>{if(e.label in labels)throw new Error("Redefined label: "+e.label);if(e.instr==="EQU"){const[r,n]=getOperandModeValue(t,e.instr,e.operand,2);if(r!==ADDR_MODE.ABS&&r!==ADDR_MODE.ZP_REL)throw new Error("Illegal EQU value: "+e.operand);labels[e.label]=n}else labels[e.label]=t},getHexCodesForInstruction=(e,t)=>{const r=[],n=pcodes[e];return r.push(e),t>=0&&(r.push(t%256),n.bytes===3&&r.push(Math.trunc(t/256))),r};let orgStart=0;const parseOnce=(e,t)=>{let r=orgStart;const n=[];let D="";if(e.forEach(l=>{if(l=l.split(";")[0].trimEnd().toUpperCase(),!l)return;let C=(l+"                   ").slice(0,30)+toHex(r,4)+"- ";const u=splitLine(l,D);if(D="",!u.instr){D=u.label;return}if(u.instr==="ORG"){if(t===1){const[p,M]=parseNumberOptionalAddressMode(u.operand);p===ADDR_MODE.ABS&&(orgStart=M,r=M)}doOutput&&t===2&&console.log(C);return}if(t===1&&u.label&&handleLabel(u,r),u.instr==="EQU")return;let d=[],R,g;if(u.instr==="ASC"||u.instr==="DA"){let p=u.operand,M=0;if(p.startsWith('"')&&p.endsWith('"'))M=128;else if(p.startsWith("'")&&p.endsWith("'"))M=0;else throw new Error("Invalid string: "+p);p=p.substring(1,p.length-1);for(let w=0;w<p.length;w++)d.push(p.charCodeAt(w)|M);d.push(0),r+=p.length+1}else if([R,g]=getOperandModeValue(r,u.instr,u.operand,t),u.instr==="DB")d.push(g&255),r++;else if(u.instr==="DW")d.push(g&255),d.push(g>>8&255),r+=2;else if(u.instr==="DS")for(let p=0;p<g;p++)d.push(0),r++;else{if(t===2&&isBranchInstruction(u.instr)&&(g<0||g>255))throw new Error(`Branch instruction out of range: ${l} value: ${g} pass: ${t}`);const p=pcodes.findIndex(M=>M&&M.name===u.instr&&M.mode===R);if(p<0)throw new Error(`Unknown instruction: "${l}" mode=${R} pass=${t}`);d=getHexCodesForInstruction(p,g),r+=pcodes[p].bytes}doOutput&&t===2&&(d.forEach(p=>{C+=` ${toHex(p)}`}),console.log(C)),n.push(...d)}),doOutput&&t===2){let l="";n.forEach(C=>{l+=` ${toHex(C)}`}),console.log(l)}return n},parseAssembly=(e,t,r=!1)=>{labels={},doOutput=r;try{return orgStart=e,parseOnce(t,1),parseOnce(t,2)}catch(n){return console.error(n),[]}};let timerID=0;const driverAddr=192,code1=`
