...
Ctrl+S    Turn Sound On/Off`,setup$1=()=>{memSet(3178,99)},rumble$1=()=>{memGet(14799,!1)===255&&passRumble({startDelay:0,duration:1e3,weakMagnitude:1,strongMagnitude:0})},robotron={address:16962,data:[173,0,192],keymap:{},joystick:null,gamepad:null,rumble:rumble$1,setup:setup$1,helptext:helptext$4},helptext$3=`SNOGGLE
...
N ← ,  left
M → .  right
`,gamepad$1=e=>{switch(e){case 1:memSet(109,255);break;case 12:addToBuffer("A");break;case 13:addToBuffer("Z");break;case 14:addToBuffer("\b");break;case 15:addToBuffer("");break}},threshold=.75,joystick=e=>{const t=e[0]<-threshold?"\b":e[0]>threshold?"":e[1]<-threshold?"A":e[1]>threshold?"Z":"";return t&&addToBuffer(t),e},setup=()=>{memSet(25025,173),memSet(25036,64)},snoggle=[{address:34918,data:[32,0,96],keymap:{},joystick:null,gamepad:null,rumble:null,setup,helptext:helptext$3},{address:7291,data:[173,0,192],keymap:{N:"\b",M:"",",":"\b",".":""},joystick,gamepad:gamepad$1,rumble:null,setup:null,helptext:helptext$3}],helptext$2=`Ultima V: Warriors of Destiny
by Lord British
...
`,ultima5={address:514,data:[85,76,84,73,77,65,53],keymap:{},gamepad:null,joystick:null,rumble:null,setup:null,helptext:helptext$2},helptext$1=`Wizardry
